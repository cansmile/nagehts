            ...
            array( 'Wie heißen Sie?', '이름이 어떻게 되시나요?',
                array(
                    'r1-Guten Tag!' => array( 'A. Guten Tag!', '안녕하세요!',
                        array(
                            'A2' => array( '그림과 알맞은 표현을 연결해보세요.', 'Ordnen Sie zu.' ),
                            'A3' => array( '말풍선에 알맞은 표현을 채우세요.', 'Ergänzen Sie.' ),
                        )
                    ),
                    'r1-Wie heissen Sie' => array( 'B. Wie heißen Sie?', '이름이 어떻게 되시나요?',
                        array(
                            'B1' => array( '이름이 어떻게 되시나요?', 'Wie heißen Sie?' ),
                            'B3' => array( '네 이름은 무엇이니?', 'Wie heißt du?' ),
                            'B4' => array( '빈칸을 채우세요.', 'Ergänzen Sie die Lücken!' ),
                            'B5' => array( '다음을 성과 이름으로 분류하세요.', 'Sortieren Sie die Namen nach Vor- und Familiennamen.' ),
                        )
                    ),
                    'r1-Wie geht es Ihnen' => array( 'C. Wie geht es Ihnen?', '어떻게 지내시나요?',
                        array(
                            'C2' => array( '연결하세요.', 'Ordnen Sie zu.' ),
                            'C1' => array( '어떻게 지내시나요?', 'Wie geht es Ihnen?' ),
                            'C3' => array( '어떻게 지내?', 'Wie geht es dir?' ),
                        )
                    ),
                    'r1-Wer ist Hyun Kim' => array( 'D. Wer ist Hyun Kim?', '김현이 누구인가요?',
                        array(
                            'D1' => array( '독일어 수업시간에', 'Im Deutschunterricht' ),
                        )
                    ),
                    'r1-Zahlen(1-10)' => array( 'F. Zahlen(1~10)', '수(1~10)',
                        array(
                            'F1' => array( '수(1~10)', 'Zahlen(1-10)' ),
                            'F2' => array( '다음 숫자들은 어떻게 불리나요?', 'Wie heißen die Zahlen?' ),
                        )
                    ),
                    'r1-Uebungen' => array( 'G. Übungen', '연습하기',
                        array(
                            'G1' => array( '인사', 'Begrüßung' ),
                            'G2' => array( '사람들이 뭐라고 하나요?', 'Was sagen die Personen?' ),
                            'G3' => array( '질문인가요? 대답인가요?', 'Frage oder Antwort?' ),
                            'G7' => array( '„du“ 혹은 „Sie“를 쓰세요.', 'Ergänzen Sie: „du“ oder „Sie“.' ),
                            'G8' => array( '빈칸에 동사의 알맞은 형태로 채우세요.', 'Ergänzen Sie die passende Form.' ),
                            'G11' => array( '듣고 알맞은 억양(Satzmelodie)기호를 채우세요.', 'Hören Sie und ergänzen Sie.' ),
                        )
                    ),
                ...
                array(
                    ...
                    'r11-Minas Reisebeitraege (auf Facebook)' => array( 'D. Minas Reisebeiträge (auf Facebook)', '미나의 여행일지 (페이스북)',
                        array(
                            ...
                            'D3' => array( 'Übersetzen Sie die Sätze ins Koreanische.', '문장들을 한국어로 변역하세요.' ),

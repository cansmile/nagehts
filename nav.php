...
// 각 과별 중단원 파일명과 제목
$tl = array(
array("r0-Alphabet"=>"A. Alphabet","r0-Quizzzz"=>"B. Quiz","r0-Zuordnung"=>"C. Zuordnung"),
...
// 각 과별 중단원 파일명과 제목 번역
$tl_k = array(
array("r0-Alphabet"=>"알파벳","r0-Quizzzz"=>"퀴즈","r0-Zuordnung"=>"연결하기"),
...
array("r5-Essen und Trinken"=>"먹고 마시기","r5-Was isst du gern und was trinkst du gern"=>"무엇을 즐겨 먹고 마셔?","r5-Was isst und trinkt er,sie"=>"그(녀)는 무엇을 먹고 마시나요?","r5-Im Restaurant. Was bekommen Sie"=>"레스토랑에서.<br>무엇을 주문하시겠어요?","r5-Waehrend des Essens"=>"식사 중에","r5-Was bezahlen Sie"=>"무엇을 지불하시겠어요?","r5-Uebungen"=>"연습문제","r5-Grammatik und Wendungen"=>"문법과 표현"),
array("r6-Was machst du gern"=>"하루일과 중 무엇을 즐겨 하니?","r6-Wie spaet ist es"=>"몇시인가요?","r6-Wann hast du Deutschunterricht"=>"독일어 수업이 언제니?","r6-Tagesablauf"=>"하루일과","r6-Uebungen"=>"연습문제","r6-Grammatik und Wendungen"=>"문법과 표현"),
array("r7-Wochenende Was haben Sie am Wochenende vor"=>"주말: 주말에 무엇을 하나요?","r7-Verabredung. Hast du heute Abend Zeit"=>"약속. 오늘저녁시간있니?","r7-Anweisungen"=>"지시문. 무엇을 할 수 있고 해서는 안되나요?","r7-Uebungen"=>"연습문제","r7-Grammatik und Wendungen"=>"문법과 표현"),
...
$rtl = array(
	...
	array(
		...
		"E" => array("E1a" => "Visitenkarten", "E1b" => "Visitenkarten"),
		"F" => array("F1" => "Wer ist das?", "F2" => "Ergänzen Sie.", "F3" => "Ergänzen Sie die Verben.", "F5" => "Ergänzen Sie")
	),
	4 =>
	array(
		...
		"C" => array("C1" => "Was ist das?", "C2a" => "Wie heißt das?", "C2b" => "Was hat er/sie oder was hat er/sie nicht?"),
		"D" => array("D1" => "Wie heißt das Gegenteil?", "D2" => "Adjektive", "D3" => "In meiner Wohnung"),
		"E" => array("E1" => "Sortieren Sie die Wörter.", "E2" => "Ergänzen Sie mit Artikeln.", "E3" => "sein oder haben?", "E4" => "Ergänzen Sie mit Artikeln.", "E5" => "„kein” oder „nicht”?", "E6" => "Schreiben Sie die Sätze.")
	),
	5 =>
	array(
		"A" => array("A1" => "Wo sind die Leute und was machen sie?", "A2" => "Lesen Sie und ergänzen Sie die Lücken.", "A3" => "Ordnen Sie zu."),
		...
		"G" => array("G1" => "Ordnen Sie und tragen Sie unten ein.", "G3" => "Was essen und trinken<br>Tim und Monika gern?", "G4" => "Der Kellner bringt das Falsche.", "G5" => "Wer möchte was?", "G7" => "Was passt zusammen?", "G10" => "Ergänzen Sie die Tabelle.", "G11" => "Ergänzen Sie ‚e’ oder ‚i’", "G12" => "Ergänzen Sie.", "G13" => "Ergänzen Sie.", "G14" => "Ergänzen Sie: der/den/die/das.", "G16" => "Ich möchte bestellen. Ich möchte bezahlen.")
	),
	6 =>
	array(
		...
		"D" => array("D1" => "Wohin passt das? Schreiben Sie.", "D2" => "Wohin passt das? Schreiben Sie."),
	...
	array(
		...
		"B" => array("B1" => "Verabredung I", "B2" => "Verabredung II (Telefon)", "B3" => "Verabredung III (Chat)", "B4" => "Was passt?", "B5" => "Verabredung IV (SMS)", "B6" => "Höfliches Absagen bei Kurznachrichten"),
		...
		"D" => array("D1" => "Was passt zu welchem Bild?", "D2" => "Ergänzen Sie die Lücken.", "D3" => "Ergänzen Sie die Modalverben in der richtigen Form.", "D4" => "Ergänzen Sie.", "D5" => "Wohin sollte man gehen?", "D6" => "Schreiben Sie die Sätze neu.", "D7" => "Ergänzen Sie um, am oder in.", "D8" => "Ergänzen Sie das Telefongespräch.")
	),
	8 =>
	array(
	...
	array(
		...
		"C" => array("C1" => "Was passt zusammen?", "CGR" => "Personalpronomen und (un)bestimmter Artikel im Dativ und Akkusativ", "C4" => "Was möchten Sie zum Geburtstag haben?"),
		"D" => array("D1" => "Schreiben Sie eine Einladungskarte.", "D2" => "Ergänzen Sie die Personalpronomen.", "D3" => "Schreiben Sie einen Einladungskarte zur Einweihungsfeier.", "D4a" => "Meine 20. Geburtstagsfeier", "D4b" => "Hören Sie und ergänzen Sie die passenden Partizip II-Formen.", "D4c" => "Hören Sie den Text und klicken Sie an."),
		"E" => array("E1" => "Feste und Jahreszeiten", "E2" => "Wie heißen die Feste?", "E3" => "Schreiben Sie die Tage.", "E4" => "Diese Personen haben Geburtstag. Was kann man ihnen schenken? Warum?", "E5" => "Mein schönstes Fest", "E6" => "Wann sagt man das?", "E7" => "Ergänzen Sie die Personalpronomen im Dativ und die Verben in der richtigen Form.", "E8" => "Ergänzen Sie die Personalpronomen im Nominativ, Akkusativ oder Dativ.", "E9a" => "Präteritum", "E9b" => "Präteritum von sein und haben.", "E10a" => "Das Perfekt mit „haben“ oder „sein“ ?", "E10b" => "TIPP", "E11" => "Perfekt", "E12" => "Wie war das Fest zu Neujahr, in Korea ,Seolnal‘? Schreiben Sie an Ihrer Freundin Mina.")
	),
	10 =>
	array(
		...
		"E" => array("E1a" => "Wo ist der Spatz?", "E1b" => "Wohin fliegt der Spatz?", "E2a" => "Wo sind die Gegenstände im Zimmer?", "E2b" => "Wohin bringt sie die Gegenstände?", "E3" => "Wo kann man in Gartenstadt was machen?", "E4" => "Ordnen Sie die Ausdrücke aus dem Kasten in die Tabelle ein.", "E5" => "Entschuldigung, wo ist ... ?", "E6" => "Wie komme ich zum/zur ...?", "E7a" => "Hören Sie die Dialoge und ergänzen Sie die Lücken: Am Alexanderplatz", "E7b" => "Hören Sie die Dialoge und ergänzen Sie die Lücken: An der Frauenkirche", "E7c" => "Hören Sie die Dialoge und ergänzen Sie die Lücken: An der Bushaltestelle", "E8" => "Ordnen Sie die Verben je nach der Partizip –II Formen zu.", "E10" => "Ergänzen Sie die Perfekt-Formen.", "E11" => "Mein Urlaub in Dresden")
	)
);
...
1 =>
	...
	array(
		...
		"E" => array("E1a" => "명함", "E1b" => "명함"),
		"F" => array("F1" => "이 사람은 누구인가요?", "F2" => "빈칸을 채우세요.", "F3" => "빈칸에 동사를 채우세요.", "F5" => "아래의 정보를 가지고 빈 칸을 채우세요.")
	),
	4 =>
	array(
		...
		"C" => array("C1" => "이것은 무엇일까요?", "C2a" => "뭐라고 부르나요?", "C2b" => "그(녀)는 무엇을 가지고 있고 무엇을 가지고 있지 않나요?"),
		"D" => array("D1" => "반대말은 무엇인가요?", "D2" => "형용사", "D3" => "나의 집에서"),
		"E" => array("E1" => "다음 단어들을 성에 따라 분류하세요.", "E2" => "동사 표를 채우세요.", "E3" => "sein 혹은 haben?", "E4" => "관사를 채우세요.", "E5" => "kein 혹은 nicht?", "E6" => "보기와 같이 문장을 만드세요.")
	),
	5 =>
	array(
		"A" => array("A1" => "사람들은 어디 있고 무엇을 하나요?", "A2" => "읽고 각 그림에 해당하는<br>알맞은 단어를 찾아 넣으세요.", "A3" => "알맞게 분류하세요."),
		"B" => array("B1" => "내가 좋아 하는 음식", "B2" => "무엇을 즐겨 마시니?", "B4" => "나는 차라리 빵을 먹겠어요."),
		"C" => array("C1" => "그(녀)는 무엇을 먹고 마시나요?", "C2" => "무엇을 먹고 마시니?", "C4" => "식사: 팀 자거가 무엇을 먹고 마시나요?", "C5" => "식사: 모니카 마이는 무엇을 먹고 마시나요?", "C6" => "한국의 식사"),
	...
	6 =>
	array(
		"A" => array("A1" => "그들은 무엇하기를 좋아하나요?", "A2" => "무엇을 즐겨 하나(하지 않나)요?", "A3" => "가사일"),
		"B" => array("B0" => "몇시인가요?", "B1" => "시각을 듣고 메모를 하세요."),
		"C" => array("C1" => "듣고 따라 하세요.", "C2" => "어떤 질문을 할까요?"),
		"D" => array("D1" => "무엇이 어디에 맞을까요? 써보세요.", "D2" => "무엇이 어디에 맞을까요? 써보세요."),
		"E" => array("E1" => "이 사람들은 무엇을 하나요?", "E2" => "ja, nein, doch로 대답하세요.", "E3" => "시각을 쓰세요.", "E4" => "분리 혹은 비분리 동사?", "E5" => "동사를 분류하세요.", "E6" => "그는 금요일에 실제로 무엇을 하나요?", "E7" => "다음 글을 읽으세요.")
	),
	7 =>
	array(
		"A" => array("A0" => "어디인가요?", "A1" => "주말에 뭐하세요?", "A2" => "주말에 무엇을 하고 싶나요?", "A3" => "행사 캘린더를 보면 무엇이 가능(불가능)한가요?"),
		"B" => array("B1" => "약속 I", "B2" => "약속 II (전화)", "B3" => "약속 III (채팅)", "B4" => "무엇이 알맞은가요?", "B5" => "약속 III (문자메시지)", "B6" => "문자메시지 상에서의 공손한 거절"),
		"C" => array("C1" => "무엇을 할 수 있고 해야만 하고 해도 되나요?", "C2" => "무엇을 해야만 하고 하려고 하고 하고싶어 하나요?", "C3" => "무엇을 할 수 있고, 해서는 안되고 해야만 할까요?", "C4" => "텍스트를 읽고 모든 동사에 줄을 그으세요.", "C6" => "지시문: 순서대로 나열하세요.", "C7" => "대화문을 듣고 채우세요."),
		"D" => array("D1" => "어느 그림에 무엇이 맞나요?", "D2" => "빈칸을 채우세요.", "D3" => "괄호안에 알맞은 형태의 화법조동사를 넣으세요.", "D4" => "빈칸을 채우세요.", "D5" => "어디로 가는 것이 좋은가요?", "D6" => "밑줄친 단어를 이용해 문장을 다시 써보세요.", "D7" => "빈칸에 um, am 또는 in 중 알맞은 전치사를 넣어 보세요.", "D8" => "다음 전화통화 내용에 알맞은 답을 넣어 문장을 완성해 보세요.")
	)
,
	8 =>
	array(
	...
	array(
		...
		"D" => array("D1" => "초대장을 써보세요. 순서에 맞게 문장을 써보세요.", "D2" => "알맞은 인칭대명사를 쓰세요.", "D3" => "집들이 파티에 초장을 쓰세요.", "D4a" => "나의 스무번째 생일", "D4b" => "듣고 알맞은 과거분사형을 채우세요.", "D4c" => "듣고 알맞은 답을 선택하세요."),
		"E" => array("E1" => "축일과 계절", "E2" => "축일 이름은?", "E3" => "날짜를 쓰세요.", "E4" => "아래의 사람들이 생일을 맞이하였어요. 그들에게 무엇을 선물할까요?", "E5" => "나의 가장 아름다운 축일", "E6" => "언제 이렇게 말하지요?", "E7" => "3격 인칭대명사와 동사를 올바르게 써넣으세요.", "E8" => "1,3,4격 인칭대명사를 넣으세요.", "E9a" => "과거형", "E9b" => "haben과 sein의 과거형", "E10a" => "완료형에서 조동사 haben 혹은 sein 중 어느 것이 맞나요?", "E10b" => "현재완료형", "E11" => "완료형", "E12" => "한국의 설날은 어떻게 보내셨나요? 한국인 미나에게 써보세요.")
	),
	10 =>
	array(
		...
		"E" => array("E1a" => "어디에 참새가 있나요?", "E1b" => "어디로 참새가 날라가나요?", "E2a" => "문장을 채우세요.", "E2b" => "문장을 채우세요.", "E3" => "가르텐시의 어디서 무엇을 할 수 있나요?", "E4" => "상자안의 표현구들을 표안에 넣으세요.", "E5" => "실례하지만...", "E6" => "어떻게 ... 가야할까요?", "E7a" => "문장을 대화문을 듣고 빈칸을채우세요: 알렉산더 플라자", "E7b" => "문장을 대화문을 듣고 빈칸을채우세요: 프라우엔 교회", "E7c" => "문장을 대화문을 듣고 빈칸을채우세요: 버스 정류장", "E8" => "과거분사형태에 따라 구분해보세요.", "E10" => "완료형을 넣으세요.", "E11" => "드레스덴에서의 나의 휴가")
	)
...
?>
	...
	<?php
		if(!($fn == "inthebeginning" || $fn == "Deutschland")) {
			echo("<div class=\"font-weight-bold rounded p-1 px-2 text-gray-light d-inline-flex\">\n");
			echo("Reihe ".$r);
			if($ds) {
				if($da == "Quizzzz") {
					echo(" - Quiz\n");

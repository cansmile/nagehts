<?php require_once("heading.php"); ?>
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        ...
        <br>
        <button type="button"
            class="btn btn-<?php echo($color); ?> btn-sm d-inline" disabled>
            HV
        </button>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 mb-4 mt-2 py-2 text-center">
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="A">
                        <strong>A</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="B">
                        <strong>B</strong>e
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="C">
                        <strong>C</strong>e
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="D">
                        <strong>D</strong>e
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="E">
                        <strong>E</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="F">
                        e<strong>F</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="G">
                        <strong>G</strong>e
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="H">
                        <strong>H</strong>a
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="I">
                        <strong>I</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="J">
                        <strong>J</strong>ot
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="K">
                        <strong>K</strong>a
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="L">
                        e<strong>L</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="M">
                        e<strong>M</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="N">
                        e<strong>N</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="O">
                        <strong>O</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="P">
                        <strong>P</strong>e
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="Q">
                        <strong>Q</strong>u
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="R">
                        e<strong>R</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="S">
                        e<strong>S</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="T">
                        <strong>T</strong>e
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="U">
                        <strong>U</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="V">
                        <strong>V</strong>au
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="W">
                        <strong>W</strong>e
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="X">
                        i<strong>X</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="Y">
                        <strong>Y</strong>psilon
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="Z">
                        <strong>Z</strong>et
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="Ä">
                        <strong>Ä</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="Ö">
                        <strong>Ö</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="Ü">
                        <strong>Ü</strong>
                    </button>
                    -
                    <button type="button"
                        class="btn btn-outline-primary my-2 btn-lg itm" id="ß">
                        <strong>ß</strong>
                    </button>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 text-center">
                    ...
                    <span>
                        ...
                        <button class="itm btn btn-sm btn-outline-dark"
                            id="wie_Anton">▶</button>
                    </span>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 text-center">
            ...
            <div class="row">
                <div class="col-lg-12 mb-4 mt-2 text-center">
                    ...
                    <br>
                    <div id="show"
                        class="border border-danger p-1 px-2 m-1 display-4">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="video-container rounded"><object width="320"
                            height="240">
                            <param name="movie"
                                value="https://www.youtube.com/v/N8JP3aSDqWY?version=3">
                            </param>
                            <param name="allowFullScreen" value="true">
                            </param>
                            <param name="allowscriptaccess" value="always">
                            </param><embed
                                src="https://www.youtube.com/v/N8JP3aSDqWY?version=3"

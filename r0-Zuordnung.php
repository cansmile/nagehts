                    ...
                    if ($("#wahl").visibility != "visible" && $(this).attr("id") == "chk") {
                        ...
                        $(".itm").each(function () {
                            ...
                            if ($(this).hasClass("ans" + (a))) {
                                ...
                                $(this).addClass("btn-sm text-danger fw-bold");
                                $(this).find(".tran").show();
                            }
                            ;
                            if ($(this).hasClass("text-danger")) {/* $(this).text().insertAfter($("lst-"+($(this).attr("id").substr(3,)))) */
                                for (var i = 1; i <= $(".itm-lst").length; i++) {
                                    if ($(this).hasClass("ans" + i)) {
                                        $(eval('"#lst-' + i + '"')).append("<button class=\"mt-1 mx-1 btn btn-lg btn-outline-dark w-100 text-warning bg-white fw-bold\">" + $(this).html() + "</button>");/* $(lstn).append(i); */
                                    }
                                }
                            }
                            ;

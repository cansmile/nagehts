            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        Hilfe!<span
                            class="tran"><br><small>도와주세요!</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn btn-lg btn-outline-dark ans1 itm so"
                        id="2">
                        Auf Wiedersehen!<span class="tran"><br><small>다시
                                만나요</small></span>
                    </button>
                    <button type="button"
                        ...
                        id="3">
                        Guten Tag!<span
                            class="tran"><br><small>안녕하세요(낮인사)</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn btn-lg btn-outline-dark ans5 itm so"
                        id="4">
                        Gute Nacht!<span class="tran"><br><small>안녕히
                                주무세요</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn btn-lg btn-outline-dark ans4 itm so"
                        id="5">
                        Danke. Das ist nett.<span class="tran"><br><small>감사합니다.
                                참 친절하시네요.</small></span>
                    </button>
                </div>
            </div>
            ...
            <div class="row" id="lsts">
                <div style="min-height: 320px;"
                    ...
                    <img style="width: 100%; height: auto;"
                        src=".\<?php echo($root); ?>images\Reihe 1\Reihe-1-A3-1.png"
                        class="ttl">
                </div>
                <div style="min-height: 320px;"
                    class="rounded-top border border-outline-dark itm-lst text-center text-dark col-xs-4 col-sm-4 col-md-4 col-lg-3 col-xl"
                    id="lst-2">
                    <img style="width: 100%; height: auto;"
                        src=".\<?php echo($root); ?>images\Reihe 1\Reihe-1-A3-2.png"
                        class="ttl">
                </div>
                <div style="min-height: 320px;"
                    class="rounded-top border border-outline-dark itm-lst text-center text-dark col-xs-4 col-sm-4 col-md-4 col-lg-3 col-xl"
                    id="lst-3">
                    <img style="width: 100%; height: auto;"
                        src=".\<?php echo($root); ?>images\Reihe 1\Reihe-1-A3-3.png"
                        class="ttl">
                </div>
                <div style="min-height: 320px;"
                    class="rounded-top border border-outline-dark itm-lst text-center text-dark col-xs-4 col-sm-4 col-md-4 col-lg-3 col-xl"
                    id="lst-4">
                    <img style="width: 100%; height: auto;"
                        src=".\<?php echo($root); ?>images\Reihe 1\Reihe-1-A3-4.png"
                        class="ttl">
                </div>
                <div style="min-height: 320px;"
                    class="rounded-top border border-outline-dark itm-lst text-center text-dark col-xs-4 col-sm-4 col-md-4 col-lg-3 col-xl"
                    id="lst-5">
                    <img style="width: 100%; height: auto;"
                        src=".\<?php echo($root); ?>images\Reihe 1\Reihe-1-A3-5.png"
                        class="ttl">
                </div>
            </div>
            <!-- 리스트 끝 -->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: [
                    "./<?php echo($root); ?>sounds/Reihe 1/r1 A3.mp3"],
                sprite: {
                    "0": [297, 17192],
                    "1": [4569, 1406],
                    "2": [6832, 2129],

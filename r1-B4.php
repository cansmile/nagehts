			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 3. Ergänzen Sie die Lücken! Mädchen- oder Jungennamen? </a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="r1-B1.php">1. Hören Sie und sprechen Sie nach. </a><a class="dropdown-item" href="r1-B3.php">2. Wie heißt du?</a><a class="dropdown-item active" href="r1-B4.php">3. Ergänzen Sie die Lücken! Mädchen- oder Jungennamen? <span class="sr-only">(current)</span></a><a class="dropdown-item" href="r1-B5.php">4. Sortieren Sie die Namen nach Vor- und Familennamen.</a>
						</div>
					</li>
					<li class="nav-item">

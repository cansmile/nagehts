        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mb col-xs-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans15 btn-lg btn-outline-dark so itm"
                        id="2">
                        Andreas
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans25 btn-lg btn-outline-dark so itm"
                        id="3">
                        Angelika
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans18 btn-lg btn-outline-dark so itm"
                        id="4">
                        Anton
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans22 btn-lg btn-outline-dark so itm"
                        id="5">
                        Barbara
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans19 btn-lg btn-outline-dark so itm"
                        id="6">
                        Birgit
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans26 btn-lg btn-outline-dark so itm"
                        id="7">
                        Brigitte
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans17 btn-lg btn-outline-dark so itm"
                        id="8">
                        Christian
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans28 btn-lg btn-outline-dark so itm"
                        id="13">
                        Heike
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans23 btn-lg btn-outline-dark so itm"
                        id="15">
                        Helga
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans20 btn-lg btn-outline-dark so itm"
                        id="16">
                        Hilde
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans16 btn-lg btn-outline-dark so itm"
                        id="18">
                        Johann
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans14 btn-lg btn-outline-dark so itm"
                        id="20">
                        Karl
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans21 btn-lg btn-outline-dark so itm"
                        id="22">
                        Luisa
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans27 btn-lg btn-outline-dark so itm"
                        id="23">
                        Maja
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans24 btn-lg btn-outline-dark so itm"
                        id="27">
                        Monika
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans13 btn-lg btn-outline-dark so itm"
                        id="28">
                        Oliver
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans11 btn-lg btn-outline-dark so itm"
                        id="31">
                        Rudolf
                    </button>
                    <button type="button"
    ...
    <section>
        <div class="container">
            ...
            <div class="row" id="lsts">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 col-12 mt-1 1itm"
                    id="lst-2">
                    <table class="table table-borderless text-center">
                        <thead>
                            <tr>
                                <th colspan="4"bg-danger">
                                    여자 Vornamen </th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="row">
                <div class="col-12">
                    <table class="table table-borderless text-center">
                        ...
                        <tbody>
                            <tr>
                                <td>Müller Bauer Wecker Schneider Koch Schmidt
                                    Schumacher</td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: [
                    "./<?php echo($root); ?>sounds/Reihe 1/r1 B4.mp3"],
                sprite: {
                    "0": [0, 86740],
                    "1": [22435, 1792],
                    "2": [43808, 1671],

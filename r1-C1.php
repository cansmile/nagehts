                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                ...
                                <td>Guten Tag, Frau Kwan.<span
                                        class="tran"><br><small>안녕하세요, 권
                                            선생님.</small></span></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="tran"><br><small>안녕하세요, 박 선생님.
                                            어떻게 지내시나요?</small></span></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="tran"><br><small>감사합니다, 좋아요.
                                            선생님은요?</small></span></td>
                            </tr>
                            <tr>
                                ...
                                <td>Auch gut. Danke.<span
                                        class="tran"><br><small>저도 좋아요.
                                            감사해요.</small></span></td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: [
                    "./<?php echo($root); ?>sounds/Reihe 1/r1 C1.mp3"],
                sprite: {
                    "0": [881, 27414],
                    "1": [14064, 1935],
                    "2": [17037, 3635],

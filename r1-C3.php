			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 3. Wie geht es dir? </a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="r1-C2.php">1. Ordnen Sie zu</a> <a class="dropdown-item" href="r1-C1.php">2. Wie geht es Ihnen?</a> <a class="dropdown-item active" href="r1-C3.php">3. Wie geht es dir? <span class="sr-only">(current)</span></a>
						</div>
					</li>
					<li class="nav-item">

                ...
                <table class="table table-borderless table-light text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-leftt">Wie ist ihr Name?<span
                        ...
                        <tr>
                            ...
                            <td class="text-leftt">Ich heiße Maria Kim.<span
                        ...
                        <tr>
                            ...
                            <td class="text-leftt">Mina. Und du?<span
                        ...
                        <tr>
                            ...
                            <td class="text-leftt">Ja, mein Name ist Kim.<span
                        ...
                        <tr>
                            ...
                            <td class="text-leftt">Wie geht es dir?<span
                ...
                <table class="table table-borderless table-light text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-leftt">Danke, gut. Und dir?<span
                        ...
                        <tr>
                            ...
                            <td class="text-leftt">Was machen Sie ?<span
                        ...
                        <tr>
                            ...
                            <td class="text-leftt">Sind Sie Studentin?<span
                        ...
                        <tr>
                            ...
                            <td class="text-leftt">Woher kommen Sie?<span
                        ...
                        <tr>
                            ...
                            <td class="text-leftt">Kommen Sie aus Korea?<span
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: [
                    "./<?php echo($root); ?>sounds/Reihe 1/r1 G11.mp3"],
                sprite: {
                    "0": [1423, 62203],
                    "1": [8348, 4345],
                    "2": [14591, 4633],

        ...
        <div class="container">
            <div class="col-lg-12 mb-4 mt-2 text-center">
                ...
                <h3>[ <small><button type="button" class="btn disabled btn-sm btn-<?php echo($color); ?>">HV</button>
                        버튼 또는 <button type="button" class="so btn btn-sm btn-outline-secondary disabled">번호</button>
                        ...
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <button class="so btn btn-outline-dark" id="18">▶</button>
                                    <span class="h4 border border-dark bg-secondary text-white rounded p-1 px-2 m-1">Dialog 1</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th scope="row"><button type="button" id="6"
                                        class="so btn btn-outline-primary">1</button>
                                </th>
                                <td>
                                    Auf Wiedersehen!
                                    <span class="tran"><br><small>안녕히
                                            가세요!</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><button type="button" id="7"
                                        class="so btn btn-outline-success">2</button>
                                </th>
                                <td>
                                    Auf Wiedersehen!
                                    <span class="tran"><br><small>안녕히
                ...
                <div class="col-auto">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <button class="so btn btn-outline-dark" id="19">▶</button>
                                    <span class="h4 border border-dark bg-secondary text-white rounded p-1 px-2 m-1">Dialog 2</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="tran"><br><small>잘가, 에바!
                                            사랑해!</small></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Tschüs, Tim! Ich liebe dich auch! Gute
                                    Reise!
                                    <span class="tran"><br><small>안녕, 팀! 나도 사랑해!
                                            여행 잘해!</small></span>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="col-auto">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <button class="so btn btn-outline-dark" id="20">▶</button>
                                    <span class="h4 border border-dark bg-secondary text-white rounded p-1 px-2 m-1">Dialog 3</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    Guten Tag, Frau Kim!
                                    <span class="tran"><br><small>안녕하세요, 김
                                            선생님.</small></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Guten Tag, Herr Cho!
                                    <span class="tran"><br><small>안녕하세요, 조
                                            선생님!</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><button type="button" id="12"
                                        class="so btn btn-outline-primary">3</button>
                                </th>
                                <td>
                                    Willkommen in Dresden! Das ist für Sie!
                                    <span class="tran"><br><small>드레스덴에 오신 것을
                                            환영해요! 이거 받으세요!</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><button type="button" id="13"
                                        class="so btn btn-outline-success">4</button>
                                </th>
                                <td>
                                    Oh, Danke. Das ist nett!
                                    <span class="tran"><br><small>오, 고마워요. 정말
                                            친절하시네요!</small></span>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="col-auto">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <button class="so btn btn-outline-dark" id="21">▶</button>
                                    <span class="h4 border border-dark bg-secondary text-white rounded p-1 px-2 m-1">Dialog 4</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="tran"><br><small>안녕, 마틴!
                                            오랫만이다.</small></span>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="col-auto">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <button class="so btn btn-outline-dark" id="22">▶</button>
                                    <span class="h4 border border-dark bg-secondary text-white rounded p-1 px-2 m-1">Dialog 5</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="tran"><br><small>오, 우리 강아지!
                                            배고프니?</small></span>
                                </td>
                            </tr>
                        </tbody>

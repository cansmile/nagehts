                        ...
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <p class="display-4 so" id="18">Dialog 1</p>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="col-auto">
                    <table class="table table-borderless text-center">
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <p class="display-4 so" id="19">Dialog 2</p>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="col-auto">
                    <table class="table table-borderless text-center">
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <p class="display-4 so" id="20">Dialog 3</p>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="col-auto">
                    <table class="table table-borderless text-center">
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <p class="display-4 so" id="21">Dialog 4</p>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="col-auto">
                    <table class="table table-borderless text-center">
                        <thead>
                            <tr>
                                <th colspan="2" scope="col">
                                    <p class="display-4 so" id="22">Dialog 5</p>
                                </th>
                            </tr>
                        </thead>
                        <tbody>

	...
	<div class="container">
		...
		<section>
			<div class="container">
				...
				<div class="row">
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-9 text-center"><img src="./<?=$root ?>images/Reihe 10/Reihe-10-A3-1.png" alt="Wo ist das?" style="max-width: 100%; height: auto;"></div>
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
					<table class="table">
						<thead>
							<tr>
								<th scope="col" class="display-4 border-0">Dialog 1</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="border-0">
									...
									<ul type="square">
										<li><button type="button" id="11" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Im Hotel Augustin.
											<span class="tran"><br><small>호텔 아우구스틴에서요.</small></span></li>
									</ul>
									<ul type="circle">
										<li><button type="button" id="12" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Wo ist das, bitte?
											<span class="tran"><br><small>어디인가요?</small></span></li>
									</ul>
									<ul type="square">
				...
				<div class="row mt-3">
					<div class="col-12">
						<table class="table">
							<thead>
								<tr>
									<th scope="col" class="border-0"><span class="text-black bg-lime p-1 px-2 text-center rounded border border-success">TIPP</span></th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="border-0">장소를 나타내는 3,4격 전치사(Wechselpäpositionen) 중 공간1 개념(Raum1)으로 사용되는 전치사는 <strong>in</strong>, <strong>an</strong> 그리고 광장이나 거리를 의미 할때는 <strong>auf</strong>가 사용된다. 공공기관(우체국, 은행, 경찰서, 역 공항 등)을 나타날 때도 <strong>auf</strong> 가 사용된다.</td>
								</tr>
							</tbody>
						</table>
					</div>
							...
							<table class="table table-bordered text-center m-0">
								<tbody>
									<tr>
										...
										<td rowspan="2" class="border-0 align-middle">안에</td>
									</tr>
									<tr>
										<td height="100" class="align-middle"><span class="border border-dark bg-primary rounded p-3"><span class="border border-dark bg-orange rounded rounded-circle p-1 px-3"></span></span></td>
									</tr>
								</tbody>
							</table>
						</div>
							...
							<table class="table table-bordered text-center m-0">
								<tbody>
									<tr>
										...
										<td rowspan="2" class="border-0 align-middle">곁에</td>
									</tr>
									<tr>
										<td height="100" class="align-middle"><span class="border border-dark bg-orange rounded rounded-circle p-1 px-3"></span><span class="border border-dark bg-primary rounded p-3 px-4"></span></td>
									</tr>
								</tbody>
							</table>
						</div>
							...
							<table class="table table-bordered text-center m-0">
								<tbody>
									<tr>
										...
										<td rowspan="2" class="border-0 align-middle">위에</td>
									</tr>
									<tr>
										<td height="100" class="align-middle"><span class="border border-dark bg-orange rounded rounded-circle p-1 px-3" style="position: relative; top: -14px;"></span><br><span class="border border-dark bg-primary rounded p-3 px-4" style="position: relative; top: 6px;"></span></td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<div class="row">
					<div class="col-12">
						<table class="table">
							<thead>
								<tr>
									<th scope="col" class="border-0">1. 건물, 공간 안에 있는 경우:</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="border-0">im Park, im Restaurant, im Theater, im Krankenhaus, in der Bibliothek, in der Kirche</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="row">
					<div class="col-12">
						<table class="table">
							<thead>
								<tr>
									<th scope="col" class="border-0">2. 공공기관, 길, 광장의 경우:</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="border-0">auf der Bank, auf dem Rathaus, auf der Post, auf der Straße, auf dem Markt, auf dem Platz</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="row">
					<div class="col-12">
						<table class="table">
							...
							<tbody>
								<tr>
									<td class="border-0">Wechselpräpositionen (3,4격 지배전치사)가 정지상태일 경우(어디에, wo) 3격관사를 수반한다.</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="row text-center align-middle" style="line-height: 250%;">
					<div class="col-3 align-middle text-center p-0 border border-dark">Abkürzung<br>(<small>축약형</small>)</div>
					<div class="col-9">
						<div class="row">
							<div class="col-9">
								<div class="row">
									<div class="col-12 border border-dark">
										<div class="row">
											<div class="col-4 text-center align-middle">in, an(3, 4)<br>von(3)<br>bei(3)<br>zu(3)<br>&nbsp;</div>
											<div class="col-4 text-center align-middle">+ dem +</div>
											<div class="col-4 text-center align-middle">남성명사<br>중성명사</div>
										</div>
									</div>
								</div>
							</div>
							<div class="col-3">
								<div class="row">
									<div class="col-12 border border-dark">im<br>am<br>vom<br>beim<br>zum<br></div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-9">
								<div class="row">
									<div class="col-12 border border-dark">
										<div class="row">
											<div class="col-4 text-center align-middle">zu(3)</div>
											<div class="col-4 text-center align-middle">+ der +</div>
											<div class="col-4 text-center align-middle">여성명사</div>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="row pt-sm-3 pt-md-2 pt-lg-1">
					...
					<div class="col-6">
						<table class="table text-center">
							<tbody>
								<tr>
									<th rowspan="2" scope="col" class="border-0 bg-secondary text-white align-middle">Dativ</th>
									<th scope="col" class="border-0 text-primary bg-light">m</th>
									<th scope="col" class="border-0 text-danger bg-light">f</th>
									<th scope="col" class="border-0 text-purple bg-light">n</th>
									<th scope="col" class="border-0 text-khaki bg-light">Pl.</th>
								</tr>
								<tr>
									<td class="border-0 text-primary bg-light">dem</td>
									<td class="border-0 text-danger bg-light">der</td>
									<td class="border-0 text-purple bg-light">dem</td>
									<td class="border-0 text-khaki bg-light">den</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				ion.sound( {
					...
					$("#chk").on("click", function() {
						...
						if($("#itms").find("button").length < 1) {
							...
							var qa = $(".itm-lst").length-$(".itm-lst>.ttl").length; // 전체 문항 수

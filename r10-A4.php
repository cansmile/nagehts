    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12" id="itms">
                <button type="button"
                        class="mt-1 mx-1 btn ans15 btn-sm btn-outline-dark itm px-3"
                        id="1">
                    Wenn ich Aspirin holen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans13 btn-sm btn-outline-dark itm px-3"
                        id="2">
                    Wenn ich Bahnkarten besorgen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans12 btn-sm btn-outline-dark itm px-3"
                        id="3">
                    Wenn ich Brot holen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans17 btn-sm btn-outline-dark itm px-3"
                        id="4">
                    Wenn ich ein Paket senden will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans6 btn-sm btn-outline-dark itm px-3"
                        id="5">
                    Wenn ich eine Reise nach Spanien buchen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-sm btn-outline-dark itm px-3"
                        id="6">
                    Wenn ich übernachten will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans11 btn-sm btn-outline-dark itm px-3"
                        id="7">
                    Wenn ich einen Film sehen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans4 btn-sm btn-outline-dark itm px-3"
                        id="8">
                    Wenn ich essen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-sm btn-outline-dark itm px-3"
                        id="9">
                    Wenn ich beten will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans8 btn-sm btn-outline-dark itm px-3"
                        id="10">
                    Wenn ich Fleisch und Käse kaufen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans14 btn-sm btn-outline-dark itm px-3"
                        id="11">
                    Wenn ich frisches Gemüse und Obst kaufen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans5 btn-sm btn-outline-dark itm px-3"
                        id="12">
                    Wenn ich Geld abheben will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans16 btn-sm btn-outline-dark itm px-3"
                        id="13">
                    Wenn ich Gemälde aus dem Mittelalter besichtigen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-sm btn-outline-dark itm px-3"
                        id="14">
                    Wenn ich Blumen kaufen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans7 btn-sm btn-outline-dark itm px-3"
                        id="15">
                    Wenn ich Kaffee trinken und Kuchen essen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans10 btn-sm btn-outline-dark itm px-3"
                        id="16">
                    Wenn ich schwimmen will
                </button>
                <button type="button"
                        class="mt-1 mx-1 btn ans9 btn-sm btn-outline-dark itm px-3"
                        id="17">

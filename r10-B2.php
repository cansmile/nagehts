        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        class="mt-1 mx-1 btn ans16 btn-lg btn-outline-dark itm px-3"
                        id="1">
                        Berliner Straße
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans15 btn-lg btn-outline-dark itm px-3"
                        id="6">
                        die Brechtstraße
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans18 btn-lg btn-outline-dark itm px-3"
                        id="10">
                        Kino Megabox
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans13 btn-lg btn-outline-dark itm px-3"
                        id="18">
                        Telefonzelle
                    </button>
                    <button type="button"
        ...
        <div class="container">
            ...
            <div class="row mt-2">
                <div
                    ...
                    <span
                        class="border border-white p-1 px-2 rounded bg-dark">Dialog
                ...
                <div class="col-12 p-3" style="line-height: 250%;">
                    ...
                    . Gehen Sie
                    <div class="itm-lst 1itm d-inline-block px-0 m-0"
                        style="min-width: 200px;" id="lst-15">
                        <h2 class="btn btn-warning btn-xl ttl d-block">
                            ▼ </h2>
                    </div>
                    geradeaus bis zur
                    <div class="itm-lst 1itm d-inline-block px-0 m-0"
                        style="min-width: 200px;" id="lst-16">
                        <h2 class="btn btn-warning btn-xl ttl d-block">
                            ▼ </h2>
                    </div>
                    . Dort sehen Sie dann
                    ...
                    <div class="itm-lst 1itm d-inline-block px-0 m-0"
                        style="min-width: 200px;" id="lst-18">
                        <h2 class="btn btn-warning btn-xl ttl d-block">
                            ▼ </h2>
                    </div>
                    und dem
                    <div class="itm-lst 1itm d-inline-block px-0 m-0"
                        style="min-width: 200px;" id="lst-19">
                        <h2 class="btn btn-warning btn-xl ttl d-block">
                            ▼ </h2>
                    </div>
                    .

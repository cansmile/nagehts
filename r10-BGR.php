							...
							<tr>
								<td class="border-0 text-center">
									<div class="border border-dark rounded p-2 mx-auto">
										<img src="./images/Reihe 10/Reihe-10-BGR-1.png" alt="Wechselpräpositionen" style="max-width: 100%; height: auto;"><br>
			...
			<div class="row">
				<div class="col-sm-12 col-md-6 col-lg-4">
					<table class="table">
						<tbody>
							<tr>
								<td class="border-0 text-center" width="120" rowspan="2"><img src="./images/Reihe 10/Reihe-10-BGR-2.png" alt="Präpositionmen des Ortes" style="max-width: 100%; height: auto;"></td>
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					<table class="table">
						<tbody>
							<tr>
								<td class="border-0 text-center" width="120" rowspan="2"><img src="./images/Reihe 10/Reihe-10-BGR-3.png" alt="Präpositionmen des Ortes" style="max-width: 100%; height: auto;"></td>
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					<table class="table">
						<tbody>
							<tr>
								<td class="border-0 text-center" width="120" rowspan="2"><img src="./images/Reihe 10/Reihe-10-BGR-4.png" alt="Präpositionmen des Ortes" style="max-width: 100%; height: auto;"></td>
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					<table class="table">
						<tbody>
							<tr>
								<td class="border-0 text-center" width="120" rowspan="2"><img src="./images/Reihe 10/Reihe-10-BGR-5.png" alt="Präpositionmen des Ortes" style="max-width: 100%; height: auto;"></td>
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					<table class="table">
						<tbody>
							<tr>
								<td class="border-0 text-center" width="120" rowspan="2"><img src="./images/Reihe 10/Reihe-10-BGR-6.png" alt="Präpositionmen des Ortes" style="max-width: 100%; height: auto;"></td>
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					<table class="table">
						<tbody>
							<tr>
								<td class="border-0 text-center" width="120" rowspan="2"><img src="./images/Reihe 10/Reihe-10-BGR-7.png" alt="Präpositionmen des Ortes" style="max-width: 100%; height: auto;"></td>
								<td class="border-0"><small>(공간) ~위로, 위에</small>
								</td>
							</tr>
							<tr>
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					<table class="table">
						<tbody>
							<tr>
								<td class="border-0 text-center" width="120" rowspan="2"><img src="./images/Reihe 10/Reihe-10-BGR-8.png" alt="Präpositionmen des Ortes" style="max-width: 100%; height: auto;"></td>
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					<table class="table">
						<tbody>
							<tr>
								<td class="border-0 text-center" width="120" rowspan="2"><img src="./images/Reihe 10/Reihe-10-BGR-9.png" alt="Präpositionmen des Ortes" style="max-width: 100%; height: auto;"></td>
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					<table class="table">
						<tbody>
							<tr>
								<td class="border-0 text-center" width="120" rowspan="2"><img src="./images/Reihe 10/Reihe-10-BGR-10.png" alt="Präpositionmen des Ortes" style="max-width: 100%; height: auto;"></td>
					...
					<table class="table table-striped text-center" style="line-height: 250%;">
						<tbody>
							<tr>
								...
								<td class="border-0 align-middle">in<br>an<br>von<br>bei<br>zu</td>
							...
							<tr>
								...
								<td class="border-0 align-middle">zu</td>
								<td class="border-0 align-middle">+</td>
							...
							<tr>
								...
								<td class="border-0 align-middle">in<br>an</td>
								<td class="border-0 align-middle">+</td>
				...
				if($(this).attr("id")=="done") {}
					...
					i++) {
						...
						if(rfchk($("#qst-"+(i+1)), true)) {
							...
							if( !$.isArray(an[i])) {
								$("#qst-"+(i+1)).after("<div class=\"d-block text-dark bg-warning rounded p-1 m-1 px-2 font-weight-bold\" style=\"position: relative; top: -6px; max-width: 100px; min-width: 100px;\">"+an[i]+"</div>");}
							else {
								// 2 이상인 경우
								var r = "<div class=\"d-block text-dark bg-warning rounded p-1 m-1 px-2 font-weight-bold\" style=\"position: relative; top: -6px; max-width: 100px; min-width: 100px;\">";

...
<!-- 알림 끝 -->
	<section>
		<div class="container">
			...
			<div class="row">
				<div class="col-12"><img src="./<?php echo($root); ?>images/Reihe 10/Reihe-10-c3.png" alt="Wohin und wie wollen sie fahren (gehen)?" style="max-width: 100%; height: auto;"></div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 my-2">
					<table class="table">
						<thead>
							<tr>
								<th colspan="2" scope="col" class="border-0 display-4 bg-light text-center"><small>Dialog 1</small><divborder class="border border-dark bg-success text-white rounded-circle px-4 font-weight-bold">&nbsp;</divborder></th>
							</tr>
						</thead>
						<tbody>
							<tr>
				...
				<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 my-2">
					<table class="table">
						<thead>
							<tr>
								<th colspan="2" scope="col" class="border-0 display-4 bg-light text-center"><small>Dialog 2</small><divborder class="border border-dark bg-primary text-white rounded-circle px-4 font-weight-bold">&nbsp;</divborder></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td class="border-0" style="line-height: 250%;">
									<div class="input-group">VW-Gläserne Manufaktur mit der
	...
	<li>Vielen Dank. Wiedersehen!</li>
				...
				<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 my-2">
					<table class="table">
						<thead>
							<tr>
								<th colspan="2" scope="col" class="border-0 display-4 bg-light text-center"><small>Dialog 3</small><divborder class="border border-dark bg-pink text-white rounded-circle px-4 font-weight-bold">&nbsp;</divborder></th>
							</tr>
						</thead>
						<tbody>
							<tr>

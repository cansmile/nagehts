                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="lh250">
                                    <div class="input-group d-inline">
                                        ...
                                        어미가 <input autocomplete="off" type="text" class="form-control q ps-0 rounded-0
                            ...
                            <tr>
                                ...
                                <td class="lh250">
                                    <div class="input-group d-inline">
                                        규칙변화동사들은<input autocomplete="off" type="text" class="form-control q ps-0 rounded-0
                                        border-bottom-only mx-1 px-2 py-1 text-center border-dark d-inline-block t-6"
                                            style="max-width: 100px; min-width: 50px;" aria-label="." id="qst-20">로 그리고
                                        불규칙
                                        변화 동사들은<input autocomplete="off" type="text" class="form-control q ps-0 rounded-0
                                        border-bottom-only mx-1 px-2 py-1 text-center border-dark d-inline-block t-6"
                            ...
                            <tr>
                                ...
                                <td class="lh250">
                                    <div class="input-group d-inline">
                                        전철과 함께 오는 (불)규칙동사들은<input autocomplete="off" type="text" class="form-control q ps-0 rounded-0
                            ...
                            <tr>
                                ...
                                <td class="lh250">
                                    <div class="input-group d-inline">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control q ps-0 rounded-0 border-bottom-only
                                        ...
                                        과거분사형은<input autocomplete="off" type="text" class="form-control q ps-0 rounded-0
                                        border-bottom-only mx-1 px-2 py-1 text-center border-dark d-inline-block t-6 w-50"
                            ...
                            <tr>
                                ...
                                <td class="lh250">
                                    <div class="input-group d-inline">
                                        -ieren 동사들의 과거분사형은<input autocomplete="off" type="text" class="form-control q ps-0 rounded-0
                                        border-bottom-only mx-1 px-2 py-1 text-center border-dark d-inline-block t-6"

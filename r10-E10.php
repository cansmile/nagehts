        ...
        <div class="container">
            ...
            <div class="row my-2 py-2">
                <div class="col" style="line-height: 250%;">
                    <span
                        class="border border-dark rounded p-2">angekommen</span>
                    <span
                        class="border border-dark rounded p-2">angerufen</span>
                    <span
                        class="border border-dark rounded p-2">angezogen</span>
                    ...
                    <span
                        class="border border-dark rounded p-2">funktioniert</span>
                    <span
                        class="border border-dark rounded p-2">geblieben</span>
                    ...
                    <span
                        class="border border-dark rounded p-2">gesprochen</span>
                    <span
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-5 border border-dark rounded m-4 p-3"
                    style="line-height: 250%;">
                    <div class="input-group">
                        1. Musst du ihn noch <input type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                ...
                <div class="col-sm-12 col-md-12 col-lg-5 border border-dark rounded m-4 p-3"
                    style="line-height: 250%;">
                    <div class="input-group">
                        2. Warum gehst du nicht mit uns ins Kino? Früher <input
                            type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-3">du doch immer mit uns ins
                        Kino <input type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-4">.
                ...
                <div class="col-sm-12 col-md-12 col-lg-5 border border-dark rounded m-4 p-3"
                    style="line-height: 250%;">
                    <div class="input-group">
                        3. Suchst du immer noch die Tasche? Nein, ich <input
                            type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                        ...
                        <span class="tran">&nbsp;<small>여전히 가방을 찾고 있니? – 아니, 이미
                                찾았어.</small></span>
                    </div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-5 border border-dark rounded m-4 p-3"
                    style="line-height: 250%;">
                    <div class="input-group">
                        4. Wann kommst du denn an? Ich <input type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            ...
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-8">.
                        <span class="tran">&nbsp;<small>대체 언제 도착하니? – 어제 이미
                                도착했어.</small></span>
                    </div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-5 border border-dark rounded m-4 p-3"
                    style="line-height: 250%;">
                    <div class="input-group">
                        5. Will er sich nicht anziehen? Er <input type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                        ...
                        <span class="tran">&nbsp;<small>그가 옷을 안입으려고 하니? – 이미
                                입었어.</small></span>
                    </div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-5 border border-dark rounded m-4 p-3"
                    style="line-height: 250%;">
                    <div class="input-group">
                        6. Warum funktioniert der Apparat nicht? Gestern <input
                            type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-11">er noch gut <input
                            type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-12">.
                        <span class="tran">&nbsp;<small>이 기계가 왜 작동이 안될까요? 어제는 잘
                                되었는데요.</small></span>
                    </div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-5 border border-dark rounded m-4 p-3"
                    style="line-height: 250%;">
                    <div class="input-group">
                        7. Er ist ein interessanter Gesprächspartner. Ich <input
                            type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-13">lange mit ihm <input
                            type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-14">.
                        <span class="tran">&nbsp;<small>그는 재미있는 대화상대야. 그와 오랫동안
                                이야기했어.</small></span>
                    </div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-5 border border-dark rounded m-4 p-3"
                    style="line-height: 250%;">
                    <div class="input-group">
                        8. Ich <input type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-15">gestern Abend eine Pizza
                        <input type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-16">und eine Cola <input
                            type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                ...
                <div class="col-sm-12 col-md-12 col-lg-5 border border-dark rounded m-4 p-3"
                    style="line-height: 250%;">
                    <div class="input-group">
                        9. Wo <input type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"
                            aria-label="." id="qst-18">du denn so lange <input
                            type="text"
                            class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 150px; min-width: 100px;"

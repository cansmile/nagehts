...
<section class="nq-exercise" data-type="fill-blank" data-reihe="10">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 border border-dark rounded m-4 p-3 lh250">
                ...
                <div class="input-group">
                    ...
                    Stadtrundgang <input autocomplete="off" type="text" class="form-control q rounded-0 border-bottom-only mx-1 px-2
                        ...
                        col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 100px; min-width: 50px;" aria-label="."
                                         id="qst-5">.
                    <span class="tran">&nbsp;<small>7월 16일 일요일에 시내구경을
                                했다.</small>&nbsp;</span>
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    ...
                    Panorama.<span class="tran">&nbsp;<small>그곳은 경치가
                            ...
                            col-sm-12 col-md-6 col-md col-lg t-6" style="max-width: 100px; min-width: 50px;"
                                                                            aria-label="." id="qst-9"> ich auf dem
                    Orgelkonzert
...
<script>
    ...
    $(".ant").hide();
    var an = new Array();
    var an = ["2", "4", "1", "3", "gemacht", "besichtigt", "gemacht", "gab", "war"];

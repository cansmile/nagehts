	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12" id="itms">
				...
				<button type="button" class="mt-1 mx-1 btn ans9 btn-lg btn-outline-dark itm px-3" id="9">
				unter dem
				</button>
				<button type="button" class="mt-1 mx-1 btn ans5 btn-lg btn-outline-dark itm px-3" id="10">
				zwischen den
				</button>
				<button type="button" class="mt-1 mx-1 btn ans8 btn-lg btn-outline-dark itm px-3" id="11">
				über dem
				</button>
			</div>
		</div>
		...
		<section>
			<div class="container">
				...
				<div class="row">
					<div class="col-12"><img src="./<?php echo($root); ?>images/Reihe 10/Reihe-10-E-2-1.png" alt="Wo sind die Gegenstände im Zimmer?" style="max-width: 100%; height: auto;"></div>
				</div>
				<div class="row mt-2">
								...
								<tr>
									...
									<td class="border-0">
										<div class="itm-lst 1itm" id="lst-1">
											Das Bild hängt&nbsp;<h2 class="btn btn-warning btn-lg ttl d-inline-block" style="position: relative; top: 6px;">
											▼ </h2>&nbsp;Wand.<span class="tran"><br><small>그림은 벽에 걸려 있습니다.</small></span>
										</div>
									</td>
								</tr>
							</tbody>
								...
								<tr>
									...
									<td class="border-0">
										<div class="itm-lst 1itm" id="lst-4">
											Der Kaktus steht&nbsp;<h2 class="btn btn-warning btn-lg ttl d-inline-block" style="position: relative; top: 6px;">
											▼ </h2>&nbsp;Stuhl.<span class="tran"><br><small>선인장은 의자 뒤에 있습니다.</small></span>
										</div>
									</td>
								</tr>
							</tbody>
								...
								<tr>
									...
									<td class="border-0">
										<div class="itm-lst 1itm" id="lst-5">
											Der Computer ist&nbsp;<h2 class="btn btn-warning btn-lg ttl d-inline-block" style="position: relative; top: 6px;">
											▼ </h2>&nbsp;Büchern und der Kaffeetasse.<span class="tran"><br><small>컴퓨터는 책과 커피잔 사이에 있습니다.</small></span>
										</div>
									</td>
								</tr>
							</tbody>
								...
								<tr>
									...
									<td class="border-0">
										<div class="itm-lst 1itm" id="lst-6">
											Die Blumen sind&nbsp;<h2 class="btn btn-warning btn-lg ttl d-inline-block" style="position: relative; top: 6px;">
											▼ </h2>&nbsp;Mülleimer.<span class="tran"><br><small>꽃은 휴지통 안에 있습니다.</small></span>
										</div>
									</td>
								</tr>
							</tbody>
						...
						<table class="table text-center">
							<tbody>
								<tr>
									...
									<td class="border-0">
										<div class="itm-lst 1itm" id="lst-2">
											Der Spatz sitzt&nbsp;<h2 class="btn btn-warning btn-lg ttl d-inline-block" style="position: relative; top: 6px;">
											▼ </h2>&nbsp;Stuhl.<span class="tran"><br><small>참새는 의자 위에 있습니다.</small></span>
										</div>
									</td>
								</tr>
							</tbody>
								...
								<tr>
									...
									<td class="border-0">
										<div class="itm-lst 1itm" id="lst-9">
											Das Geld liegt&nbsp;<h2 class="btn btn-warning btn-lg ttl d-inline-block" style="position: relative; top: 6px;">
											▼ </h2>&nbsp;Stuhl.<span class="tran"><br><small>돈은 의자 아래 있습니다.</small></span>
										</div>
									</td>
								</tr>
							</tbody>
								...
								<tr>
									...
									<td class="border-0">
										<div class="itm-lst 1itm" id="lst-8">
											Die Lampe hängt&nbsp;<h2 class="btn btn-warning btn-lg ttl d-inline-block" style="position: relative; top: 6px;">
											▼ </h2>&nbsp;Bett.<span class="tran"><br><small>전등은 침대 위에 있습니다.</small></span>
										</div>
									</td>
								</tr>
							</tbody>
								...
								<tr>
									...
									<td class="border-0">
										<div class="itm-lst 1itm" id="lst-7">
											Das Handy liegt&nbsp;<h2 class="btn btn-warning btn-lg ttl d-inline-block" style="position: relative; top: 6px;">
											▼ </h2>&nbsp;Bett.<span class="tran"><br><small>휴대폰은 침대 아래 있습니다.</small></span>
										</div>
									</td>
								</tr>
							</tbody>

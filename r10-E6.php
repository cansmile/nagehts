                            ...
                            <tr>
                                <td class="lh350">
                                    <div class="input-group d-inline">
                                        ...
                                        Gehen Sie immer geradeaus <input autocomplete="off" type="text" class="form-control q ps-0
                                        ...
                                        links <input autocomplete="off" type="text" class="form-control q ps-0
                                        rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                                        d-inline-block t-6" style="max-width: 150px; min-width: 100px;"
                                        aria-label="." id="qst-2">
                                        Maxstraße.<span class="tran"><br><small>그런 다음 왼쪽
                                                막스슈트라세로 가세요.</small><br></span>
                                        Gehen Sie geradeaus <input autocomplete="off" type="text" class="form-control q ps-0
                                        rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                                        d-inline-block t-6" style="max-width: 150px; min-width: 100px;"
                                        aria-label="." id="qst-3">
                            ...
                            <tr>
                                <td class="lh350">
                                    <div class="input-group d-inline">
                                        ...
                                        Schwimmbad ist <input autocomplete="off" type="text" class="form-control q ps-0
                                        rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                                        d-inline-block t-6" style="max-width: 150px; min-width: 100px;"
                                        aria-label="." id="qst-9">
                            ...
                            <tr>
                                <td class="lh350">
                                    <div class="input-group d-inline">
                                        ...
                                        ist <input autocomplete="off" type="text" class="form-control q ps-0
                                        rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark
                                        d-inline-block t-6" style="max-width: 150px; min-width: 100px;"

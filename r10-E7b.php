				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
						<table class="table">
							<thead>
								<tr>
									<th colspan="2" scope="col" class="border-0 font-weight-bold bg-light text-black">Dialog 2: An der Frauenkirche:<span class="tran"><br><small>프라우엔키르헤에서</small><br></span></th>
								</tr>
							</thead>
							<tbody>
								<tr>
								...
								<tr>
									...
									<td class="border-0">
										Guten Tag, kann ich Ihnen helfen?<span class="tran"><br><small>안녕하세요, 제가 도와드릴까요?</small><br></span>
									</td>
								</tr>
								<tr>
									<td class="border-0"><button type="button" id="9" class="so btn btn-outline-dark btn-sm mr-1">▶</button></td>
									<td class="border-0">
										Ja, wir suchen das Theater.<span class="tran"><br><small>네, 우리는 극장을 찾고 있어요.</small><br></span>
									</td>
								</tr>
								<tr>
									<td class="border-0"><button type="button" id="10" class="so btn btn-outline-dark btn-sm mr-1">▶</button></td>
									<td class="border-0">
										Das Theater?<span class="tran"><br><small>극장이요?</small><br></span> Das ist in der Berliner Straße.<span class="tran"><br><small>베를리너슈트라세에 있어요.</small><br></span>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="border-0"><button type="button" id="13" class="so btn btn-outline-dark btn-sm mr-1">▶</button></td>
									<td class="border-0">
										Vielen Dank! Auf Wiedersehen.<span class="tran"><br><small>네, 대단히 감사합니다. 안녕히 가세요.</small><br></span>
									</td>
								</tr>
							</tbody>
						</table>

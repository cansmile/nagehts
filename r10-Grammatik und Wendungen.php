						...
						<div class="card-header" id="heading1">
							<h5 class="mb-0">
								<button class="btn btn-outline-danger mt-1 mx-1 btn-block" type="button" data-toggle="collapse" data-target="#collapse1" area-expanded="false" aria-controls="collapse1" id="1">
									<strong>F1. Wechselpräpositionen</strong> <small>3,4격 지배전치사</small>
								</button>
							</h5>
						</div>
										...
										<td colspan="5" class="border-0">
											<div class="row">
												...
												<div class="col">zwischen</div>
																		...
																		<tr>
										<td colspan="5" class="border-0 text-center align-middle"><img src="./<?php echo($root); ?>images/Reihe 10/Reihe-10-F.png" alt="Wechselpräpositionen"></td>
									</tr>
									<tr>
						...
						<div class="card-header" id="heading2">
							<h5 class="mb-0">
								<button class="btn btn-outline-orange mt-1 mx-1 btn-block" type="button" data-toggle="collapse" data-target="#collapse2" area-expanded="false" aria-controls="collapse2" id="2">
									<strong>F2. Redewendungen</strong> <small>어휘와 숙어</small>
								</button>
							</h5>
						</div>
						<div class="collapse" id="collapse2" aria-divledby="heading2" data-parent="#accordionitms">
							...
							<table class="table text-left bg-light">
								<tbody>
									...
									<tr>
										<td colspan="2">Gehen Sie immer geradeaus bis zum Friedenplatz. Dann links in die Maxstraße.<br>Gehen Sie geradeaus bis zur Post. Die Hannabank ist neben der Post.</td>
									</tr>
									<tr>
										<td colspan="2">Tut mir leid, das weiß ich nicht. / ... ich bin fremd hier. ...</td>
									</tr>
								</tbody>
							</table>
						</div>

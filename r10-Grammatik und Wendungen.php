...
<!-- 알림 끝 -->
<section class="nq-exercise" data-type="grammar" data-reihe="10">
    <div class="container">
        <div class="row">
            <div class="col-22">
                    ...
                    <div class="accordion-item">
                        <h5 class="accordion-header" id="flush-heading1">
                            <button class="text-danger bg-transparent accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapse1"><strong>F1.
                                    Wechselpräpositionen</strong><small>3,4격 지배전치사</small>
                            </button>
                        </h5>
                            ...
                            <div class="accordion-body">
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="row">
                                                ...
                                                <div class="col">hinter</div>
                                                <div class="col">in</div>
                                                <div class="col">neben</div>
                                                <div class="col">vor</div>
                                                <div class="col">unter</div>
                                                <div class="col">über</div>
                                                <div class="col">zwischen</div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" class="text-center align-middle"><img
                                                src="./dev/images/Reihe 10/Reihe-10-F.png" alt="Wechselpräpositionen">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="5%">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col">miut</div>
                                                <div class="col">nach</div>
                                                <div class="col">seit</div>
                                                <div class="col">von</div>
                                                <div class="col">zu</div>
                                                <div class="col">gegenüber</div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%" class="text-center"></td>
                                        <td width="15%" class="text-center">ge-<span class="wd_inline">&nbsp;</span>-t/-en
                                        </td>
                                        <td width="15%" class="text-center">ge-<span class="wd_inline">&nbsp;</span>-t/-en
                                        </td>
                                        <td width="15%" class="text-center"><span class="wd_inline">&nbsp;</span>-t/-en
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="7">
                                            <ul>
                                                <li>Ich bin gut in Dresden angekommen. Ich bin gleich mit der Tram in
                                                    die Stadtmitte gefahren und habe dort den Zwinger, die Frauenkirche
                                                    usw. besucht.
                                                </li>
                                            </ul>
                                        </td>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <td>
                                            <ul>
                                                <li>Ich gehe in den Blumenladen Schön, <span
                                                        class="wd_inline">wenn</span>ich Blumen kaufen <span
                    ...
                    <div class="accordion-item">
                        <h5 class="accordion-header" id="flush-heading2">
                            <button class="text-orange bg-transparent accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapse2"><strong>F2. Redewendungen</strong><small>어휘와
                                    숙어</small>
                            </button>
                        </h5>
                        <div id="flush-collapse2" class="accordion-collapse collapse" aria-labelledby="flush-heading2"
                            ...
                            <div class="accordion-body">
                                ...
                                <table class="table table-borderless text-start">
                                    ...
                                    <tr>
                                        <td width="30%" rowspan="3" class=" text-center align-middle">Entschuldigung,
                                        </td>
                                        <td>wir suchen</td>
                                        <td>einen Flohmarkt / ein Café / eine Bank.</td>
                                    </tr>
                                    <tr>
                                        <td>wo ist</td>
                                        <td>die Friedrichstraße? / der Reichstag?</td>
                                    </tr>
                                    <tr>
                                        <td>wie komme ich</td>
                                        <td>zum Alexanderplatz? / zur Schlossbrücke?</td>
                                    </tr>
                                    </tbody>
                                </table>
                                <table class="table table-borderless text-start bg-light">
                                    ...
                                    <tr>
                                        <td rowspan="2" class="align-middle">
                                            <div class="row">
                                                ...
                                                <div class="col-6 mx-1 px-1 lh250">Zuerst</div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-6 mx-1 px-1 lh250">Dann</div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td rowspan="3">
                                            <div class="row">
                                                ...
                                                <div class="col-6 mx-1 px-1">Danach</div>
                                            </div>
                                        </td>
                                        <td colspan="2">links / rechts, an der / dem ... vorbei. Dann sehen Sie den /
                                            das / die ...
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Gehen Sie immer geradeaus bis zum Friedenplatz. Dann links in
                                            die Maxstraße.<br>Gehen Sie geradeaus bis zur Post. Die Hannabank ist neben
                                            der Post.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Tut mir leid, das weiß ich nicht. / ... ich bin fremd hier.
                                            ...
                                        </td>
                                    </tr>
                                    </tbody>

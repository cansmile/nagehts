...
<!-- 알림 끝 -->
<section class="nq-exercise" data-type="fill-blank" data-reihe="11">
    <div class="container">
        <div class="row">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                1. Dieser Mantel ist der <input autocomplete="off" type="text"
                                                                ...
                                                                aria-label="."
                                                                id="qst-1"> bei uns. (neu, +++)
                            </div>
                            <span class="tran"><small>이 코트는 저희 매장에서 가장 신상품이예요. (neu, +++)</small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                2. Haben Sie auch <input autocomplete="off" type="text"
                                                         class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark t-6"
                                                         style="max-width: 100px; min-width: 150px;" aria-label="."
                                                         id="qst-2"> Jeans?(billig, ++)
                            </div>
                            <span class="tran"><small>더 싼 청바지도 있니요? (billig, ++)</small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                3. Dieses Kleid hier finde ich am <input autocomplete="off" type="text"
                                                                         class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark t-6"
                                                                         style="max-width: 100px; min-width: 150px;"
                                                                         aria-label="."
                                                                         id="qst-3">. (schön, +++.)
                            </div>
                            <span class="tran"><small>제 생각엔 여기 이 원피스가 가장 예쁘네요. (schön, +++.)</small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                4. Für den Sommer wäre die <input autocomplete="off" type="text"
                                                                  class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark t-6"
                                                                  style="max-width: 100px; min-width: 150px;"
                                                                  aria-label="."
                                                                  id="qst-4"> Bluse viel
                            ...
                            <span class="tran"><small>여름엔 더 얇은 이 브라우스가 훨씬 더 시원할거예요. (dünn, kühl, ++) </small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                5. Welche Srickjacke gefällt dir am <input autocomplete="off" type="text"
                                                                           class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark t-6"
                                                                           style="max-width: 100px; min-width: 150px;"
                                                                           aria-label="."
                                                                           id="qst-6">? (gut, +++.)
                            </div>
                            <span class="tran"><small>어떤 니트재킷이 제일 맘에 드니? (gut, +++.)</small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                6. Könnten Sie die Hose etwas <input autocomplete="off" type="text"
                                                                     class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark t-6"
                                                                     style="max-width: 100px; min-width: 150px;"
                                                                     aria-label="."
                                                                     id="qst-7"> machen?(kurz, ++.)
                            </div>
                            <span class="tran"><small>이 바지를 약간 더 짧게 해주실 수 있나요? (kurz, ++.)</small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                7. In diesem Kaufhaus gibt es die <input autocomplete="off" type="text"
                                                                         class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark t-6"
                                                                         style="max-width: 100px; min-width: 150px;"
                                                                         aria-label="."
                                                                         id="qst-8"> Laptops.(leicht, +++)
                            </div>
                            <span class="tran"><small>이 백화점에 가장 가벼운 노트북이 있어요.(leicht, +++)</small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                8. Leider haben wir gerade keinen <input autocomplete="off" type="text"
                                                                         class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark t-6"
                                                                         style="max-width: 100px; min-width: 150px;"
                                                                         aria-label="."
                                                                         id="qst-9"> Jogginganzug. (groß, ++)
                            </div>
                            <span class="tran"><small>죄송하지만 더 큰 조깅복은 지금 없어요. (groß, ++)</small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                9. Ich hole Ihnen eine Nummer <input autocomplete="off" type="text"
                                                                     class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark t-6"
                                                                     style="max-width: 100px; min-width: 150px;"
                                                                     aria-label="."
                                                                     id="qst-10">. (klein, ++)
                            </div>
                            <span class="tran"><small>한 치수 더 작은 걸로 가져다 드릴게요. (klein, ++)</small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col input-group">
                                10. Im Online-Shop kostet dieser Rock 200 Euro, im Outlet kostet er noch <input
                                ...
                                <input autocomplete="off" type="text"
                                       class="form-control q rounded-0 border-bottom-only mx-1 px-2 py-1 text-center border-dark t-6"
                                       style="max-width: 100px; min-width: 150px;" aria-label="."
                                       id="qst-12"> kostet er im Kaufhaus.(viel, ++, +++)
                            </div>
                            <span class="tran"><small>온라인숍에서 이 스커트는 200 유로인데, 아울렛에서는 더 비싸고, 백화점에서는 가장 비싸요. (viel, ++, +++)</small></span>
                        </td>
                    </tr>
                    </tbody>
                    </tr></thead></table>
...
<script>
    ...
    $(".ant").hide();
    var an = new Array();
    var an = ["neuste", "billigere", "dchönsten", "dünnere", "kühler", "besten", "kürzer", "leichtesten", "größeren", "kleiner", "mehr", "meisten"];
    $(document).ready(function () {
        ...
        var nagehts = new Howl({
            src: ["./dev/sounds/Reihe 11/r11 E4.mp3"],
            sprite: {
                "0": [518, 86311],
                "1": [10394, 4238],
                "2": [16487, 4650],

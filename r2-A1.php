<?php require "nav.php"; ?>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col"><img
                        src="./<?php echo($root); ?>images/Reihe 2/Reihe-2-A1-1.png"
                        style="max-width: 100%; height: auto;" alt="Eiffelturm">
                </div>
                <div class="col"><img
                        src="./<?php echo($root); ?>images/Reihe 2/Reihe-2-A1-2.png"
                        style="max-width: 100%; height: auto;"
                        alt="Freiheitsstatue"></div>
                <div class="col"><img
                        src="./<?php echo($root); ?>images/Reihe 2/Reihe-2-A1-3.png"
                        style="max-width: 100%; height: auto;"
                        alt="Griechischer Tempel"></div>
                <div class="col"><img
                        src="./<?php echo($root); ?>images/Reihe 2/Reihe-2-A1-4.png"
                        style="max-width: 100%; height: auto;"
                        alt="Amphitheater"></div>
                <div class="col"><img
                        src="./<?php echo($root); ?>images/Reihe 2/Reihe-2-A1-5.png"
                            ...
                            <tr>
                                <th scope="row" class="align-middle" id="th-1">
                                    <div class="itm-lst 1itm align-middle"
                                        id="lst-1">
                                        <h1
                                            class="btn btn-warning cmp btn-xl ttl d-block">
                                            ▼ </h1>
                                    </div>
                                </th>
                            </tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: [
                    "./<?php echo($root); ?>sounds/Reihe 2/r2 A1.mp3"],
                sprite: {
                    "0": [2378, 57789],
                    "1": [23474, 1277],
                    "2": [28129, 1240],
                ...
                onload: function () {
                    ...
                    $("#11").addClass(
                        "btn-block btn-outline-dark font-weight-bold"
                        );

				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<table class="table table-borderless table-light">
						<tr>
							...
							<td rowspan="4" class="text-center align-middle"><img src="./<?=$root ?>images/Reihe 2/Reihe-2-A2-1.png" style="max-width: 240px; height: auto;" alt="Sandmännchen"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>und ich wohne in 
								<div class="itm-lst 1itm d-inline-block mr-2" id="lst-2">
									<h2 class="btn btn-warning btn-xl ttl d-block" style="min-width: 150px;">
									▼ </h2>
								</div>.<br><span class="tran">&nbsp;<small>그리고 나는 <strong>베를린</strong>에 살아.</small></span></td>
						</tr>
					</table>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<table class="table table-borderless table-light">
						<tr>
							...
							<td rowspan="4" class="text-center align-middle"><img src="./<?=$root ?>images/Reihe 2/Reihe-2-A2-2.png" style="max-width: 240px; height: auto;" alt="Pororo"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>Ich wohne in 
								<div class="itm-lst 1itm d-inline-block mr-2" id="lst-4">
									<h2 class="btn btn-warning btn-xl ttl d-block" style="min-width: 150px;">
									▼ </h2>
								</div>.<br><span class="tran">&nbsp;<small>나는 <strong>서울</strong>에서 살아.</small></span></td>
						</tr>
					</table>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<table class="table table-borderless table-light">
						<tr>
							...
							<td rowspan="5" class="text-center align-middle"><img src="./<?=$root ?>images/Reihe 2/Reihe-2-A2-3.png" style="max-width: 150px; height: auto;" alt="Minnie Mouse"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>Ich wohne in 
								<div class="itm-lst 1itm d-inline-block mr-2" id="lst-6">
									<h2 class="btn btn-warning btn-xl ttl d-block" style="min-width: 150px;">
									▼ </h2>
								</div>.<br><span class="tran">&nbsp;<small>나는 <strong>캘리포니아</strong>에 살아.</small></span></td>
						</tr>
					</table>
				</div>
			</div>
...
var nagehts = new Howl({
	src: ["./<?=$root ?>sounds/Reihe 2/r2 A2.mp3"],
	sprite : {
		"0": [941, 56382],
		"1": [59835, 1353],
		"2": [67824, 1526],

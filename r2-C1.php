		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-2 text-center">
					<table class="table table-borderless" style="min-height: 100%;"><tr><td class="align-middle"><img src="./<?=$root ?>images/Reihe 2/Reihe-2-C1-1.png" style="max-width: 100%; height: auto;" alt="Dooly"></td></tr></table>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-2 text-center">
					<table class="table table-borderless" style="min-height: 100%;"><tr><td class="align-middle"><img src="./<?=$root ?>images/Reihe 2/Reihe-2-C1-2.png" style="max-width: 100%; height: auto;" alt="Kleopatra"></td></tr></table>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-4">
					<table class="table table-borderless table-light text-center">
						<tr>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-2 text-center">
					<table class="table table-borderless" style="min-height: 100%;"><tr><td class="align-middle"><img src="./<?=$root ?>images/Reihe 2/Reihe-2-C1-3.png" style="max-width: 100%; height: auto;" alt="Mickey Mouse"></td></tr></table>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-4">
					<table class="table table-borderless table-light text-center">
						<tr>
...
var nagehts = new Howl({
	src: ["./<?=$root ?>sounds/Reihe 2/r2 C1.mp3"],
	sprite : {
		"0": [1370, 55027],
		"1": [59017, 1264],
		"2": [67884, 1586],

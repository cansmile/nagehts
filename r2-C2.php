<?php require_once("heading.php"); ?>
    ...
    <section class="nq-exercise" data-type="dragtogroup" data-reihe="2">
        <div class="container">
            <!-- 고르는 아이템들 -->
            <div class="row">
                <div class="col-lg-12 mb-4 mt-2 text-center">
                    ...
                    <h3>[ <small><button type="button"
                            ...
                            버튼을 눌러 듣고 <br>알맞은 위치에 짝지우세요.</small> ]</h3>
                </div>
            </div>
            <div class="row">
                <div
                    ...
                    <table
                        ...
                        <tbody>
                            <tr>
                                <th class="align-middle py-0" scope="row">Korea
                                </th>
                                <td class="align-middle py-0"><button
                                        type="button" id="12"
                                        class="so btn btn-danger">▶</button>
                                </td>
                            </tr>
                            <tr>
                                <th class="align-middle py-0" scope="row">Japan
                                </th>
                                <td class="align-middle py-0"><button
                                        type="button" id="16"
                                        class="so btn btn-danger">▶</button>
                            ...
                            <tr>
                                <th class="align-middle py-0" scope="row">China
                                </th>
                                <td class="align-middle py-0"><button
                                        type="button" id="20"
                                        class="so btn btn-danger">▶</button>
                            ...
                            <tr>
                                <th class="align-middle py-0" scope="row">
                                    Deutschland</th>
                                <td class="align-middle py-0"><button
                                        type="button" id="24"
                                        class="so btn btn-danger">▶</button>
                            ...
                            <tr>
                                <th class="align-middle py-0" scope="row">die
                                    Schweiz</th>
                                <td class="align-middle py-0"><button
                                        type="button" id="32"
                                        class="so btn btn-danger">▶</button>
                ...
                <div
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="align-middle py-0">Österreicherin
                                </td>
                                <td class="align-middle py-0"><button
                                        type="button" id="30"
                                        class="so btn btn-danger">▶</button>

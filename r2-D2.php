                            ...
                            <tr>
                                ...
                                <tr>
                                    <td style="height: 65px;"><img
                                            src="./<?php echo($root); ?>images/Reihe 2/Reihe-2-D2-1.png"
                                            alt="Map"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle"><img
                                            src="./<?php echo($root); ?>images/Reihe 2/Reihe-2-D2-2.png"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: [
                    "./<?php echo($root); ?>sounds/Reihe 2/r2 D2.mp3"
                ],
                sprite: {
                    "0": [1138, 50607],
                    "1": [8245, 2950],
                                ...
                                function () {
                                    ...
                                    if ($(this)
                                        ...
                                        $(this)
                                            ...
                                            .addClass(
                                                "rounded bg-warning text-dark font-weight-bold m-2 p-1 px-2"
                                            );
                                    } else if (
                                        $(this)
                                        .hasClass(

            ...
            <div class="row">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 2/Reihe-2-E-1.png"
                                        alt="Herkunft"
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <table class="table table-borderless table-responsive">
                        <tbody>
                            <tr>
                                <th>1.</th>
                                <td>Peter kommt<span class="tran"><br><small>피터는
                                            <strong>독일에서</strong>
                                            왔다.</small></span></td>
                                <td>
                                    ...
                                    <div class="input-group">
                                        <input type="text" placeholder="Antwort"
                                            ...
                                            class="form-control q border-bottom-only rounded-0 px-1 t-6"
                                            id="qst-1">
                                        .
                                    </div>
                                </td>
                            ...
                            <tr>
                                <th>3.</th>
                                <td>Ivan kommt<span class="tran"><br><small>이반은
                                            <strong>러시아에서</strong>
                                            왔다.</small></span></td>
                                <td>
                            ...
                            <tr>
                                <th>7.</th>
                                <td>Arti kommt<span class="tran"><br><small>아르티는
                                            <strong>수단에서</strong>
                                            왔다.</small></span></td>
                                <td>
                            ...
                            <tr>
                                <th>8.</th>
                                <td>Linh kommt<span class="tran"><br><small>린은
                                            <strong>베트남에서</strong>
                                            왔다.</small></span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <th>9.</th>
                                <td>Xiao kommt<span class="tran"><br><small>샤오는
                                            <strong>중국에서</strong>
                                            왔다.</small></span>
                                </td>
                                <td>
                ...
                <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <th class="border border-dark" width="90"
                                    rowspan="15">aus</th>

                        ...
                        <thead>
                            <tr>
                                <th colspan="2" scope="col"><img
                                        src="./<?php echo($root); ?>images/Reihe 2/Reihe-2-E-2.png"
                                        alt="Herkunft"
                                ...
                                <td>
                                    <div class="my-1 text-center" id="sehen">
                                        <span class="wd">das Namdaemun
                                            ...
                                            Brandenburger Tor</span><span
                                            class="wd">der
                                            Eiffelturm</span><span
                                            class="wd">das Kolosseum</span><span
                                            class="wd">das Känguru</span><span
                            ...
                            <tr>
                                <td>
                                    <div class="my-1 text-center" id="city">
                                        <span class="wd">Berlin</span><span
                                            class="wd">New York</span><span
                                            class="wd">Giza</span><span
                                            class="wd">Paris</span><span
                                            class="wd">Seoul</span><span
                                            class="wd">Mexico City</span><span
                                            class="wd">Moshi</span><span
                                            class="wd">Peking</span><span
                                            class="wd">Rom</span><span
                                            class="wd">Sydney</span></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="my-1 text-center" id="coun">
                                        <span class="wd">Korea</span><span
                                            class="wd">Australien</span><span
                                            class="wd">Tanzania</span><span
                                            class="wd">Frankreich</span><span
                                            class="wd">Ägypten</span><span
                                            class="wd">Amerika</span><span
                                            class="wd">Deutschland</span><span
                                            class="wd">Italien</span><span
                                            class="wd">China</span><span
                                            class="wd">Mexico</span></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="my-1 text-center" id="land">
                                        <span class="wd">Südamerika</span><span
                                            class="wd">Nordamerika</span><span
                                            class="wd">Asien</span><span
                                            class="wd">Australien</span><span
                                            class="wd">Afrika</span><span
                                            class="wd">Europa</span></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <span class="tran"><br> <small
                                            class="text-dark">남대문은 어디에 있나요? 그것은
                                ...
                                <td>
                                    ...
                                    <div class="input-group lh250">
                                        ...
                                        Wo ist<input type="text"
                                            ...
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-1">Brandenburger Tor?
                                        <input type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon6"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-2">ist in Berlin, <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon7"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-3">. Deutschland liegt in
                                        <input type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                ...
                                <td>
                                    ...
                                    <div class="input-group lh250">
                                        ...
                                        <input type="text" placeholder="Antwort"
                                            ...
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-6"> ist in Rom, <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon11"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-7">. Italien liegt in <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                ...
                                <td>
                                    ...
                                    <div class="input-group lh250">
                                        ...
                                        <input type="text" placeholder="Antwort"
                                            ...
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-10"> ist in Paris, <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon15"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-11">. Frankreich ist in
                                        <input type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                ...
                                <td>
                                    ...
                                    <div class="input-group lh250">
                                        ...
                                        <input type="text" placeholder="Antwort"
                                            ...
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-14"> ist in Peking, <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon19"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-15">. China ist in <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                ...
                                <td>
                                    ...
                                    <div class="input-group lh250">
                                        ...
                                        <input type="text" placeholder="Antwort"
                                            ...
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-18"> ist in Giza, <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon23"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-19">. Ägypten ist in <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                ...
                                <td>
                                    ...
                                    <div class="input-group lh250">
                                        ...
                                        Wo ist <input type="text"
                                            ...
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-21"> Mt. Kilimanjaro?
                                        <input type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon26"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-22"> ist in Moshi, <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon27"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-23">. Tanzania ist in <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                ...
                                <td>
                                    ...
                                    <div class="input-group lh250">
                                        ...
                                        <input type="text" placeholder="Antwort"
                                            ...
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-26"> ist in Sydney, <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon31"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-27">. Australien ist in
                                        <input type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                ...
                                <td>
                                    ...
                                    <div class="input-group lh250">
                                        ...
                                        <input type="text" placeholder="Antwort"
                                            ...
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-30"> ist in New York, <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon35"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-31">. Amerika ist in <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                ...
                                <td>
                                    ...
                                    <div class="input-group lh250">
                                        ...
                                        <input type="text" placeholder="Antwort"
                                            ...
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-34"> ist in Mexico City,
                                        <input type="text" placeholder="Antwort"
                                            aria-label="Antwort"
                                            aria-describedby="basic-addon39"
                                            class="form-control q border-bottom-only rounded-0 mx-1 border-dark"
                                            style="min-width: 50px; max-width: 80px;"
                                            id="qst-35">. Mexico ist in <input
                                            type="text" placeholder="Antwort"
                                            aria-label="Antwort"

...
<section class="nq-exercise" data-type="grammar" data-reihe="2">
    <div class="container">
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="accordion-item">
                        <h5 class="accordion-header" id="flush-heading3">
                            <button class="text-warning bg-transparent accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapse3"><strong>F3.
                                    Verbkonjugation</strong><small>동사변화</small></button>
                        </h5>
                            ...
                            <div class="accordion-body">
                                <table class="table table-borderless table-striped text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>komm<strong>e</strong></td>
                                        <td>wohn<strong>e</strong></td>
                                        <td>sprech<strong>e</td>
                                        </strong>
                                        <td>lieg<strong>e</td>
                                        </strong></tr>
                                    <tr>
                                        <th class="text-center" scope="row">du</th>
                                        <td>komm<strong>st</strong></td>
                                        <td>wohn<strong>st</strong></td>
                                        <td>sprich<strong>st</strong></td>
                                        <td>lieg<strong>st</strong></td>
                                    </tr>
                                    <tr>
                                        <th class="text-center" scope="row">er/sie/es</th>
                                        <td>komm<strong>t</strong></td>
                                        <td>wohn<strong>t</strong></td>
                                        <td>sprich<strong>t</strong></td>
                                        <td>lieg<strong>t</strong></td>
                                    </tr>
                                    <tr>
                                        <th class="text-center" scope="row">Sie</th>
                                        <td>komm<strong>en</strong></td>
                                        <td>komm<strong>en</strong></td>
                                        <td>sprech<strong>en</strong></td>
                                        <td>lieg<strong>en</strong></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="accordion-body">
                                <table class="table table-borderless text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th width="25%" class="bg-light" width="33%" scope="col"><strong>Position
                                                2</strong></th>
                                        <th width="25%" scope="col">&nbsp;</th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr>
                                        <th scope="row" class="bg-light">Ja/Nein - Frage<small><br>예/아니오-의문문</small>
                                        </th>
...
<script>
    ...
    var nagehts = new Howl({
        ...
        src: ["./dev/sounds/Reihe 2/r2 F.mp3"],
        sprite: {
            "1": [222, 37337],
            "2": [7722, 2012],
            "3": [11499, 2159],

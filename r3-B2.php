...
<?php include "nav.php"; ?>
			...
			<div class="row">
				<div class="col-12">
					<table class="table table-borderless">
						<tbody>
							<tr>
								<th scope="row" rowspan="7" class="text-center align-middle"><img src="./<?php echo($root); ?>images/Reihe 3/Reihe-3-B2-1.png" style="max-width: 240px; height: auto;"></th>
	...
	$(document).ready(function() {
		...
		var nagehts=new Howl( {
			src: [ "./<?php echo($root); ?>sounds/Reihe 3/r3 B2.mp3"],
			sprite: {
				"0": [107, 31292],
				"1": [7875, 1674],
				"2": [10790, 4769],
			...
			onload: function() {
				...
				$(".q").on("keyup", function () {
					if($(this).val().length > 0) { var wid = (($(this).val().length)+2)*2+"em"; $(this).css("width",wid); } else { $(this).css("width",((8+2)*2+"em")); }

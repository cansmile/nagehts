...
<?php include "nav.php"; ?>
			...
			<div class="row">
				<div class="col-12">
					<table class="table table-borderless">
						<tbody>
							<tr>
								<th scope="row" rowspan="7" class="text-center align-middle"><img src="./<?=$root ?>images/Reihe 3/Reihe-3-B2-1.png" style="max-width: 240px; height: auto;"></th>
	...
	$(document).ready(function() {
		...
		var nagehts=new Howl( {
			src: [ "./<?=$root ?>sounds/Reihe 3/r3 B2.mp3"],
			sprite: {
				"0": [107, 31292],
				"1": [7875, 1674],
				"2": [10790, 4769],

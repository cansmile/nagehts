...
<?php require "nav.php"; ?>
			...
			<div class="row">
				<div class="col-12">
					<table class="table table-borderless">
						<tbody>
							<tr>
								<th scope="row" rowspan="12" class="text-center align-middle"><img src="./<?=$root ?>images/Reihe 3/Reihe-3-C1-1.png" style="max-width: 240px; height: auto;"></th>
	...
	$(document).ready(function() {
		...
		var nagehts=new Howl( {
			src: [ "./<?=$root ?>sounds/Reihe 3/r3 C1.mp3"],
			sprite: {
				"0": [812, 57094],
				"1": [13178, 1747],
				"2": [16160, 2233],

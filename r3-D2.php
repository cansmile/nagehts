		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12" id="itms">
					...
					<button type="button" class="mt-1 mx-1 btn ans7 btn-lg btn-outline-dark itm" id="2">
					Eva
					</button>
					<button type="button" class="mt-1 mx-1 btn ans8 btn-lg btn-outline-dark itm" id="3">
					Frankreich
					</button>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 mb-4 mt-2 text-center">
					...
					<h3>[ <small><button type="button" class="btn disabled btn-sm btn-<?php echo($color); ?>">HV</button> 버튼 또는 <button type="button" class="so btn btn-sm btn-outline-secondary disabled">▶</button> 버튼을 눌러 듣고, 각 항목에 알맞은 단어를 짝지우세요.</small> ]</h3>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-5 col-lg-5 col-xl-5">
					<table class="table-borderless text-center table table-striped table-sm">
						<tbody>
							<tr>

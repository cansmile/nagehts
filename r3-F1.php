				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
						<table class="table table-borderless">
							<thead>
								<tr>
									<th colspan="2" scope="col"><img src="./<?php echo($root); ?>images/Reihe 3/Reihe-3-F1.png" alt="Stammbaum" style="max-width: 100%; height: auto;"></th>
								</tr>
							</thead>
							<tbody>
								<tr>
...
var nagehts = new Howl({
	src: ["./<?php echo($root); ?>sounds/Reihe 3/r3 F1.mp3"],
	sprite : {
		"0": [1842, 130574],
		"10": [10137, 5435],
		"11": [17532, 5204],

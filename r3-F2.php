<?php require_once("heading.php"); ?>
    <section>
        <div class="container">
            ...
            <div class="row">
                <div
                    class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-4 mt-2 text-center">
                    <table class="table table-borderless text-center">
                        ...
                        <tbody>
                            <tr>
                                <td><span
                                        class="border border-dark rounded p-2 m-2">Mario</span><span
                                        class="border border-dark rounded p-2 m-2">13</span>
                                </td>
                            </tr>
                            <tr>
                                <td width="33%">
                                    <div class="ant t-6" id="ant-a"></div>
                                    <div class="input-group">
                                        Wer ist das?
                                    </div>
                                    <span
                                        class="tran"><small>누구인가요?</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <div
                    ...
                    <table class="table table-borderless text-center">
                        ...
                        <tbody>
                            <tr>
                                <td><span
                                        class="border border-dark rounded p-2 m-2">Caroline</span><span
                                        class="border border-dark rounded p-2 m-2">20</span>
                                </td>
                            </tr>
                            <tr>
                                <td width="33%">
                                    <div class="ant t-6" id="ant-b"></div>
                                    <span
                                        class="tran"><small>누구인가요?</small></span>
                                </td>
                            </tr>
                ...
                <div
                    ...
                    <table class="table table-borderless text-center">
                        ...
                        <tbody>
                            <tr>
                                <td><span
                                        class="border border-dark rounded p-2 m-2">Tanja</span><span
                                        class="border border-dark rounded p-2 m-2">3</span>
                                </td>
                            </tr>
                            <tr>
                                <td width="33%">
                                    <div class="ant t-6" id="ant-c"></div>
                                    <span
                                        class="tran"><small>누구인가요?</small></span>
                                </td>
                            </tr>
    ...
    <script>
        ...
        var an = new Array();
        var an = ["Mario", "er", "Er", ["13", "dreizehn"], "Caroline", "sie",
            "Sie", ["20", "zwanzig"], "Tanja", "sie", "Sie", ["3", "drei"]
        ];

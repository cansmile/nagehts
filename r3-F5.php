			...
			<div class="row">
				...
				<div class="col-12 mb-4 mt-2">
					<table class="table table-borderless">
						<thead>
							<tr>
								<th scope="col" class="text-center" width="50%"><img src="./<?php echo($root); ?>images/sym_frau.png" alt="Frau" style="max-height: 140px; width: auto;"></th>
								<th scope="col" class="text-center" width="50%"><img src="./<?php echo($root); ?>images/sym_mann.png" alt="Mann" style="max-height: 140px; width: auto;"></th>
							</tr>
						</thead>
						<tbody>
							<tr>
	...
	<script>
		...
		$(document).ready(function() {
			...
			var nagehts=new Howl( {
				src: ["./<?php echo($root); ?>sounds/Reihe 3/r3 F5.mp3"],
				sprite : {
					"0": [86, 50198],
					"1": [55962, 1288],
					"2": [73239, 1256],

                    ...
                    <div class="accordion" id="accordionitms">
                            ...
                            <div class="card-header" id="heading2">
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        <strong>G2. Ja / Nein Fragen und
                                            Antworten</strong> <small>“예”,
                                            “아니요”로 시작하는 의문문과 대답</small>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" id="heading3">
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        <strong>G3. Personalpronomen</strong>
                                        <small>인칭 대명사</small>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" id="heading4">
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        <strong>G4. Possessivartikel im
                                            Nominativ</strong> <small>주격의
                                            소유관사</small>
                                    </button>
                                </h5>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="heading5">
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        <strong>G5. Verbkonjugation</strong>
                                        <small>동사변화</small>
                                    </button>
                                </h5>
                            </div>
                            <div class="collapse" id="collapse5"
                                ...
                                data-parent="#accordionitms">
                                <table
                                    class="table table-borderless text-center align-middle table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col">&nbsp;</th>
                            ...
                            <div class="card-header" id="heading5">
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        <strong>G6. Redewendungen</strong>
                                        <small>어휘와 숙어</small>
                                    </button>
                                </h5>
                            </div>

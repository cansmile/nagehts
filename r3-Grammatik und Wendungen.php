                        ...
                        <div id="flush-collapse6" class="accordion-collapse collapse" aria-labelledby="flush-heading6"
                            ...
                            <div class="accordion-body">
                                ...
                                <table class="table table-borderless text-left">
                                    ...
                                    <tr>
                                        <th class="text-center align-middle m-2 p-2" colspan="2">
                                            <button type="button" id="26" class="so btn btn-outline-dark btn-sm mr-1">▶
                                            </button>
                                        </th>
                                    </tr>
                                    <tr>
                                ...
                                <table class="table table-borderless text-left bg-light">
                                    ...
                                    <tr>
                                        <th class="text-center align-middle m-2 p-2" colspan="2">
                                            <button type="button" id="35" class="so btn btn-outline-dark btn-sm mr-1">▶
                                            </button>
                                        </th>
                                    </tr>
                                    <tr>
                                ...
                                <table class="table table-borderless text-left">
                                    ...
                                    <tr>
                                        <th class="text-center align-middle m-2 p-2" colspan="2">
                                            <button type="button" id="42" class="so btn btn-outline-dark btn-sm mr-1">▶
                                            </button>
                                        </th>
                                    </tr>
                                    <tr>
                                ...
                                <table class="table table-borderless text-left">
                                    ...
                                    <tr>
                                        <th class="text-center align-middle m-2 p-2" colspan="2">
                                            <button type="button" id="54" class="so btn btn-outline-dark btn-sm mr-1">▶
                                            </button>
                                        </th>
                                    </tr>
                                    <tr>

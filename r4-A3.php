            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    ...
                    <button type="button"
                        ...
                        id="5">
                        der Balkon<span
                            class="tran"><br><small>발코니</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="7">
                        Kaffee trinken<span class="tran"><br><small>커피를
                                마시다</small></span>
                    </button>
                    <button type="button"
                        ...
                        id="8">
                        das Wohnzimmer<span
                            class="tran"><br><small>거실</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="9">
                        das Badezimmer<span
                            class="tran"><br><small>욕실</small></span>
                    </button>
                    <button type="button"
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" width="30%"
                                    class="align-middle">Wo?<span
                                        class="tran"><br><small>어디인가요?</small></span>
                                </th>
                                <th scope="col" width="30%"
                                    class="align-middle">Was tut man?<span
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <table
                        class="table table-borderless text-center d-sm-none d-md-none d-lg-block d-xl-block mb-0">
                        <thead>
                            <tr>
                                <th scope="col" width="40%"
                                    class="align-middle"><img

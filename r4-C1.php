		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 mb-4 mt-2 text-center">
					...
					<h3>[ <small>음성을 듣고 있는 것을 선택하세요.<br><button type="button" class="btn disabled btn-sm btn-<?=$color ?>">HV</button> 버튼 또는 <button type="button" class="so btn btn-sm btn-outline-secondary disabled">▶</button> 버튼을 눌러 듣기를 2번 완료하면 <br>문장과 번역이 나옵니다.</small> ]</h3>
				</div>
			</div>
			<div class="row">
								...
								<td>
									<div class="btn-group btn-group-toggle q" data-toggle="buttons" id="qst-1">
										<div class="btn btn-light pop o" data-toggle="popover" data-container="body" data-placement="top" data-content="정답!">
											<input type="radio" name="options" id="option1" autocomplete="off"><label for="option1"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C1-2.png" alt="Auto" style="max-width: 240px; height: auto;"></label>
										</div>
										<div class="btn btn-light pop x" data-toggle="popover" data-container="body" data-placement="top" data-content="정답이 아니에요.">
											<input type="radio" name="options" id="option2" autocomplete="off"><label for="option2"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C1-1.png" alt="Fahrrad" style="max-width: 240px; height: auto;"></label>
										</div>
									</div>
							...
							<tr>
								...
								<td>
									<div class="btn-group btn-group-toggle q" data-toggle="buttons" id="qst-2">
										<div class="btn btn-light pop x" data-toggle="popover" data-container="body" data-placement="top" data-content="정답이 아니에요.">
											<input type="radio" name="options" id="option3" autocomplete="off"><label for="option3"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C1-3.png" alt="Katze" style="max-width: 240px; height: auto;"></label>
										</div>
										<div class="btn btn-light pop o" data-toggle="popover" data-container="body" data-placement="top" data-content="정답!">
											<input type="radio" name="options" id="option4" autocomplete="off"><label for="option4"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C1-4.png" alt="Hund" style="max-width: 240px; height: auto;"></label>
										</div>
									</div>
							...
							<tr>
								...
								<td>
									<div class="btn-group btn-group-toggle q" data-toggle="buttons" id="qst-3">
										<div class="btn btn-light pop o" data-toggle="popover" data-container="body" data-placement="top" data-content="정답!">
											<input type="radio" name="options" id="option5" autocomplete="off"><label for="option5"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C1-6.png" alt="Frau" style="max-width: 240px; height: auto;"></label>
										</div>
										<div class="btn btn-light pop x" data-toggle="popover" data-container="body" data-placement="top" data-content="정답이 아니에요.">
											<input type="radio" name="options" id="option6" autocomplete="off"><label for="option6"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C1-5.png" alt="Mann" style="max-width: 240px; height: auto;"></label>
										</div>
									</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			var nagehts=new Howl( {
				src: ["./<?=$root ?>sounds/Reihe 4/r4 C1.mp3"],
				sprite : {
					"0": [3314, 46832],
					"1": [16497, 10565],
					"2": [29597, 10452],

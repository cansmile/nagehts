            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    ...
                    <button type="button"
                        ...
                        id="11">
                        der Radiergummi<span
                            class="tran"><br><small>지우개</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark so itm"
                        id="12">
                        die Buntstifte<span
                            class="tran"><br><small>색연필</small></span>
                    </button>
                    <button type="button"
                ...
                <div class="col-12" id="itms">
                    ...
                    <button type="button"
                        ...
                        id="15">
                        die Büroklammern<span
                            class="tran"><br><small>클립</small></span>
                    </button>
                    <button type="button"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-1-1.png"
                ...
                <div closs="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-1-2.png"
                                        alt="Was ist das?"
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-1-3.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-1-4.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-1-5.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-1-6.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-1-7.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless text-center">
                        <tbody>
                            <tr>
                                ...
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-2-1.png"
                                        style="max-width: 180px; height: auto;">
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-2-2.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-2-3.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-2-4.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-2-5.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-2-6.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="250" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-C2-2-7.png"
                                        alt="Was ist das?"
                                        style="max-width: 120px; height: auto;">
                                </td>
                            </tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: [
                    "./<?php echo($root); ?>sounds/Reihe 4/r4 C2a.mp3"],
                sprite: {
                    "0": [1455, 61038],
                    "8": [15937, 1703],
                    "9": [19577, 1694],

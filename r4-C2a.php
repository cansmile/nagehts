...
<?php include "nav.php"; ?>
	...
	<section class="bg-white rounded p-2" style="position: fixed; left: 0; bottom: 0; z-index: 9999; width: 100%;" id="wahl">
		<div class="container">
			<div class="row">
				...
				<div class="col bg-<?=$color ?> rounded text-center text-white font-weight-bold col-12 mt-1">Klaudia</div>
				...
				<div class="col bg-<?=$color ?> rounded text-center text-white font-weight-bold col-12 mt-1">Michael </div>
				<div class="col-12" id="itms">
					...
					<table class="table table-borderless">
						<tbody>
							<tr>
								...
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-1-1.png" style="max-width: 180px; height: auto;"></td>
							</tr>
							<tr>
				...
				<div closs="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-1-2.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-1-3.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-1-4.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-1-5.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-1-6.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-1-7.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
					...
					<table class="table table-borderless">
						<tbody>
							<tr>
								...
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-2-1.png" style="max-width: 180px; height: auto;"></td>
							</tr>
							<tr>
					...
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								...
								<img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-2-2.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-2-3.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-2-4.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-2-5.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-2-6.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
				...
				<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-xl-2">
					<table class="table table-borderless">
						<tbody>
							...
							<tr>
								<td height="250" class="align-middle"><img src="./<?=$root ?>images/Reihe 4/Reihe-4-C2-2-7.png" alt="Was ist das?" style="max-width: 120px; height: auto;"></td>
							</tr>
							<tr>
								<td>
	...
	<script src="./<?=$root ?>js/taptogroupnomoveh.js"></script>
	...
	$(document).ready(function() {
		...
		var nagehts=new Howl( {
			src: [ "./<?=$root ?>sounds/Reihe 4/r4 C2a.mp3"],
			sprite: {
				"0": [1455, 61038],
				"8": [15937, 1703],
				"9": [19577, 1694],

...
<?php include "nav.php"; ?>
	...
	<section>
		<div class="container">
			...
			<div class="row" id="lsts">
				<div style="min-height: 240px;" class="rounded-top bg-success itm-lst col-xs col-sm col-md col-lg pt-1 m-1" id="lst-1">
					<h2 class="btn btn-light btn-xl ttl d-block">
					sehr gut<span class="tran"><br />매우 좋은</span></h2>&nbsp;
				</div>
				<div style="min-height: 240px;" class="rounded-top bg-primary itm-lst col-xs col-sm col-md col-lg pt-1 m-1" id="lst-2">
					<h2 class="btn btn-light btn-xl ttl d-block">
					gut<span class="tran"><br />좋은</span></h2>&nbsp;
				</div>
				<div style="min-height: 240px;" class="rounded-top bg-khaki itm-lst col-xs col-sm col-md col-lg pt-1 m-1" id="lst-3">
					<h2 class="btn btn-light btn-xl ttl d-block">
	...
	$(document).ready(function() {
		...
		var nagehts=new Howl( {
			src: [ "./<?php echo($root); ?>sounds/Reihe 4/r4 D2.mp3"],
			sprite: {
				"0": [363, 103695],
				"1": [19991, 1757],
				"2": [23981, 1698],

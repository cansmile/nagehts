<?php require_once("heading.php"); ?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Das ist eine Küche.
                                    <span class="tran"><br><small>이것은
                                            부엌입니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="25"><button type="button" id="2"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td>Das da ist eine Einbauküche.
                                    <span class="tran"><br><small>여기 이것은 빌트인
                                            부엌입니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="25"><button type="button" id="3"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>이 부엌은 완비되어
                                            있습니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="tran"><br><small>가격은 999
                                            유로입니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="25"><button type="button" id="5"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>이것은 완비된
                                            부엌입니다.</small></span>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="col">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td width="25"><button type="button" id="7"
                                        class="so btn btn-outline-success">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>여기 이것은 디자이너
                                            테이블입니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="25"><button type="button" id="8"
                                        class="so btn btn-outline-success">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>이 디자이너 테이블은
                                            아름답습니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="25"><button type="button" id="9"
                                        class="so btn btn-outline-success">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>가격은 599
                                            유로입니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="25"><button type="button" id="10"
                                        class="so btn btn-outline-success">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>그것은 아름다운
                                            테이블입니다.
                                        </small></span>
                                </td>
                            </tr>
                ...
                <div class="col">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td width="25"><button type="button" id="12" class="so btn btn-outline-info">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>여기 이것은
                                            침대입니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="25"><button type="button" id="13" class="so btn btn-outline-info">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>이 침대는
                                            독창적입니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="25"><button type="button" id="14" class="so btn btn-outline-info">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>가격은 499
                                            유로입니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td width="25"><button type="button" id="15" class="so btn btn-outline-info">▶</button>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><br><small>그것은 독창적인
                                            침대입니다.</small></span>
                                </td>
                            </tr>
                        </tbody>
    ...
    <script>
        ...
        $(".tran").hide();
        var an = new Array();
        var an = ["Die", "Sie", "komplette", "ein", "da", "Der", "Er", "er",
            "ein", "ein", "Das", "Es", "es"
        ];

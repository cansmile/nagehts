            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        Bleistift<span
                            class="tran">&nbsp;<small>연필</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="7">
                        Ledersofa<span
                            class="tran">&nbsp;<small>가죽소파</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="8">
                        Kopfhörer<span
                            class="tran">&nbsp;<small>헤드폰</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark so itm"
                        id="9">
                    ...
                    <button type="button"
                        ...
                        id="10">
                        Kühlschrank<span
                            class="tran">&nbsp;<small>냉장고</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark so itm"
                        id="11">
                        Smartphone<span
                            class="tran">&nbsp;<small>스마트폰</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark so itm"
                        id="12">
    ...
    <section class="nq-exercise" data-type="dragtogroup" data-reihe="4">
        <div class="container">
            ...
            <div class="row" id="lsts">
                ...
                <div style="min-height: 240px;"
                    class="rounded-top bg-purple itm-lst col-6 col-sm-4 col-md-3 p-2"
                    id="lst-3">
                    <h2 class="btn btn-light btn-xl ttl w-100">
                        <strong>n</strong></h2>&nbsp;
                </div>

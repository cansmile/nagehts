                ...
                <table class="table table-borderless">
                    ...
                    <tr>
                        <th scope="row" class="align-middle text-center"
                            rowspan="4"><img
                                src="./dev/images/Reihe 4/Reihe-4-E3-1.png"
                        ...
                        <td>
                            ...
                            <div class="input-group">
                                ...
                                <input autocomplete="off" type="text" placeholder="Antwort"
                                       ...
                                       class="text-center form-control q border-bottom-only rounded-0 mx-1 t-6" style="max-width:120px"
                                       id="qst-1">
                                mit Paul verheiratet.
                            </div>
                            <span class="tran">Petra는 Paul과
                                        결혼했습니다.</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="pb-5">
                            ...
                            <span class="tran">그녀의 남편 Paul 또한
                                        목사입니다.</span>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="align-middle text-center"
                            rowspan="6"><img
                                src="./dev/images/Reihe 4/Reihe-4-E3-2.png"
                                style="max-width: 240px; height: auto;"
                                alt="Sabine"></th>
                        <td>
                            <div id="ant-5"></div>
                            ...
                            <span class="tran">Sabine과 Achim은 결혼하지
                                        않았습니다.</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <span class="tran">아이들은 아직 없지만, 고양이와 개는
                                        있습니다.</span>
                        </td>
                    </tr>
                    <tr>

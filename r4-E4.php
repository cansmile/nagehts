...
<body>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                            ...
                            <tr>
                                <th scope="row" colspan="2"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-E4-1.png"
                                        alt="Fernseher."
                                ...
                                <td>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Antwort"
                                            ...
                                            border-bottom-only rounded-0 ml-1 t-6"
                                            id="qst-1">
                                        Computer?
                                    </div>
                ...
                <div
                    class="col-sm-12 col-md-12 col-lg-5 col-xl-5 border-success border m-2 p-2">
                    <table class="table table-borderless table-striped">
                        <tbody>
                            <tr>
                                <th scope="row" colspan="2"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-E4-2.png"
                                        alt="Telefon"
                                        style="max-width: 240px; height: auto;">
                                </th>
                            </tr>
                ...
                <div
                    class="col-sm-12 col-md-12 col-lg-5 col-xl-5 border-primary border m-2 p-2">
                    <table class="table table-borderless table-striped">
                        <tbody>
                            <tr>
                                <th scope="row" colspan="2"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 4/Reihe-4-E4-3.png"
                                        alt="Brille"
                                        style="max-width: 240px; height: auto;">
                                </th>
                            </tr>
    ...
    <script>
        ...
        var an = new Array();
        var an = ["ein", "kein", "ein", "der", "ein", "kein", "ein", "das",
            "eine", "keine", "eine", "die"
        ];

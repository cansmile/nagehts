...
<body>
							...
							<div class="collapse" id="collapse1" aria-divledby="heading1" data-parent="#accordionitms">
								<table class="table table-borderless text-justify align-middle">
									<tbody>
										...
										<tr>
											<th scope="row" rowspan="3"><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="2" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">Was <strong>ist</strong> das?</div>
												</div>
											</th>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="3" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Das ist <span class="bg-secondary text-white px-2"><strong>ein</strong></span> Computer.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">- Das ist <span class="bg-secondary text-white px-2"><strong>eine</strong></span> Uhr.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">- Das ist <span class="bg-secondary text-white px-2"><strong>ein</strong></span> Smartphone.</div>
												</div>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<th scope="row" rowspan="3"><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Was <strong>haben</strong> Sie?</div>
												</div>
											</th>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="8" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Ich habe <span class="bg-secondary text-white px-2"><strong>einen</strong></span> Computer.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">- Ich habe <span class="bg-secondary text-white px-2"><strong>eine</strong></span> Uhr.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">- Ich habe <span class="bg-secondary text-white px-2"><strong>ein</strong></span> Smartphone.</div>
												</div>
											</td>
										</tr>
									</tbody>
										...
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Hier ist der Computer.</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="13" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">Ich habe den Computer.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Hier ist die Uhr.</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="15" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">Ich habe die Uhr.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Hier ist das Smartphone.</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="17" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">Ich habe das Smartphone.</div>
												</div>
											</td>
										</tr>
									</tbody>
										...
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Auf Ullungdo gibt es <strong>keine</strong> Universität.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Karla ist <strong>keine</strong> Telefonistin, sondern Sekretärin.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Er ist <strong>kein</strong> Engländer, sondern Amerikaner.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Sim Chung ist <strong>nicht</strong> alt.</div>
												</div>
											</td>
										</tr>
									</tbody>
										...
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie ist <u>der Schrank</u>?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="25" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- <strong>Er</strong> ist schön.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie ist <u>die Uhr</u>?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">- <strong>Sie</strong> ist altmodisch.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie ist <u>das Regal</u>?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="29" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- <strong>Es</strong> ist klein.</div>
												</div>
											</td>
										</tr>
									</tbody>
										...
										<tr>
											<td width="50%"><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie wohnen Sie?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="31" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Ich wohne in einem Apartment.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie heißt das Zimmer?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="33" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Das ist ein Wohnzimmer.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Was ist das?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="35" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Das ist ein Kugelschreiber.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie heißt das auf Deutsch?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="37" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Das ist ein Foto.</div>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">- Das ist eine Kamera.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie viele Zimmer hat Ihre Wohnung?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="40" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Sie hat 3 Zimmer, ein Wohnzimmer, ein Schlafzimmer und ein Kinderzimmer.</div>
												</div>
											</td>
										</tr>
									</tbody>
										...
										<tr>
											<td width="50%"><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Was hast du in deiner Schultasche?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="42" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Ich habe einen Kugelschreiber, ein Buch und Büroklammern.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Ist das ein Schrank?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="44" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Nein, das ist kein Schrank.</div>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Das ist ein Regal.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Ist das eine Vase?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="47" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Nein, das ist keine Vase. Das ist ein Glas.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Ist die Vase klein?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="49" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Nein, die Vase/sie ist nicht klein.</div>
												</div>
											</td>
										</tr>
									</tbody>
										...
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Ich habe einen Computer, eine Uhr und ein Regal.</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Er hat keinen Computertisch, keine Brille und kein Handy.</div>
												</div>
											</td>
										</tr>
									</tbody>
										...
										<tr>
											<td width="50%"><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie ist das Wohnzimmer?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="53" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Es ist dunkel/hell/schön/modisch/altmodisch...</div>
												</div>
											</td>
										</tr>
									</tbody>
										...
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Das ist ein Stuhl. Er kostet 77 Euro.</div>
												</div>
											</td>
										</tr>
									</tbody>
										...
										<tr>
											<td width="50%"><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie ist Ihre Adresse?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="56" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Meine Adresse ist ...</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie ist deine Telefonnummer?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="58" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Meine Telefonnummer ist ...</div>
												</div>
											</td>
										</tr>
										<tr>
											<td><div class="row">
												<div class="mx-1 px-1">
													...
													</div><div class="col-10 mx-1 px-1 lh250">Wie ist ihre Handynummer?</div>
												</div>
											</td>
											<td><div class="row">
												<div class="mx-1 px-1">
													<button type="button" id="60" class="so btn btn-outline-dark btn-sm mr-1">▶</button>
													</div><div class="col-10 mx-1 px-1 lh250">- Ihre Handynummer ist ...</div>
												</div>
											</td>
										</tr>
									</tbody>
	...
	<script>
		...
		var nagehts=new Howl( {
		    ...
		    src: ["./<?=$root ?>sounds/Reihe 4/r4 F.mp3"],
		    sprite : {
		        "1": [8878, 12771],
	            "2": [8878, 2716],
	            "3": [11785, 2576],

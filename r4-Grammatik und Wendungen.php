						...
						<div class="card">
							...
							<div class="collapse" id="collapse6" aria-divledby="heading6" data-parent="#accordionitms">
								<table class="table table-borderless text-left bg-light">
									<tbody>
										<tr>
											<td width="50%"><button type="button" id="30" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Wie wohnen Sie?</td>
											<td><button type="button" id="31" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Ich wohne in einem Apartment.</td>
										</tr>
										<tr>
											<td><button type="button" id="32" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Wie heißt das Zimmer?</td>
											<td><button type="button" id="33" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Das ist ein Wohnzimmer.</td>
										</tr>
										<tr>
											<td><button type="button" id="34" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Was ist das?</td>
											<td><button type="button" id="35" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Das ist ein Kugelschreiber.</td>
										</tr>
										<tr>
											<td><button type="button" id="36" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Wie heißt das auf Deutsch?</td>
											<td><button type="button" id="37" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Das ist ein Foto.</td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td><button type="button" id="38" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Das ist eine Kamera.</td>
										</tr>
										<tr>
											<td><button type="button" id="39" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Wie viele Zimmer hat Ihre Wohnung?</td>
											<td><button type="button" id="40" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Sie hat 3 Zimmer, ein Wohnzimmer, ein Schlafzimmer und ein Kinderzimmer.</td>
										</tr>
									</tbody>
								</table>
								<table class="table table-borderless text-left">
									<tbody>
										<tr>
											<td width="50%"><button type="button" id="41" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Was hast du in deiner Schultasche?</td>
											<td><button type="button" id="42" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Ich habe einen Kugelschreiber, ein Buch und Büroklammern.</td>
										</tr>
										<tr>
											<td><button type="button" id="43" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Ist das ein Schrank?</td>
											<td><button type="button" id="44" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Nein, das ist kein Schrank.</td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td><span class="ml-3"><button type="button" id="45" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Das ist ein Regal.</span></td>
										</tr>
										<tr>
											<td><button type="button" id="46" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Ist das eine Vase?</td>
											<td><button type="button" id="47" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Nein, das ist keine Vase. Das ist ein Glas.</td>
										</tr>
										<tr>
											<td><button type="button" id="48" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Ist die Vase klein?</td>
											<td><button type="button" id="49" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Nein, die Vase/sie ist nicht klein.</td>
										</tr>
									</tbody>
								</table>
								<table class="table table-borderless text-left bg-light">
									<tbody>
										<tr>
											<td><button type="button" id="50" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Ich habe einen Computer, eine Uhr und ein Regal.</td>
										</tr>
										<tr>
											<td><button type="button" id="51" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Er hat keinen Computertisch, keine Brille und kein Handy.</td>
										</tr>
									</tbody>
								</table>
								<table class="table table-borderless text-left">
									<tbody>
										<tr>
											<td width="50%"><button type="button" id="52" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Wie ist das Wohnzimmer?</td>
											<td><button type="button" id="53" class="so btn btn-outline-dark btn-sm mr-1">▶</button>- Es ist dunkel/hell/schön/modisch/altmodisch...</td>
										</tr>
									</tbody>
								</table>
								<table class="table table-borderless text-left bg-light">
									<tbody>
										<tr>
											<td><button type="button" id="54" class="so btn btn-outline-dark btn-sm mr-1">▶</button>Das ist ein Stuhl. Er kostet 77 Euro.</td>
										</tr>
									</tbody>
								</table>
								<table class="table table-borderless text-left">

                        ...
                        <tbody>
                            <tr>
                                <td class="align-middle text-center"
                                    height="300"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-A1-1.png"
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td class="align-middle text-center"
                                    height="300"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-A1-2.png"
                                        alt="Wo sind die Leute und was machen sie?"
                                        style="max-width: 240px; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td class="align-middle text-center"
                                    height="300"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-A1-3.png"
                                        alt="Wo sind die Leute und was machen sie?"
                                        style="max-width: 240px; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td class="align-middle text-center"
                                    height="300"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-A1-4.png"
                                        alt="Wo sind die Leute und was machen sie?"
                                        style="max-width: 240px; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td class="align-middle text-center"
                                    height="300"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-A1-5.png"
                                        alt="Wo sind die Leute und was machen sie?"
                                        style="max-width: 240px; height: auto;">
                                </td>
                            </tr>

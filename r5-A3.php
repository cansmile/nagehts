            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        die Wurst<span
                            class="tran">&nbsp;<small>소시지</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="2">
                    ...
                    <button type="button"
                        ...
                        id="3">
                        das Wasser<span
                            class="tran">&nbsp;<small>물</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark so itm"
                        id="4">
                        der Kaffee<span
                            class="tran">&nbsp;<small>커피</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark so itm"
                        id="5">
                    ...
                    <button type="button"
                        ...
                        id="6">
                        der Käse<span
                            class="tran">&nbsp;<small>치즈</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="7">
                    ...
                    <button type="button"
                        ...
                        id="8">
                        die Schokolade<span
                            class="tran">&nbsp;<small>쵸콜릿</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="9">
                        der Kuchen<span
                            class="tran">&nbsp;<small>케잌</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="10">
                        das Obst<span
                            class="tran">&nbsp;<small>과일</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="11">
                        das Fleisch<span
                            class="tran">&nbsp;<small>고기</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="12">
                        das Gemüse<span
                            class="tran">&nbsp;<small>야채</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark so itm"
                        id="13">
                        die Milch<span
                            class="tran">&nbsp;<small>우유</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="14">
                        der Salat<span
                            class="tran">&nbsp;<small>샐러드</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark so itm"
                        id="15">
                        das Bier<span
                            class="tran">&nbsp;<small>맥주</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="16">
                        das Eis<span
                            class="tran">&nbsp;<small>아이스크림</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="17">
                        die Suppe<span
                            class="tran">&nbsp;<small>수프</small></span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row" id="lsts">
                <div style="min-height: 240px;"
                    class="rounded-top bg-info itm-lst col-6 col-sm-4 col-md-3 p-2"
                    id="lst-1">

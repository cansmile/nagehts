<?php require_once("heading.php"); ?>
            ...
            <div class="row">
                <div class="col-lg-12 mb-4 mt-2 text-center">
                    ...
                    <h3>[ <small><button type="button"
                            ...
                            버튼을 눌러 듣기를 2번 완료하면<br>문장의 번역이 나옵니다.</small> ]</h3>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                ...
                                <td>Hm, Kaffee und Kuchen.<span class="tran"><br><small>음, 커피와
                                            케이크.</small></span></td>
                            </tr>
                            <tr>
                                <th scope="row"><button type="button" id="2" class="so btn btn-outline-info">▶</button>
                                </th>
                                <td>Ich esse <strong>gern</strong> Kuchen.<span class="tran"><br><small>난 케이크 먹는 걸
                                            좋아해..</small></span></td>
                            </tr>
                            <tr>
                                ...
                                <td>Ich nicht.<span class="tran"><br><small>난
                                            아니야.</small></span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Ich esse <strong>am liebsten</strong>
                                    Käsebrot.<span class="tran"><br><small>난 치즈빵
                                            먹는 게 제일 좋아.</small></span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        ...
        var nagehts = new Howl({
            src: ["./dev/sounds/Reihe 5/r5 B4.mp3"],
            sprite: {
                "0": [901, 30060],
                "1": [10209, 3049],
                "2": [13753, 1800],

        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 py-2 my-2">
                    ...
                    <span
                        class="border border-dark rounded p-1 px-2">Pizza</span>
                    <span class="border border-dark rounded p-1 px-2">Flasche
                        Milch</span>
                    <span
                        class="border border-dark rounded p-1 px-2">Hamburger</span>
                    <span class="border border-dark rounded p-1 px-2">Dose
                        Cola</span>
                </div>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                ...
                                <td>Morgens isst Tim Sager ein Brötchen mit
                                    Butter und Marmelade.<span
                                        class="tran"><br><small>아침에 팀 자거는 버터와 잼을
                                            바른 빵을 먹는다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="qst-1">
                                        .
                                    </div><span class="tran"><br><small>그는 우유 한
                                            병을 마신다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    </div><span class="tran"><br><small>점심엔 햄버거와
                                            콜라 한 잔을 마신다.</small></span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="qst-3">
                                        .
                                    </div><span class="tran"><br><small>오후엔
                                            감자튀김과 아이스크림을 먹는다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            aria-label="."
                                            id="qst-4">
                                    </div><span class="tran"><br><small>저녁엔 피자를
                                            먹고</small></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="qst-5">
                                        .
                                    </div><span class="tran"><br><small>콜라 한 캔을
                                            마신다.</small></span>
                                </td>
                            </tr>
                        </tbody>

                            ...
                            <tr>
                                <td style="height: 300px;"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-E2-1.png"
                                        alt="Geschmack"
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td style="height: 300px;"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-E2-2.png"
                                        alt="Geschmack"
                                        style="max-width: 180px; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td style="height: 300px;"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-E2-3.png"
                                        alt="Geschmack"
                                        style="max-width: 180px; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td style="height: 300px;"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-E2-4.png"
                                        alt="Geschmack"
                                        style="max-width: 180px; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td style="height: 300px;"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-E2-5.png"
                                        alt="Geschmack"
                                        style="max-width: 180px; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td style="height: 300px;"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-E2-6.png"
                                        alt="Geschmack"
                                        style="max-width: 180px; height: auto;">
                                </td>
                            </tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: [
                    "./<?php echo($root); ?>sounds/Reihe 5/r5 E2.mp3"],
                sprite: {
                    "0": [382, 22140],
                    "1": [6876, 1057],
                    "2": [9831, 1143],

            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td>Was bezahlen Sie?<span class="tran"><br><small>무엇을
                    ...
                    <table class="table table-borderless text-center table-sm">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th scope="col" width="25%" class="border border-white bg-light text-primary">
                                    m</th>
                                <th scope="col" width="25%" class="border border-white bg-light text-danger">
                                    f</th>
                                <th scope="col" width="25%" class="border border-white bg-light text-purple">
                                    n</th>
                            </tr>
                        </thead>
                        <tbody>

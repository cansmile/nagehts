            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td>Was bezahlen Sie?<span
                                        class="tran"><br><small>무엇을
                                            계산하시겠어요?</small></span></td>
                            </tr>
                            <tr>
                                <td>
                                    <span class="sen">Ich bezahle <span
                                            class="nu">①</span>
                                    ...
                                    <span class="tran"><br><small>저는 피자를
                                            계산하겠습니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span class="tran"><br><small>저는 콜라를
                                            계산하겠습니다.</small></span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span class="tran"><br><small>저는 스테이크와 와인을
                                            계산하겠습니다.</small></span>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <table class="table table-borderless text-center table-sm">
                        <thead>
                            <tr>
                                <th colspan="4" class="border border-white">
                                    bestimmter Artikel im Nominativ und
                                    Akkusativ</th>
                            </tr>
                            <tr>
                                <th scope="col" width="25%"
                                    class="border border-white ">&nbsp;</th>
                                <th scope="col" width="25%"
                                    class="border border-white bg-light text-primary">
                                    m</th>
                                <th scope="col" width="25%"
                                    class="border border-white bg-light text-danger">
                                    f</th>
                                <th scope="col" width="25%"
                                    class="border border-white bg-light text-purple">
                                    n</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th class="border border-white bg-light"
                                    scope="row">Nominativ</th>
                                <td class="border border-white text-primary">
                                    <strong>der</strong> Salat</td>
                                <td class="border border-white text-danger">
                                    <strong>die</strong> Pizza</td>
                                <td class="border border-white text-purple">
                                    <strong>das</strong> Steak</td>
                            </tr>
                            <tr>
                                <th class="border border-white bg-light"
                                    scope="row">Akkusativ</th>
                                <td class="border border-white text-primary">

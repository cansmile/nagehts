                        ...
                        <tbody>
                            <tr>
                                <th scope="row" width="50"
                                    class="text-center align-middle">1.</th>
                                <td>
                                    <span class="sen">
                                        <div id="ant-1"></div>
                                    ...
                                    <span class="tran">나는 그 샐러드를 먹는다. 그것은
                                        맛있다.</span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" width="50"
                                    class="text-center align-middle">2.</th>
                                <td>
                                    <span class="sen">
                                        <div id="ant-2"></div>
                                        <div class="input-group">
                                    ...
                                    <span class="tran">나는 그 와인을 마시지 않는다. 그것은
                                        따뜻하다.</span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" width="50"
                                    class="text-center align-middle">3.</th>
                                <td>
                                    <span class="sen">
                                        <div id="ant-3"></div>
                                        <div class="input-group">
                                    ...
                                    <span class="tran">나는 이 감자들을 먹지 않는다. 그것들은
                                        차갑다.</span>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <th scope="row" width="50"
                                    class="text-center align-middle">4.</th>
                                <td>
                                    <span class="sen">
                                        <div id="ant-4"></div>
                                        <div class="input-group">
                                    ...
                                    <span class="tran">나는 이 닭고기를 먹는다. 그것은 정말
                                        맛있다.</span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" width="50"
                                    class="text-center align-middle">5.</th>
                                <td>
                                    <span class="sen">
                                        <div id="ant-5"></div>
                                        <div class="input-group">
                                    ...
                                    <span class="tran">그녀는 이 콜라를 마시지 않는다. 그것이 너무
                                        미지근하다.</span>
                                </td>
                            </tr>
                        </tbody>

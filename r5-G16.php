    ...
    <script>
        ...
        $(document).ready(function () {
                ...
                var nagehts = new Howl({
                        ...
                        src: [
                            "./<?php echo($root); ?>sounds/Reihe 5/r5 G16.mp3"],
                        sprite: {
                            "0": [5559, 93458],
                            "1": [5797, 3304],
                            "2": [11040, 1597],

<?php require_once("heading.php"); ?>
                ...
                <div class="col-12">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td
                                class="border border-secondary border-right-only">
                                &nbsp;</td>
                            <td>keine</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th scope="row" class="bg-warning">Tim</th>
                            <td colspan="3"
                                class="text-center border border-secondary border-right-only bg-warning">
                                Hamburger, Cola</td>
                            <td colspan="3"
                                class="text-center bg-warning">Käse
                            </td>
                        </tr>
                        <tr>
                            <th scope="row" class="bg-warning">Monika
                            </th>
                            <td colspan="3"
                                class="text-center border border-secondary border-right-only bg-warning">
                                Marmeladenbrot, Wein</td>
                            <td colspan="3"
                                class="text-center bg-warning">Bier
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                <table class="table table-borderless">
                    <tbody>
                        <tr>
                            <th scope="row" class="text-center align-middle"
                                rowspan="3" width="10em">Monika</th>
                            <td>
                                <span class="sen">
                                    <div id="ant-4"></div>
                                    <div class="input-group">
    ...
    <script>
        ...
        var an = new Array();
        var an = ["Hamburger", "Cola", "Käse", "Marmeladenbrot", "Wein",
        "Bier"];

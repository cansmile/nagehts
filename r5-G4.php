<?php require_once("heading.php"); ?>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center">
                                    <span
                                        class="p-1 px-2 m-1 bg-primary align-middle text-white rounded font-weight-bold">m</span>
                                    <span
                                        class="p-1 px-2 m-1 bg-danger align-middle text-white rounded font-weight-bold">f</span>
                                    <span
                                        class="p-1 px-2 m-1 bg-purple align-middle text-white rounded font-weight-bold">n</span>
                                </th>
                                <th scope="col" class="text-center" width="15%">
                                    das Richtige</th>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-left align-middle">
                                    ...
                                    <span class="tran"><small>저는 치즈빵을 주문하지
                                            않았어요.</small></span>
                                </td>
                                <td rowspan="2"
                                    class="text-center align-middle text-purple font-weight-bold">
                            ...
                            <tr>
                                <td class="text-left align-middle">
                                    ...
                                    <span class="tran"><small>저는 소시지빵을
                                            주문하였어요.</small></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-left align-middle">
                                    ...
                                    <span class="tran"><small>저는 콜라를 주문하지 않있어요.
                                        </small></span>
                                </td>
                                <td rowspan="2"
                            ...
                            <tr>
                                <td class="text-left align-middle">
                                    ...
                                    <span class="tran"><small>저는 오렌지주스 한 잔을
                                            주문하였어요.</small></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-left align-middle">
                                    ...
                                    <span class="tran"><small>저는 와인 한 잔을 주문하지
                                            않았어요.</small></span>
                                </td>
                                <td rowspan="2"
                                    class="text-center align-middle text-purple font-weight-bold">
    ...
    <script>
        ...
        var an = new Array();
        var an = ["kein Käsebrötchen", "ein Bratwurstbrötchen", "keine Cola",
            "einen Orangensaft", "keinen Wein", "ein Bier"
        ];

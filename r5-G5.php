        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col text-center"><img
                        src="./<?php echo($root); ?>images/Reihe 5/Reihe-5-G5-1.png"
                        alt="Wer möchte was?"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: [
                    "./<?php echo($root); ?>sounds/Reihe 5/r5 G5.mp3"],
                sprite: {
                    "0": [206, 31519],
                    "1": [8249, 1142],
                    "2": [11068, 1316],
                                    ...
                                    function () {
                                        if ($(
                                            ...
                                            switch (
                                                ...
                                                case '':
                                                    var ao =
                                                        "<span class=\"bg-khaki text-white p-0 px-1 rounded\">";
                                                    break;
                                                case 'einen':
                                                    var ao =
                                                        "<span class=\"bg-primary text-white p-0 px-1 rounded\">";
                                                    break;
                                                case 'eine':
                                                    var ao =
                                                        "<span class=\"bg-danger text-white p-0 px-1 rounded\">";
                                                    break;
                                                case 'ein':
                                                    var ao =
                                                        "<span class=\"bg-purple text-white p-0 px-1 rounded\">";
                                                    break;
                                            }
                                            var ac =
                                                "</span>";

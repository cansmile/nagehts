...
<!-- 알림 끝 -->
<section class="nq-exercise" data-type="grammar" data-reihe="5">
    <div class="container">
        <div class="row">
            <div class="col-12">
                        ...
                        <div id="flush-collapse1" class="accordion-collapse collapse" aria-labelledby="flush-heading1"
                            ...
                            <div class="accordion-body">
                                ...
                                <table class="table table-borderless table-striped" width="80%">
                                    <thead>
                                    <tr>
                                        <th scope="col"><span class="tipp">TIPP</span></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        <th scope="row"><small>지시대명사는 앞에 언급했던 명사를 다시 지시하며 언급할 때 사용되며, 각 명사의 성에 해당하는 정관사로
                                                표현한다.</small></th>
                                    </tr>
                                    <tr>
                    ...
                    <div class="accordion-item">
                        <h5 class="accordion-header" id="flush-heading5">
                            <button class="text-purple bg-transparent accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapse5"><strong>H5. Verbkonjugation: essen, trinken,
                                    nehmen, bekommen, möchten</strong> <small>동사의 변화</small>
                            </button>
                        </h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-9 mx-1 px-1 my-auto lh250">Ich esse / trinke gern ...</div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-9 mx-1 px-1 my-auto lh250"><span class="text-white"></span>Nein,
                                                    ich mag keinen, keine, kein, keine ....
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td width="50%">
                                            <div class="row">
                                                ...
                                                <div class="col-9 mx-1 px-1 my-auto lh250">Was möchtest du?</div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="row">
...
<script>
    ...
    var nagehts = new Howl({
            ...
            src: ["./dev/sounds/Reihe 5/r5 H.mp3"],
            sprite: {
                "1": [4875, 15966],
                "2": [4875, 3120],
                "3": [8332, 2514],

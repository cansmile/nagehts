        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 mb-4 mt-2 text-center">
                    ...
                    <h3>[ <small>음성을 듣고 내용과 일치하는 문장을 선택하세요.<br><button
                                type="button"
            ...
            <div class="row">
                <div class="col-12"><strong><button type="button" id="1"
                            class="so btn btn-outline-primary">▶</button>&nbsp;1.
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">a. Ich fahre gern Rad.<span
                                    class="tran"><small><br>나는 자전거 타는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">b. Ich lese gern
                                Bücher.<span class="tran"><small><br>나는 책 읽는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">c. Ich spiele gern
                                Fußball.<span class="tran"><small><br>나는 축구 하는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">d. Ich fahre gern
                                Auto.<span class="tran"><small><br>나는 자동차 운전하는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="row">
                <div class="col-12"><strong><button type="button" id="2"
                            class="so btn btn-outline-danger">▶</button>&nbsp;2.
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">a. Ich schlafe gern.<span
                                    class="tran"><small><br>나는 자는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">b. Ich esse gern.<span
                                    class="tran"><small><br>나는 먹는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">c. Ich gehe gern
                                einkaufen.<span class="tran"><small><br>나는 쇼핑하는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">d. Ich arbeite gern.<span
                                    class="tran"><small><br>나는 일하는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="row">
                <div class="col-12"><strong><button type="button" id="3"
                            class="so btn btn-outline-success">▶</button>&nbsp;3.
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">a. Ich koche gern.<span
                                    class="tran"><small><br>나는 요리하는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">b. Ich treffe gern
                                Freunde.<span class="tran"><small><br>나는 친구들
                                        만나는거 좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">c. Ich schwimme gern.<span
                                    class="tran"><small><br>나는 수영하는 거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="align-middle">d. Ich putze gern.<span
                                    class="tran"><small><br>난 청소하는거
                                        좋아.</small></span></td>
                        </tr>
                    </table>
                </div>

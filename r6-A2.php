<?php require "nav.php"; ?>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th scope="col" colspan="4">1. Was macht er
                                    <strong class="text-success">gern</strong>?
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th scope="col" colspan="4">2. Was macht er
                                    <strong class="text-danger">nicht
                                        gern</strong>?</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <td>• 무엇을 즐겨하다 / 즐겨하지 않다<br>
                                    <div class="pl-4">Ich schlafe gern. / nicht
                                        ...
                                        <div class="pl-4">- Ich esse
                                            ...
                                            Auto.<br>
                                            - Sie spielt <strong>gern</strong>
                                            am Computer.<br>
                                            - Sie sieht <strong>nicht
                                                gern</strong> fern.</div>
                                    </div><br>
                                    • gern은 동사 뒤에 위치한다.<br>
                                </td>
                            </tr>
    ...
    <script>
        ...
        var an = new Array();
        var an = ["fährt", ["Rad", "Fahrrad"], "spielt", "schwimmt", "liest",
            "trifft", "fährt"
        ];

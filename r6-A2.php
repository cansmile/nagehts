				...
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
						<table class="table">
							...
							<tbody>
								<tr>
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A2-1.png" alt="Was macht er gern?" style="max-width: 240px; max-height: 120px;"></td>
									<td class="border-0 text-center align-middle"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A2-2.png" alt="Was macht er gern?" style="max-width: 240px; max-height: 120px;"></td>
									<td class="border-0 text-center align-middle"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A2-4.png" alt="Was macht er gern?" style="max-width: 120px; max-height: 120px;"></td>
									<td class="border-0 text-center align-middle"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A2-3.png" alt="Was macht er gern?" style="max-width: 120px; max-height: 120px;"></td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
						<table class="table">
							...
							<tbody>
								<tr>
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A2-5.png" alt="Was macht er nicht gern?" style="max-width: 240px; max-height: 120px;"></td>
									<td class="border-0 text-center align-middle"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A2-6.png" alt="Was macht er nicht gern?" style="max-width: 240px; max-height: 120px;"></td>
									<td class="border-0 text-center align-middle"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A2-7.png" alt="Was macht er nicht gern?" style="max-width: 120px; max-height: 120px;"></td>
									<td class="border-0 text-center align-middle"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A2-8.png" alt="Was macht er nicht gern?" style="max-width: 120px; max-height: 120px;"></td>
								</tr>
							</tbody>
						</table>
					</div>

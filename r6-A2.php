				...
				<div class="row">
					<div class="col">
						<table class="table">
							<thead>
								<tr>
									<th scope="col" colspan="2" class="bg-light border-0"><span class="bg-success text-white m-1 px-3 py-2">GR</span> <span class="bg-info text-white m-1 px-2 py-1">ADV1</span> gern[gεrn] <small>1. 즐겨, 기꺼이 2. 곧잘, 쉽게 3. 거리낌없이</small></th>
								</tr>
							</thead>
							<tbody>
								<tr>
...
<?php include "footer.php"; ?>
		...
		<script>
			...
			var an = new Array();
			var an = ["fährt","Rad","spielt","schwimmt","liest","trifft","fährt"];

		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<table class="table">
						<thead>
							<th class="text-center border-0" scope="col"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A3-2.png" alt="Wir helfen gern im Haushalt." style="max-width: 212px; height: auto;"></th>
						</thead>
						<tbody>
							<tr>
				...
				<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<table class="table">
						<thead>
							<th class="text-center border-0" scope="col"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A3-3.png" alt="Wir helfen gern im Haushalt." style="max-width: 212px; height: auto;"></th>
						</thead>
						<tbody>
							<tr>
								<th scope="row" class="border-0">
				...
				<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<table class="table">
						<thead>
							<th class="text-center border-0" scope="col"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A3-4.png" alt="Wir helfen gern im Haushalt." style="max-width: 212px; height: auto;"></th>
						</thead>
						<tbody>
							<tr>
								<th scope="row" class="border-0">
				...
				<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<table class="table">
						<thead>
							<th class="text-center border-0" scope="col"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A3-5.png" alt="Wir helfen gern im Haushalt." style="max-width: 212px; height: auto;"></th>
						</thead>
						<tbody>
							<tr>
								<th scope="row" class="border-0">
				...
				<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<table class="table">
						<thead>
							<th class="text-center border-0" scope="col"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A3-6.png" alt="Wir helfen gern im Haushalt." style="max-width: 212px; height: auto;"></th>
						</thead>
						<tbody>
							<tr>
								<th scope="row" class="border-0">
				...
				<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<table class="table">
						<thead>
							<th class="text-center border-0" scope="col"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A3-7.png" alt="Wir helfen gern im Haushalt." style="max-width: 212px; height: auto;"></th>
						</thead>
						<tbody>
							<tr>
								<th scope="row" class="border-0">
				...
				<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<table class="table">
						<thead>
							<th class="text-center border-0" scope="col"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A3-8.png" alt="Wir helfen gern im Haushalt." style="max-width: 212px; height: auto;"></th>
						</thead>
						<tbody>
							<tr>
								<th scope="row" class="border-0">
				...
				<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<table class="table">
						<thead>
							<th class="text-center border-0" scope="col"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A3-9.png" alt="Wir helfen gern im Haushalt." style="max-width: 212px; height: auto;"></th>
						</thead>
						<tbody>
							<tr>
								<th scope="row" class="border-0">
				...
				<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<table class="table">
						<thead>
							<th class="text-center border-0" scope="col"><img src="./<?=$root ?>images/Reihe 6/Reihe-6-A3-10.png" alt="Wir helfen gern im Haushalt." style="max-width: 212px; height: auto;"></th>
						</thead>
						<tbody>
							<tr>
								<th scope="row" class="border-0">

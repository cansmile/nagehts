            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    ...
                    <button type="button"
                        ...
                        id="3">
                        den Mülleimer aus|leeren<span
                            class="tran"><br><small>쓰레기통을 비우다</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="5">
                        (eine) Pause machen<span
                            class="tran"><br><small>쉬다</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans5 btn-lg btn-outline-dark so itm"
                        id="6">
                        auf|räumen<span
                            class="tran"><br><small>정리하다</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="7">
                        Frühstück machen<span
                            class="tran"><br><small>아침식사하다</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans4 btn-lg btn-outline-dark so itm"
                        id="8">
                        auf|stehen<span
                            class="tran"><br><small>기상하다</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark so itm"
                        id="9">
                        (das) Geschirr ab|waschen und ab|trocknen<span
                            class="tran"><br><small>그릇을 설겆이하다.</small></span>
                    </button>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-borderless">
                        <thead>
                            <th class="text-center" scope="col"><img
                                    ...
                                    alt="Wir helfen gern im Haushalt."

				...
				<div class="row">
					...
					<table class="table table-striped">
						...
						<tbody>
							<tr>
								...
								<td width="60" height="<?php echo($a_cell_height); ?>" class="text-right pr-0 mr-0 align-middle">Es ist</td>
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								<td width="60" height="<?php echo($a_cell_height); ?>" class="text-right pr-0 mr-0 align-middle">&nbsp;</td>
				...
				<div class="row">
					<div class="col">
						<table class="table">
							<thead>
								<tr>
									<th scope="col" class="bg-light border-0"><span class="bg-secondary text-white m-1 p-2">TIPP</span></th>
								</tr>
							</thead>
							<tbody>
								<tr>
				...
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
						<table class="table">
							<thead>
								<tr>
									<th scope="col" class="bg-light border-0"><span class="bg-success text-white m-1 p-2 px-3">GR</span>Wochentage: Heute ist Montag.<br><span class="ml-5"><small>요일: 오늘은 월요일이다.</small></span></th>
								</tr>
							</thead>
							<tbody>
								<tr>
								...
								<tr>
									<td class="bg-light border-0"><span class="bg-secondary font-weight-bold text-white m-1 p-2">TIPP</span><strong>Wochentage</strong><br><div class="pl-2 ml-5"><small>요일, 공휴일 등의 시간적 의미를 나타낼 때에는 전치사 an이 함께 쓰인다.</small></div></td>
								</tr>
							</tbody>
						</table>
					</div>
					<div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
						<table class="table">
							<tbody>
								<tr>
									<td><span class="bg-info text-white m-1 p-1 px-2"><strong>PRÄP.1</strong></span><strong>an</strong><small><strong>[an]</strong>&nbsp;1. <시간> …에 2. <장소, ,정지 > …옆에, … 3. 기타 관용적 표현</small></td>
								</tr>
								<tr>
									<td class="bg-light border-0"><span class="bg-secondary font-weight-bold text-white m-1 p-2">TIPP</span>[ <small>시간 및 장소적 의미의 전치사</small> an ] <span class="bg-dark text-light p-1 px-2">3격</span></td>
								</tr>
								<tr>
									<td>
										<div class="pl-4 row">

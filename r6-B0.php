            ...
            <div class="row">
                <div class="col">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th scope="col" class="bg-light"><span class="bg-lime font-weight-bold p-1 px-2 m-1 rounded">TIPP</span><small>시간을 나타내는 전치사</small> um</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                        ...
                        <thead>
                            <tr>
                                <th scope="col" class="bg-light">
                                    <div class="row">
                                        <span class="bg-success rounded text-white m-1 p-2 px-3">GR</span>
                                        <div class="ml-2">
                                            Wochentage: Heute ist Montag.<br><small>요일: 오늘은 월요일이다.</small>
                                        </div>
                                    </div>
                                </th>
                            </tr>
                                ...
                                <td class="bg-light">
                                    <div class="row">
                                        ...
                                        <div class="pl-5 col-8">
                                            <strong>Wochentage</strong><br><small>요일, 공휴일 등의 시간적 의미를 나타낼 때에는 전치사 an이 함께 쓰인다.</small>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td><div class="row">
                                    <span class="bg-info rounded text-white m-1 p-1 px-2"><strong>PRÄP.1</strong></span>
                                    <strong>an</strong><small><strong>[an]</strong><br>1. <시간> …에 2. <장소, ,정지 > …옆에, … 3. 기타 관용적 표현</small>
                                </div>
                            </div></td>
                        </tr>
                        <tr>
                            <td class="bg-light"><span class="bg-lime font-weight-bold p-1 px-2 m-1 rounded">TIPP</span>[ <small>시간 및 장소적 의미의 전치사</small> an ] <span class="bg-dark text-light p-1 px-2">3격</span></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="pl-4 row">
...
$(document).ready(function() {
    ...
    var nagehts=new Howl( {
        ...
        src: [ "./<?php echo($root); ?>sounds/Reihe 6/r6 B0.mp3"],
            sprite: {
            "0": [852, 87674],
            "1": [7982, 2501],
            "2": [12210, 2211],

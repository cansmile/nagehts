	        ...
	        <div class="container">
	            <div class="row">
	                ...
	                <div class="col-12" id="itms">
	                    <button type="button"
	                        class="mt-1 mx-1 btn ans3 btn-md btn-outline-dark itm py-0 my-0 so"
	                        id="1">
	                    ...
	                    <button type="button"
	                        class="mt-1 mx-1 btn ans1 btn-md btn-outline-dark itm py-0 my-0"
	                        id="2">
	                        Wann läuft der Film am Samstag ?<span
	                            class="tran"><small><br>토요일 영화 상영시간은
	                                언제인가요?</small></span>
	                    </button>
	                    <button type="button"
	                        class="mt-1 mx-1 btn ans2 btn-md btn-outline-dark itm py-0 my-0 so"
	                        id="3">
	                    ...
	                    <button type="button"
	                        class="mt-1 mx-1 btn ans4 btn-md btn-outline-dark itm py-0 my-0 so"
	                        id="4">
	                        Was kostet der Tanzkurs pro Stunde?<span
	                            class="tran"><small><br>댄스 교습소의 시간당
	                                얼마인가요?</small></span>
	                    </button>
	                </div>
	            </div>
	                        ...
	                        <tbody>
	                            <tr>
	                                <td scope="col" width="60%"><img
	                                        ...
	                                        alt="Wie sind die Fragen?"
	                                        style="max-width: 100%; height: auto;">
	                                </td>
	                                <td scope="col"><img
	                                        src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-C2-3.png"
	                                        alt="Wie sind die Fragen?"
	                                        style="max-width: 100%; height: auto;">
	                                </td>
	                            </tr>
	                    ...
	                    <table class="table table-borderless">
	                        <tbody>
	                            <tr>
	                                ...
	                                <td scope="col"><img
	                                        src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-C2-4.png"
	                                        alt="Wie sind die Fragen?"
	                                        style="max-width: 100%; height: auto;">
	                                </td>
	                            </tr>
	                        ...
	                        <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td id="b2">Der Film läuft um
	                                    15.30 ,17.45 und um 20.00 Uhr.<span
	                                        class="tran"><small><br>영화 상영은 15시 30분,
	                                ...
	                                <tbody>
	                                    ...
	                                    <tr>
	                                        ...
	                                        <td id="b4">Am Freitag
	                                            ...
	                                            von 10 bis 18 Uhr.<span
	                                                class="tran"><small><br>금요일에
	                ...
	                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
	                    ...
	                    <table class="table table-borderless">
	                        <tbody>
	                            ...
	                            <tr>
	                                <td id="t8">&nbsp;</td>
	                                <td id="b8">Die Tanzschule
	                                    kostet 15 Euro pro Stunde.<span
	                                        class="tran"><small><br>댄스 교습소는 시간당
	                                            15유로를 받습니다.</small></td>
	                            </tr>
	                        </tbody>
	                    </table>

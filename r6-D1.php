            ...
            <div class="row">
                        ...
                        <tbody>
                            <tr>
                                <td rowspan="2" class="align-middle"><img
                                        src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D1-0.png"
                                        alt="Tagesablauf"
                                        style="max-width: 100%; height: auto;">
                                </td>
                                <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D1-5.png"
                                        alt="Tagesablauf"
                                        style="max-width: 100%; height: auto;">
                                </td>
                                <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D1-4.png"
                                        alt="Tagesablauf"
                                        style="max-width: 100%; height: auto;">
                                </td>
                                <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D1-3.png"
                                        alt="Tagesablauf"
                                        style="max-width: 100%; height: auto;">
                                </td>
                                <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D1-1.png"
                                        alt="Tagesablauf"
                                        style="max-width: 100%; height: auto;">
                                </td>
                                <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D1-2.png"
                                        alt="Tagesablauf"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td id="t1"><button type="button" id="1"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td id="b1">Das ist Maria Berndt.<span
                                        class="tran"><small><br>이 사람은 마리아
                                            베른트이다.</small></td>
                            </tr>
                            <tr>
                                <td id="t2"><button type="button" id="2"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td id="b2">Maria Berndt ist Hausfrau.<span
                                        class="tran"><small><br>마리아 베른트는
                                            주부이다.</small></td>
                            </tr>
                            <tr>
                                <td id="t3"><button type="button" id="3"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td id="b3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            aria-label="." id="qst-1">
                                        .
                                    </div><span class="tran"><small><br>그녀는 6시에
                                            잔다.</small>
                                </td>
                            </tr>
                            <tr>
                                <td id="t4"><button type="button" id="4"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td id="b4">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            aria-label="." id="qst-2">
                                        steht sie auf.
                                    </div><span class="tran"><small><br>8시에 그녀는
                                            일어난다.</small>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td id="t5"><button type="button" id="5"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td id="b5">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            aria-label="." id="qst-3">
                                        frühstückt sie.
                                    </div><span class="tran"><small><br>9시 반에
                                            그녀는 아침을 먹는다.</small>
                                </td>
                            </tr>
                            <tr>
                                <td id="t6"><button type="button" id="6"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td id="b6">Da isst sie ein Brötchen und trinkt
                                    Kaffee.<span class="tran"><small><br>그때는 작은
                                            빵을 먹고 커피를 마신다.</small></td>
                            </tr>
                            <tr>
                                <td id="t7"><button type="button" id="7"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td id="b7">
                                    ...
                                    </div><span class="tran"><small><br>11시에 그녀는
                                            식료품을 산다.</small>
                                </td>
                            </tr>
                            <tr>
                                <td id="t8"><button type="button" id="8"
                                        class="so btn btn-outline-primary">▶</button>
                                </td>
                                <td id="b8">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            aria-label="." id="qst-5">
                                        isst sie zu Mittag.
                                    </div><span class="tran"><small><br>1시에 그녀는
                                            점심을 먹는다.</small>
                                </td>
                            </tr>
                        </tbody>

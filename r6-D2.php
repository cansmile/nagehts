...
<body>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div
                    class="col align-middle text-center border border-dark p-1 px-2 pt-2 m-1 rounded">
                    zu Abend essen<span class="tran"><br /><small>저녁
                            먹기</small></span></div>
                <div
                    class="col align-middle text-center border border-dark p-1 px-2 pt-2 m-1 rounded">
                    die Zeitung lesen<span
                        class="tran"><br /><small>신문읽기</small></span></div>
                <div
                    class="col align-middle text-center border border-dark p-1 px-2 pt-2 m-1 rounded">
                ...
                <div
                    class="col align-middle text-center border border-dark p-1 px-2 pt-2 m-1 rounded">
                    Fotos machen<span
                        class="tran"><br /><small>사진찍기</small></span></div>
                <div
                    class="col align-middle text-center border border-dark p-1 px-2 pt-2 m-1 rounded">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-2 col-xl-2">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="200"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D2-0.png"
                                        alt="Wohin passt das?"
                            ...
                            <tr>
                                <td height="100" class="align-middle">Martin
                                    Klein ist Bankkaufmann.<span
                                        class="tran"><small><br>마틴 클라인은
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="200"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D2-1.png"
                                        alt="Wohin passt das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            class="form-control border border-bottom-only q"
                                            aria-label="." id="qst-1"
                                            style="position: relation; top: 5px;">
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="200"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D2-2.png"
                                        alt="Wohin passt das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="200"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D2-4.png"
                                        alt="Wohin passt das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="200"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D2-5.png"
                                        alt="Wohin passt das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td height="200"
                                    class="align-middle text-center"><img
                                        src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-D2-3.png"
                                        alt="Wohin passt das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                ...
                ready_callback: function () {
                    ...
                    $(".so").on("click", function () {
                        if ($(this).attr("id")
                            ...
                            ion.sound.pause(
                                "r6 D2 Wohin passt das (Martin Klein", {
                                    part: "0"
                                }
                            );
                            $("#0").show();

	...
	th,td {
		...
		<section>
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-2 col-sm-2 col-md-2 d-xs-block d-sm-block d-md-block d-lg-none d-xl-none p-0">
					...
					<div class="col-xs-10 col-sm-10 col-md-10 col-lg-5 col-xl-5 p-0">
						<table class="table m-0 text-center">
							<thead>
								<tr>
									<th scope="col" width="45%" class="border-0 align-middle text-white bg-secondary">formell 공식적</th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="col-xs-10 col-sm-10 col-md-10 col-lg-5 col-xl-5 p-0">
						<table class="table m-0 text-center">
							<thead>
								<tr>
									<th scope="col" width="45%" class="border-0 align-middle text-white bg-secondary">informell 비공식적</th>
								</tr>
							</thead>
							<tbody>
								<tr>

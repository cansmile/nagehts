...
<body>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <table class="table table-borderless text-center">
                        <tr>
                            <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-E6-3.png"
                                    alt="Was macht er am Freitag?" style="max-width: 100%; height: auto;"></td>
                        </tr>
                        <tr>
                            <td>schlafen</td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <div class="ant mb-3 float-right" id="ant-2">
                                </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <table class="table table-borderless text-center">
                        <tr>
                            <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-E6-5.png"
                                    alt="Was macht er am Freitag?" style="max-width: 100%; height: auto;"></td>
                        </tr>
                        <tr>
                            <td>fernsehen</td>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="ant mb-3 float-right" id="ant-4">
                                </div>
                                <div class="input-group">
                                    Am Vormittag&nbsp;
                                    <input type="text"
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <table class="table table-borderless text-center">
                        <tr>
                            <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-E6-4.png"
                                    alt="Was macht er am Freitag?" style="max-width: 100%; height: auto;"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="ant mb-3 float-right" id="ant-6">
                                </div>
                                <div class="input-group">
                                    Er&nbsp;
                                    <input type="text"
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <table class="table table-borderless text-center">
                        <tr>
                            <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-E6-6.png"
                                    alt="Was macht er am Freitag?" style="max-width: 100%; height: auto;"></td>
                        </tr>
                        <tr>
                            <td>Musik hören</td>
                        ...
                        <tr>
                            <td>
                                <div class="ant mb-3" id="ant-7"></div>
                                <div class="ant mb-3 float-right" id="ant-8">
                                </div>
                                <div class="input-group">
                                    Am Nachmittag&nbsp;
                                    <input type="text"
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <table class="table table-borderless text-center">
                        <tr>
                            <td><img src="./<?php echo($root); ?>images/Reihe 6/Reihe-6-E6-7.png"
                                    alt="Was macht er am Freitag?" style="max-width: 100%; height: auto;"></td>
                        </tr>
                        <tr>
                            <td>ein Steak essen
                        ...
                        <tr>
                            <td>
                                <div class="ant mb-3" id="ant-9"></div>
                                <div class="ant mb-3 float-right" id="ant-10">
                                </div>
                                <div class="input-group">
                                    Am Abend&nbsp;
                                    <input type="text"
    ...
    <script>
        ...
        $(".ant").hide();
        var an = new Array();
        var an = ["schläft", "Morgen", "sieht", "fern", "geht", "ins Kino",
            "hört", "Musik", "isst", "ein Steak"
        ];

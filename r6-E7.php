			...
			<div class="container">
				...
				<div class="row">
					<div class="col border border-dark rounded p-2" id="trans">
						...
						<span class="op-0 m-0 pt-1 mt-2 cbtn" style="font-size: 1.5em;" id="C100">die</span>
						<span class="op-0 m-0 pt-1 mt-2 cbtn" style="font-size: 1.5em;" id="C101">Party</span>
				...
				<div class="row">
					<div class="my-2 col-xs-12 col-sm-12 col-md-12 col-lg-12" id="itms">
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="3">macht
						<span class="tran"><small>~을 하다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="10">feiert
						<span class="tran"><small>축하하다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans2 btn-lg btn-outline-dark itm border-0" id="18">ruft
						<span class="tran"><small>전화하다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans2 btn-lg btn-outline-dark itm border-0" id="24">lädt
						<span class="tran"><small>초대하다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="29">kommen
						<span class="tran"><small>오다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans2 btn-lg btn-outline-dark itm border-0" id="35">bringen
						<span class="tran"><small>가지고 오다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans3 btn-lg btn-outline-dark itm border-0" id="40">besorgt
						<span class="tran"><small>구입하다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="46">kaufen
						<span class="tran"><small>사다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans2 btn-lg btn-outline-dark itm border-0" id="50">bringt
						<span class="tran"><small>가지고오다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="55">ist
						<span class="tran"><small>~이다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="59">schmückt
						<span class="tran"><small>꾸미다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans2 btn-lg btn-outline-dark itm border-0" id="64">bereitet
						<span class="tran"><small>준비하다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans3 btn-lg btn-outline-dark itm border-0" id="73">beginnt
						<span class="tran"><small>시작하다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="78">feiern
						<span class="tran"><small>축하하다</small></span>
						</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="79">,</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="80">tanzen
						<span class="tran"><small>춤추다</small></span>
						</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="81">,</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="82">lachen
						<span class="tran"><small>웃다</small></span>
						</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="83">und</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans3 btn-lg btn-outline-dark itm border-0" id="84">unterhalten sich
						<span class="tran"><small>말하다</small></span>
						</button>
						...
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans1 btn-lg btn-outline-dark itm border-0" id="94">denken
						<span class="tran"><small>생각하다</small></span>
						</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="95">sich</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="96">:</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="97">„</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="98">Hoffentlich</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans2 btn-lg btn-outline-dark itm border-0" id="99">hört
						<span class="tran"><small>끝나다</small></span>
						</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="100">die</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="101">Party</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="102">bald</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans2 btn-lg btn-outline-dark itm border-0 99" id="103">auf</button>
						<button type="button" class="p-0 m-0 pt-1 mt-1 btn ans0 btn-lg btn-outline-dark itm border-0" id="104">!“</button>
					</div>
				</div>
			<!-- 리스트  시작 -->

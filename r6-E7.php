		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12" id="itms">
					...
					<button type="button" class="p-0 m-0 pt-1 mt-1 ml-1 btn ans2 btn-lg btn-outline-dark itm border-0" id="89">liegen<span class="tran"><small>누워있다</small></span></button>

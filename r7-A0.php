		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12" id="itms">
					<button type="button" class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark itm" id="1"> das Schwimmbad<span class="tran"><br><small>수영장</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark itm" id="2"> das Museum<span class="tran"><br><small>박물관</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark itm" id="3"> das Restaurant<span class="tran"><br><small>식당</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans5 btn-lg btn-outline-dark itm" id="4"> das Kino(die Megabox)<span class="tran"><br><small>영화관</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans9 btn-lg btn-outline-dark itm" id="5"> die Disko<span class="tran"><br><small>디스코장</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans8 btn-lg btn-outline-dark itm" id="6"> die Oper<span class="tran"><br><small>오페라 하우스</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans7 btn-lg btn-outline-dark itm" id="7"> das Café<span class="tran"><br><small>카페</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans6 btn-lg btn-outline-dark itm" id="8"> der Zoo<span class="tran"><br><small>동물원</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans4 btn-lg btn-outline-dark itm" id="9"> der Flohmarkt<span class="tran"><br><small>벼룩시장</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans12 btn-lg btn-outline-dark itm" id="10"> die Innenstadt<span class="tran"><br><small>시내</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans10 btn-lg btn-outline-dark itm" id="11"> der Europapark<span class="tran"><br><small>놀이공원</small></span>
					</button>
					<button type="button" class="mt-1 mx-1 btn ans11 btn-lg btn-outline-dark itm" id="12"> das Live-Konzert<span class="tran"><br><small>라이브 콘서트장</small></span>
					</button>
				</div>
			</div>
		</div>

            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    ...
                    <button type="button"
                        ...
                        id="2">
                        Führung in der Gemäldegalerie<small><span
                                class="tran"><br>미술관 안내 관람<br>(Fr. 11
                                Uhr)</span></small>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans4 btn-lg btn-outline-dark itm so"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans4 btn-lg btn-outline-dark itm so"
                        id="5">
                        Stadtführung Glanzlichter Dresdens<small><span
                                class="tran"><br>드레스덴 하이라이트 시티투어<br>(Mo, Mi,
                                Fr., Sa. 18.30)</small></</span> </button>
                            <button type="button"
                            class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark itm so"
                            id="6">
        ...
        <div class="container">
            ...
            <div class="row" id="lsts">
                ...
                <div style="min-height: 240px;"
                    ...
                    id="lst-4">
                    <h2 class="btn btn-light btn-xl ttl d-block">
                        <small><strong>Am Abend</strong></small><br>(17-0 Uhr)
                    </h2>&nbsp;
                </div>
            </div>
            <!-- 리스트 끝 -->

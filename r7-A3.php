        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-3"><img
                        src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-A2-1.png"
                        alt="Was möchten Sie am Wochenende machen?"
                        style="max-width: 100%; height: auto;"></div>
                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-3"><img
                        src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-A2-2.png"
                        alt="Was möchten Sie am Wochenende machen?"
                        style="max-width: 100%; height: auto;"></div>
                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-3"><img
                        src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-A2-3.png"
                        alt="Was möchten Sie am Wochenende machen?"
                        style="max-width: 100%; height: auto;"></div>
                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-3"><img
                        src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-A2-4.png"
                        alt="Was möchten Sie am Wochenende machen?"
                        style="max-width: 100%; height: auto;"></div>
                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-3"><img
                        src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-A2-5.png"
                        alt="Was möchten Sie am Wochenende machen?"
                        style="max-width: 100%; height: auto;"></div>
                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-3"><img
                        src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-A2-6.png"
                        alt="Was möchten Sie am Wochenende machen?"
                        style="max-width: 100%; height: auto;"></div>
                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-3"><img
                        src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-A2-7.png"
                        alt="Was möchten Sie am Wochenende machen?"
                        style="max-width: 100%; height: auto;"></div>
            </div>
            <div class="row">
                    ...
                    <table class="table table-borderless table-light text-center my-0">
                        <tbody>
                            <tr>
                                ...
                                <td><strong>Wollen</strong> wir am
                            ...
                            <tr>
                                ...
                                <td><strong>Wollen</strong> wir am Sonntagabend
                                    in den Zirkus <strong>gehen</strong>?
                    ...
                    <table class="table table-borderless table-light text-center my-0">
                        <tbody>
                            <tr>
                                ...
                                <td><strong>Wollen</strong> wir am Samstagabend
                                    ins Kino <strong>gehen</strong>?
                            ...
                            <tr>
                                ...
                                <td>Ich gehe am Freitagmittag zur Stadtführung
                                    und Führung in der Gemäldegalerie.
                                    <strong>Willst</strong> du mit?
                                    <span class="tran"><br><small>나 금요일 점심에
                                            시티투어와 미술관 관람 할거야. 너도
                                            갈래?</small></span></td>
                                <td>
                                    <div class="btn-group btn-group-toggle q"

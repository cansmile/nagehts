						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td class="border-0 align-middle">Hast du heute Abend Zeit?
									<span class="tran"><br><small>너 오늘 저녁 시간 있니?</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="2" class="so btn btn-outline-primary">▶</button></td>
									<td class="border-0 align-middle">Hast du morgen früh Zeit?
									<span class="tran"><br><small>너 내일 일찍 시간 있니?</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="3" class="so btn btn-outline-primary">▶</button></td>
									<td class="border-0 align-middle">Hast du morgen Nachmittag Zeit?
									<span class="tran"><br><small>너 내일 오후에 시간 있니?</small></span></td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td class="border-0 align-middle">Ich möchte gern zum Fußballspiel gehen.
									<span class="tran"><br><small>나 축구하러 가려고해.</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="5" class="so btn btn-outline-primary">▶</button></td>
									<td class="border-0 align-middle">Ich möchte gern ins Konzert gehen.
									<span class="tran"><br><small>나 콘서트에 가려고해</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="6" class="so btn btn-outline-primary">▶</button></td>
									<td class="border-0 align-middle">Ich möchte gern ins Kino gehen.
									<span class="tran"><br><small>나 영화관에 가려고해.</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="7" class="so btn btn-outline-primary">▶</button></td>
									<td class="border-0 align-middle">Ich möchte gern essen gehen.
									<span class="tran"><br><small>나 먹으러 가려고해.</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="8" class="so btn btn-outline-primary">▶</button></td>
									<td class="border-0 align-middle">Hast du Lust?
									<span class="tran"><br><small>너도 갈래?</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="9" class="so btn btn-outline-primary">▶</button></td>
									<td class="border-0 align-middle">Kommst du mit?
									<span class="tran"><br><small>너도 같이 갈래?</small></span></td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td class="border-0 align-middle">Ja, das klingt gut!
									<span class="tran"><br><small>그래, 좋다!</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="11" class="so btn btn-outline-success">▶</button></td>
									<td class="border-0 align-middle">Ja, gern. Ich habe Zeit.
									<span class="tran"><br><small>그래, 좋다. 나 시간 있어.</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="12" class="so btn btn-outline-success">▶</button></td>
									<td class="border-0 align-middle">Wann fängt das denn an?
									<span class="tran"><br><small>언제 시작하는데?</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="13" class="so btn btn-outline-success">▶</button></td>
									<td class="border-0 align-middle">Um 4 Uhr.
									<span class="tran"><br><small>4시에.</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="14" class="so btn btn-outline-success">▶</button></td>
									<td class="border-0 align-middle">Wo treffen wir uns?
									<span class="tran"><br><small>우리 어디서 만나?</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="15" class="so btn btn-outline-success">▶</button></td>
									<td class="border-0 align-middle">Bei mir zu Hause.
									<span class="tran"><br><small>우리집에서.</small></span></td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td class="border-0 align-middle">Tut mir leid, das geht nicht.
									<span class="tran"><br><small>미안해, 난 안되겠다.</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="17" class="so btn btn-outline-danger">▶</button></td>
									<td class="border-0 align-middle">Ich habe leider keine Zeit.
									<span class="tran"><br><small>유감스럽게도 시간이 없어.</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="18" class="so btn btn-outline-danger">▶</button></td>
									<td class="border-0 align-middle">Ich muss lernen.
									<span class="tran"><br><small>나 공부해야해.</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="19" class="so btn btn-outline-danger">▶</button></td>
									<td class="border-0 align-middle">Vielleicht das nächste Mal.
									<span class="tran"><br><small>아마도 다음 번에 될 수 있어.</small></span></td>
								</tr>
								<tr>
									<td class="border-0 align-middle" width="50"><button type="button" id="20" class="so btn btn-outline-danger">▶</button></td>
									<td class="border-0 align-middle">Vielleicht morgen.
									<span class="tran"><br><small>아마도 내일은 될 수 있어.</small></span></td>
								</tr>
							</tbody>
						</table>
					</div>

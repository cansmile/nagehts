<?php require_once("heading.php"); ?>
    ...
    <!-- 알림 끝 -->
    <section class="nq-exercise" data-type="other" data-reihe="7">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border-white rounded bg-light">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: ["./dev/sounds/Reihe 7/r7 B3.mp3"],
                sprite: {
                    "0": [3022, 54974],
                    "1": [15442, 2306],
                    "2": [20518, 1316],

...
<body>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div
                    class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border-white rounded bg-light">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td class="p-0 pt-2">
                                    <span
                                        class="bg-dark text-white m-1 p-1 px-2 rounded">Tim</span>
                                    <br>
                                    <span
                                        class="p-1 ml-4 m-1 px-2 rounded bg-secondary text-white">Was
                                        machst du heute Nachmittag?
                                    </span>
                                    <button type="button" id="1"
                                        class="so btn btn-sm btn-outline-primary">▶</button>
                            ...
                            <tr>
                                <td class="p-0 pt-2 text-right">
                                    <span
                                        class="bg-dark text-white m-1 p-1 px-2 rounded">Mina</span>
                                    <br>
                                    <button type="button" id="2"
                                        class="so btn btn-sm btn-outline-danger">▶</button>
                                    <span
                                        class="p-1 mr-4 m-1 px-2 rounded bg-warning">Nichts!
                                    </span>
                                    <span
                                        class="tran mr-5"><br><small>아무것도!</small></span>
                                </td>
                            </tr>
                            <tr>
                                <td class="p-0 pt-2">
                                    ...
                                    <br>
                                    <span
                                        class="p-1 ml-4 m-1 px-2 rounded bg-secondary text-white">Hast
                                        du Lust auf Lernen?
                                    </span>
                            ...
                            <tr>
                                <td class="p-0 pt-2 text-right">
                                    ...
                                    <button type="button" id="4"
                                        class="so btn btn-sm btn-outline-danger">▶</button>
                                    <span
                                        class="p-1 mr-4 m-1 px-2 rounded bg-warning">Nöö.
                                        Keine Lust!
                                    </span>
                            ...
                            <tr>
                                <td class="p-0 pt-2">
                                    ...
                                    <br>
                                    <span
                                        class="p-1 ml-4 m-1 px-2 rounded bg-secondary text-white">Gehen
                            ...
                            <tr>
                                <td class="p-0 pt-2 text-right">
                                    ...
                                    <button type="button" id="6"
                                        class="so btn btn-sm btn-outline-danger">▶</button>
                                    <span
                                        class="p-1 mr-4 m-1 px-2 rounded bg-warning">Gute
                                        Idee! Wann denn?
                                    </span>
                            ...
                            <tr>
                                <td class="p-0 pt-2">
                                    ...
                                    <br>
                                    <span
                                        class="p-1 ml-4 m-1 px-2 rounded bg-secondary text-white">Um
                                        vier oder um sechs?
                                    </span>
                            ...
                            <tr>
                                <td class="p-0 pt-2 text-right">
                                    ...
                                    <button type="button" id="8"
                                        class="so btn btn-sm btn-outline-danger">▶</button>
                                    <span
                                        class="p-1 mr-4 m-1 px-2 rounded bg-warning">Gehen
                                        wir um vier?
                                    </span>
                            ...
                            <tr>
                                <td class="p-0 pt-2">
                                    ...
                                    <br>
                                    <span
                                        class="p-1 ml-4 m-1 px-2 rounded bg-secondary text-white">Okay.
                                        Dann bis um vier!
                                    </span>
                            ...
                            <tr>
                                <td class="p-0 pt-2 text-right">
                                    ...
                                    <button type="button" id="10"
                                        class="so btn btn-sm btn-outline-danger">▶</button>
                                    <span
                                        class="p-1 mr-4 m-1 px-2 rounded bg-warning">Ja,
                                        bis dann!
                                    </span>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            class="form-control border border-dark border-bottom-only rounded-0 mx-1
                                            px-2 py-1 q t-6"
                                            aria-label="." id="qst-1">
                                        .

            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        a. Mama, darf ich ein Eis?<span
                            class="tran"><br><small>엄마, 아이스크림 먹어도
                                되요?</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans4 btn-lg btn-outline-dark itm so"
                        id="2">
                        b. Hier darf man nicht parken.<span
                            class="tran"><br><small>여기에 주차를 하면 안
                                된다.</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="4">
                        d. Hier muss man leise sprechen.<span
                            class="tran"><br><small>여기에서 조용히 이야기해야
                                한다.</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="6">
                        f. Hier kann man parken.<span
                            class="tran"><br><small>여기에 주차를 할 수
                                있다.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans6 btn-lg btn-outline-dark itm so"
                        id="7">
                        g. Hier muss man stoppen.<span
                            class="tran"><br><small>여기에서는 무조건
                                서야한다.</small></span>
                    </button>
                </div>
            </div>

            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        a. Du sollst nicht stehlen.<span
                            class="tran"><br><small>도적질 하지 말라.</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="3">
                        c. Der Arzt hat gesagt, ich soll nicht rauchen.<span
                            class="tran"><br><small>의사가 담배를 피우지 말아야 한다고
                                했어.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark itm so"
                        id="4">
                        d. Willst du meine Frau werden? Ja, ich will.<span
                            class="tran"><br><small>내 아내가 되어 줄래? 응,
                                그럴게.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark itm so"
                        id="5">
                        e. Wir wollen nach Amerika.<span
                            class="tran"><br><small>우리는 미국에 갈거야.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans5 btn-lg btn-outline-dark itm so"
                        id="6">
                        f. Ich möchte bitte ein Glas Wasser.<span
                            class="tran"><br><small>난 물 한잔을 원해요.</small></span>
                    </button>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            <tr>
                                <td height="250"
                                    ...
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-C2-1.png"
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="250"
                                    class="align-middle text-center">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-C2-2.png"
                                        alt="Was kann / muss / darf man (nicht)?"
                                        style="max-height: 240px; max-width: 100%; width: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="250"
                                    class="align-middle text-center">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-C2-3.png"
                                        alt="Was kann / muss / darf man (nicht)?"
                                        style="max-height: 240px; max-width: 100%; width: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="250"
                                    class="align-middle text-center">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-C2-4.png"
                                        alt="Was kann / muss / darf man (nicht)?"
                                        style="max-height: 240px; max-width: 100%; width: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="250"
                                    class="align-middle text-center">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-C2-5.png"
                                        alt="Was kann / muss / darf man (nicht)?"
                                        style="max-height: 240px; max-width: 100%; width: auto;">
                                </td>
                            </tr>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="250"
                                    class="align-middle text-center">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-C2-6.png"

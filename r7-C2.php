				...
				<div class="row">
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
						<table class="table border-0">
							<tbody>
								<tr>
									<td height="250" class="border-0 align-middle text-center"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C2-1.png" alt="Was kann / muss / darf man (nicht)?" style="max-height: 240px; max-width: 100%; width: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
						<table class="table border-0">
							<tbody>
								<tr>
									<td height="250" class="border-0 align-middle text-center"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C2-2.png" alt="Was kann / muss / darf man (nicht)?" style="max-height: 240px; max-width: 100%; width: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
						<table class="table border-0">
							<tbody>
								<tr>
									<td height="250" class="border-0 align-middle text-center"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C2-3.png" alt="Was kann / muss / darf man (nicht)?" style="max-height: 240px; max-width: 100%; width: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
						<table class="table border-0">
							<tbody>
								<tr>
									<td height="250" class="border-0 align-middle text-center"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C2-4.png" alt="Was kann / muss / darf man (nicht)?" style="max-height: 240px; max-width: 100%; width: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
						<table class="table border-0">
							<tbody>
								<tr>
									<td height="250" class="border-0 align-middle text-center"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C2-5.png" alt="Was kann / muss / darf man (nicht)?" style="max-height: 240px; max-width: 100%; width: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
						<table class="table border-0">
							<tbody>
								<tr>
									<td height="250" class="border-0 align-middle text-center"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C2-6.png" alt="Was soll / will / möchte man (nicht)?" style="max-height: 240px; max-width: 100%; width: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">

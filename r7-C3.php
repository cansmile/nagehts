						...
						<table class="table p-0 m-0">
							<tbody>
								<tr>
									...
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C3-1.png" alt="Was kann man, was darf man nicht und was muss man machen?" style="max-width: 100%; height: auto;"></td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table class="table p-0 m-0">
							<tbody>
								<tr>
									...
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C3-2.png" alt="Was kann man, was darf man nicht und was muss man machen?" style="max-width: 100%; height: auto;"></td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table class="table p-0 m-0">
							<tbody>
								<tr>
									...
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C3-3.png" alt="Was kann man, was darf man nicht und was muss man machen?" style="max-width: 100%; height: auto;"></td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table class="table p-0 m-0">
							<tbody>
								<tr>
									...
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-C3-4.png" alt="Was kann man, was darf man nicht und was muss man machen?" style="max-width: 100%; height: auto;"></td>
								</tr>
							</tbody>
						</table>
					</div>

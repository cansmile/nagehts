            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        Ach so! Dann höre ich auf.<span
                            class="tran">&nbsp;<small>아 그래요! 그럼
                                그만할게요.</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="3">
                        Hier dürfen Sie nicht essen.<span
                            class="tran">&nbsp;<small>여기서 먹으면
                                안되요.</small></span>
                    </button>
                    <button type="button"
                        ...
                        id="4">
                        Ich esse.<span
                            class="tran">&nbsp;<small>먹는중인데요.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="5">
                        Was machen Sie denn da?<span
                            class="tran">&nbsp;<small>거기서 뭐하고
                                계시나요?</small></span>
                    </button>
                    <button type="button"

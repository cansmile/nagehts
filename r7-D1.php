                        ...
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./dev/images/Reihe 7/Reihe-7-D1-1.png" alt="Wo ist das?"
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./dev/images/Reihe 7/Reihe-7-D1-2.png" alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./dev/images/Reihe 7/Reihe-7-D1-3.png" alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./dev/images/Reihe 7/Reihe-7-D1-4.png" alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./dev/images/Reihe 7/Reihe-7-D1-5.png" alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./dev/images/Reihe 7/Reihe-7-D1-6.png" alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./dev/images/Reihe 7/Reihe-7-D1-7.png" alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./dev/images/Reihe 7/Reihe-7-D1-8.png" alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td height="250" class="align-middle">
                                    <img src="./dev/images/Reihe 7/Reihe-7-D1-9.png" alt="Wo ist das?"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: ["./dev/sounds/Reihe 7/r7 D1.mp3"],
                sprite: {
                    "0": [288, 98096],
                    "1": [9119, 1512],
                    "2": [12928, 1642],

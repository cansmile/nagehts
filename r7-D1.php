            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        Fußball spielen<span
                            class="tran"><br><small>축구</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans0 btn-lg btn-outline-dark itm so"
                        id="2">
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans0 btn-lg btn-outline-dark itm so"
                        id="5">
                        in die Disko gehen<span
                            class="tran"><br><small>디스코장에서</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans0 btn-lg btn-outline-dark itm so"
                        id="7">
                        in die Stadt gehen<span
                            class="tran"><br><small>시내에서</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans9 btn-lg btn-outline-dark itm so"
                        id="8">
                        in den Zoo gehen<span
                            class="tran"><br><small>동물원에서</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans0 btn-lg btn-outline-dark itm so"
                        id="9">
                        in die Bibliothek gehen<span
                            class="tran"><br><small>도서관에 가다</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans7 btn-lg btn-outline-dark itm so"
                        id="10">
                        ins Kino<span
                            class="tran"><br><small>영화관에서</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans8 btn-lg btn-outline-dark itm so"
                        id="11">
                        ins Theater<span
                            class="tran"><br><small>극장에서</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark itm so"
                        id="12">
                        ins Museum gehen<span
                            class="tran"><br><small>박물관에서</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="14">
                        fotografieren<span
                            class="tran"><br><small>사진찍다</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans0 btn-lg btn-outline-dark itm so"
                        id="15">
                    ...
                    <button type="button"
                        ...
                        id="17">
                        schwimmen<span
                            class="tran"><br><small>수영하다</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans0 btn-lg btn-outline-dark itm so"
                        id="18">
                    ...
                    <button type="button"
                        ...
                        id="19">
                        Fahrrad fahren<span
                            class="tran"><br><small>운전하다</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans0 btn-lg btn-outline-dark itm so"
                        id="20">
                        spazieren gehen<span
                            class="tran"><br><small>산책하다</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans0 btn-lg btn-outline-dark itm so"
                        id="21">
                    ...
                    <button type="button"
                        ...
                        id="22">
                        ins Café gehen<span
                            class="tran"><br><small>카페에서</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark itm so"
                        id="23">
                        ins Restaurant gehen<span
                            class="tran"><br><small>레스토랑에서</small></span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
            ...
            <div class="row" id="lsts">
                        ...
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-D1-1.png"
                                        alt="Wo ist das?"
                            ...
                            <tr>
                                <td>
                                    <div class="rounded-top itm-lst pt-1 p-2 border border-dark"
                                        id="lst-1">
                                        <h2
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-D1-2.png"
                                        alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-D1-3.png"
                                        alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-D1-4.png"
                                        alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-D1-5.png"
                                        alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-D1-6.png"
                                        alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-D1-7.png"
                                        alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="300" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-D1-8.png"
                                        alt="Wo ist das?"
                                        style="max-width: 100%; height: auto;">
                                </td>
                            </tr>
                ...
                <div
                    class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3 text-center">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td height="250" class="align-middle">
                                    <img src="./<?php echo($root); ?>images/Reihe 7/Reihe-7-D1-9.png"
                                        alt="Wo ist das?"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="input-group">
                                                <input type="text"
                                                    class="form-control q border border-dark border-bottom-only rounded-0 mx-1 px-2 py-1"
                                                    aria-label="." id="qst-1">
                                            </div><span
                                                class="tran"><small><br>저는 영화관에
                                                    갑니다. 거기서 영화를
                                                    봅니다.</small></span>
                                        </td>
                                    </tr>

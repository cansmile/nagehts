					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 p-1">
						<table class="table">
							<tbody>
								...
								<tr>
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-D4-1.png" alt="Was ist das?" style="max-width: 100%; height: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 p-1">
						<table class="table">
							<tbody>
								...
								<tr>
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-D4-3.png" alt="Was ist das?" style="max-width: 100%; height: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">
										<div class="border border-dark rounded p-3">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 p-1">
						<table class="table">
							<tbody>
								...
								<tr>
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-D4-2.png" alt="Was ist das?" style="max-width: 100%; height: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">
										<div class="border border-dark rounded p-3">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 p-1">
						<table class="table">
							<tbody>
								...
								<tr>
									<td class="border-0"><img src="./<?=$root ?>images/Reihe 7/Reihe-7-D4-4.png" alt="Was ist das?" style="max-width: 100%; height: auto;"></td>
								</tr>
								<tr>
									<td class="border-0">
										<div class="border border-dark rounded p-3">

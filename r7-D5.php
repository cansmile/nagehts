        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark itm px-2 so"
                        id="1">
                        ins Café gehen.
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans6 btn-lg btn-outline-dark itm px-2 so"
                        id="2">
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans4 btn-lg btn-outline-dark itm px-2 so"
                        id="4">
                        in die Buchhandlung gehen.
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans5 btn-lg btn-outline-dark itm px-2 so"
                        id="5">
                        ins Kino gehen.
                    </button>
                    <button type="button"
                ...
                <div class="col-12">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <th class="text-center align-middle"
                                    scope="row" width="50">1.</th>
                                <td class="align-middle">
                                    <div class="p-2 m-0">
                                        Wir wollen essen gehen. Dann sollten
                                        wir&nbsp;
                                        <div class="itm-lst 1itm d-inline-block"
                                            id="lst-2" style="min-width: 30%; ">
                                            <h2
                                                class="btn btn-warning btn-xl ttl d-block">
                                                ▼ </h2>
                                        </div>
                            ...
                            <tr>
                                <th class="text-center align-middle"
                                    scope="row" width="50">3.</th>
                                <td class="align-middle">
                                    <div class="p-2 m-0">
                                        Er will ein Buch kaufen. Dann
                                        sollte&nbsp;
                                        <div class="itm-lst 1itm d-inline-block"
                                            id="lst-4" style="min-width: 30%; ">
                                            <h2
                                                class="btn btn-warning btn-xl ttl d-block">
                                                ▼ </h2>
                                        </div>
                            ...
                            <tr>
                                <th class="text-center align-middle"
                                    scope="row" width="50">4.</th>
                                <td class="align-middle">
                                    <div class="p-2 m-0">
                                        Wir wollen einen Film sehen. Dann
                                        sollten wir&nbsp;
                                        <div class="itm-lst 1itm d-inline-block"
                                            id="lst-5" style="min-width: 30%; ">
                                            <h2
                                                class="btn btn-warning btn-xl ttl d-block">
                                                ▼ </h2>
                                        </div>
                            ...
                            <tr>
                                <th class="text-center align-middle"
                                    scope="row" width="50">5.</th>
                                <td class="align-middle">
                                    <div class="p-2 m-0">
                                        Ich will Fleisch besorgen. Dann sollte
                                        ich&nbsp;
                                        <div class="itm-lst 1itm d-inline-block"
                                            id="lst-6" style="min-width: 30%; ">
                                            <h2
                                                class="btn btn-warning btn-xl ttl d-block">
                                                ▼ </h2>
                                        </div>

<?php require_once("heading.php"); ?>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                <span class="tran"><small>나는 금요일 오전에 교수님을 만나기로
                                        했다. 우리는 10시에 학교앞에서 만날꺼야. </small></span>
                            </td>
                        </tr>
                        <tr>
                            <th class="align-middle text-center"
                                scope="row" width="50">6.</th>
                            <td class="align-middle">
                                <div
                                    class="input-group d-inline-flex align-items-baseline">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                <span class="tran"><small>일요일 20시에 Nena 콘서트가 티비에
                                        나온다. </small></span>
                            </td>
                        </tr>
                        <tr>
                            <th class="align-middle text-center"
                                scope="row" width="50">8.</th>
                            <td class="align-middle">
                                <div
                                    class="input-group d-inline-flex align-items-baseline">
    ...
    <script>
        ...
        var an = new Array();
        var an = ["Am", "in", "am", "um", "um", "Am", "um", "in", "Am", "um",
            "um"
        ];

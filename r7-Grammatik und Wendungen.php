						...
						<div class="card-header" id="heading1">
							<h5 class="mb-0">
								<button class="btn btn-outline-danger mt-1 mx-1 btn-block" type="button" data-toggle="collapse" data-target="#collapse1" area-expanded="false" aria-controls="collapse1" id="1">
									<strong>Präpositionen</strong> <small>전치사</small>
								</button>
							</h5>
						</div>
						...
						<div class="card-header" id="heading2">
							<h5 class="mb-0">
								<button class="btn btn-outline-orange mt-1 mx-1 btn-block" type="button" data-toggle="collapse" data-target="#collapse2" area-expanded="false" aria-controls="collapse2" id="2">
									<strong>Adverb im Satz</strong> <small>문장에서의 부사</small>
								</button>
							</h5>
						</div>
						...
						<div class="card-header" id="heading3">
							<h5 class="mb-0">
								<button class="btn btn-outline-warning mt-1 mx-1 btn-block" type="button" data-toggle="collapse" data-target="#collapse3" area-expanded="false" aria-controls="collapse3" id="3">
									<strong>Modalverben</strong> <small>화법조동사<br>화자의 주관적인 생각을 화법조동사를 사용하여 가능성, 필연성, 확신 등을 표현할 수 있다.</small>
								</button>
							</h5>
						</div>
					...
					<div class="card">
						...
						<div class="collapse" id="collapse4" aria-divledby="heading4" data-parent="#accordionitms">
							<table class="table text-left bg-light">
								...
								<tbody>
									<tr>
										<td width="50%">Hast du heute Abend / am ...... Zeit?</td>
										<td>- Ja, klar.</td>
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td>- Das weiß ich noch nicht.</td>
									</tr>
									<tr>
									...
									<tr>
										<td>&nbsp;</td>
										<td>- Heute Abend / Am ..... habe ich leider keine Zeit.</td>
									</tr>
								</tbody>
							</table>
							<table class="table text-left">
								...
								<tbody>
									<tr>
										<td width="50%">Gehen wir ins Kino / ..... ?</td>
										<td>- Gute Idee! / Okay!</td>
									</tr>
									<tr>
										<td>Wollen wir heute Abend in den / in die / ins ..... gehen?</td>
										<td>- Nein, leider nicht. Ich habe keine Zeit.</td>
									</tr>
									<tr>
										<td>Hast du Lust auf Kino?</td>
										<td>- Ja, gut!</td>
									</tr>
								</tbody>
							</table>

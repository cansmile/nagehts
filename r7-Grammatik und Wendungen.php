                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="align-middle">am +
                                                Wochentage und Tageszeiten</td>
                                            <td class="align-middle">- am
                                                Montag, am Morgen</td>
                                        </tr>
                                        <tr>
                                            <td class="align-middle">um +
                                                Uhrzeiten</td>
                                            <td class="align-middle">- um drei
                                                Uhr</td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="collapse" id="collapse3" aria-divledby="heading3" data-parent="#accordionitms">
                                <div class="row p-1 m-2 border border-dark rounded">
                                    ...
                                    <div class="py-2 col-8">Tim
                                        ...
                                        Fußball.</div>
                                    <div class="py-2 col-4">Wunsch
                                        <small>(소망)</small></div>
                                    <div class="py-2 col-8">Er
                                        <strong><u>möchte</u></strong> Pilot
                                        <u>werden</u>.</div>
                                    <div class="py-2 col-4">Vorteile
                                        <small>(장점)</small></div>
                                    <div class="py-2 col-8">Er
                                        <strong><u>kann</u></strong> immer
                                        <strong>fliegen</strong>. (Ich fliege
                                        gern.)</div>
                                    <div class="py-2 col-4">Nachteile
                                        <small>(단점/중요)</small></div>
                                    <div class="py-2 col-8">Ein Pilot
                                        <strong><u>muss</u></strong> auch nachts

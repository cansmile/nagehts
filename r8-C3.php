...
<div class="container">
	<div class="row">
		...
		<div class="col-12" id="itms">
			<button type="button" class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark itm px-2 so" id="1">
				Halsschmerzen
			</button>
			<button type="button" class="mt-1 mx-1 btn ans4 btn-lg btn-outline-dark itm px-2 so" id="2">
				Bauchschmerzen
			</button>
			<button type="button" class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark itm px-2 so" id="3">
				Fieber
			</button>
			<button type="button" class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark itm px-2 so" id="4">
				Ohrenschmerzen
			</button>
		</div>
	</div>

				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6" id="itms">
						...
						<button type="button" class="mt-1 mx-1 btn ans8 btn-md btn-outline-dark itm so text-left" id="2">
							...
							<span class="tran"><br><small>제가 아들 데리고 갈게요!</small></span>
						</button>
						<button type="button" class="mt-1 mx-1 btn ans5 btn-md btn-outline-dark itm so text-left" id="3">
							...
							<span class="tran"><br><small>오늘 아침에 예약할 수 있나요?</small></span>
						</button>

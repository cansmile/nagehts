        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        class="mt-1 mx-1 btn ans5 btn-md btn-outline-dark itm so text-left"
                        id="1">
                        Was hast du gegessen?
                        <span class="tran"><br><small>뭘 먹었니?</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans8 btn-md btn-outline-dark itm so text-left"
                        id="2">
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans13 btn-md btn-outline-dark itm so text-left"
                        id="3">
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-md btn-outline-dark itm so text-left"
                        id="4">
                        Guten Tag, Frau Doktor!
                        <span class="tran"><br><small>안녕하세요, 선생님!</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans14 btn-md btn-outline-dark itm so text-left"
                        id="5">
                        Gute Besserung!
                        <span class="tran"><br><small>얼른 나으렴!</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-md btn-outline-dark itm so text-left"
                        id="6">
                        Hallo Peter?
                        <span class="tran"><br><small>안녕 피터?</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans6 btn-md btn-outline-dark itm so text-left"
                        id="7">
                        Ich habe Hamburger gegessen.
                        <span class="tran"><br><small>햄버거 먹었어요.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-md btn-outline-dark itm so text-left"
                        id="8">
                        Was fehlt dir denn?
                        <span class="tran"><br><small>어디가 아프니?</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans4 btn-md btn-outline-dark itm so text-left"
                        id="9">
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans7 btn-md btn-outline-dark itm so text-left"
                        id="10">
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans15 btn-md btn-outline-dark itm so text-left"
                        id="11">
                        Danke schön, Frau Doktor!
                        <span class="tran"><br><small>고맙습니다, 선생님!</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans9 btn-md btn-outline-dark itm so text-left"
                        id="12">
                        Ja, ich weiß.
                        <span class="tran"><br><small>네, 알아요.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans11 btn-md btn-outline-dark itm so text-left"
                        id="13">
                        (nach der Untersuchung) Peter!
                        <span class="tran"><br><small>(검진 후)피터!</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans12 btn-md btn-outline-dark itm so text-left"
                        id="14">
                        Du hast Darmgrippe.
                        <span class="tran"><br><small>장염에 걸렸구나.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans10 btn-md btn-outline-dark itm so text-left"
                        id="15">
                ...
                <div class="col-lg-12 mb-4 mt-2 text-center">
                    ...
                    <h3>[ <small><button type="button"
                            ...
                            버튼 또는 <button type="button"
                                class="so btn btn-sm btn-outline-secondary disabled">보기</button>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <th class="pb-0 pt-3 align-middle"
                                    scope="row" width="100">Ärztin:</th>
                            ...
                            <tr>
                                <th class="pb-0 pt-0 align-middle"
                                    scope="row" width="100">&nbsp;</th>
                                <td class="pb-0 pt-3 align-middle">
                            ...
                            <tr>
                                ...
                                <td class="pb-0 pt-3 align-middle">
                                    <div class="itm-lst 1itm d-inline-block"
                                        id="lst-9" style="min-width: 25%;">
                                        <h2
                                            class="btn btn-warning btn-xl ttl d-block">
                                            ▼ </h2>
                                    </div>
                                    <div class="itm-lst 1itm d-inline-block"
                                        id="lst-10" style="min-width: 70%;">
                                        <h2
                                            class="btn btn-warning btn-xl ttl d-block">
                                            ▼ </h2>
                                    </div>

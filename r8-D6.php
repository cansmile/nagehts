        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm px-3"
                        id="1">
                        Nimm doch Hustensaft!
                        <span class="tran"><br><small>기침약 먹어라!</small>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans5 btn-lg btn-outline-dark so itm px-3"
                        id="2">
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans7 btn-lg btn-outline-dark so itm px-3"
                        id="3">
                        Seien Sie bitte ruhig!
                        <span class="tran"><br><small>조용히 하세요!</small>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark so itm px-3"
                        id="4">
                        Geh zum Arzt!
                        <span class="tran"><br><small>의사에게 가봐라(너)!</small>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans6 btn-lg btn-outline-dark so itm px-3"
                        id="5">
                        Habt keine Angst!
                        <span class="tran"><br><small>걱정하지 마(너희들)!</small>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans4 btn-lg btn-outline-dark so itm px-3"
                        id="6">
                        Trinken Sie Kamillentee!
                        <span class="tran"><br><small>카모마일 차 마시지요!</small>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark so itm px-3"
                        id="7">

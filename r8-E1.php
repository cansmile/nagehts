            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    ...
                    <button type="button"
                        ...
                        id="11">
                        der Kopf<span
                            class="tran">&nbsp;<small>머리</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="13">
                        der Rücken<span
                            class="tran">&nbsp;<small>등</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans18 btn-lg btn-outline-dark so itm"
                        id="14">
                        der Zeh, -en<span
                            class="tran">&nbsp;<small>발가락</small></span>
                    </button>
                    <button type="button"
                        ...
                        die Brust, -<span
                            style="position: relative; left: -.2em;">̈
                            e</span><span
                            class="tran">&nbsp;<small>가슴</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="18">
                        die Zähne<span
                            class="tran">&nbsp;<small>치아</small></span>
                    </button>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                ...
                                <td rowspan="9"
                                    class="align-middle p-0 m-2 pl-2">
                                    <img src="./<?php echo($root); ?>images/Reihe 8/Reihe-8-E1-1.png"
                                        alt="Eva"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <td rowspan="9"
                                    class="align-middle p-0 m-1 text-center">
                                    <img src="./<?php echo($root); ?>images/Reihe 8/Reihe-8-E1-2.png"
                                        alt="Adam"
                                        style="max-width: 100%; height: auto;">
                                </td>
                                <td width="50%"

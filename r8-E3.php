            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        Bleiben Sie im Bett und trinken Sie viel Tee.<span
                            class="tran"><br>&nbsp;<small>침대에 누워 차를 많이
                                마시세요.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans1 btn-lg btn-outline-dark so itm"
                        id="2">
                        Ich habe Husten und auch Fieber.<span
                            class="tran"><br>&nbsp;<small>제가 기침하고 열도
                                있어서요.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans4 btn-lg btn-outline-dark so itm"
                        id="3">
                        Danke, Frau Doktor.<span
                            class="tran"><br>&nbsp;<small>감사해요, 의사
                                선생님.</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark so itm"
                        id="4">
                        Ich verschreibe Ihnen ein Rezept.<span
                            class="tran"><br>&nbsp;<small>제가 처방전을
                                드릴게요.</small></span>
                    </button>
                </div>
            </div>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Guten Tag, Frau Doktor!<span
                                        class="tran"><br><small>안녕하세요, 의사
                                            선생님!</small></span></td>
                            </tr>
                            <tr>
                                <td scope="row">
                            ...
                            <tr>
                                ...
                                <td>und schreibe Sie für eine Woche krank.<span
                                        class="tran"><br><small>그리고 일주일치 약을 써
                                            드릴게요.</small></span></td>
                            </tr>
                            <tr>
                                <td scope="row">
                            ...
                            <tr>
                                ...
                                <td>Gute Besserung, Herr Kim!<span
                                        class="tran"><br><small>얼른 회복하세요, 김
                                            선생님!</small></span></td>
                            </tr>
                        </tbody>
                    </table>

    ...
    <section class="nq-exercise" data-type="fill-blank" data-reihe="8">
        <div class="container">
            ...
            <div class="row my-2 py-2">
                <div class="col">
                    <span class="border border-dark rounded p-2">mir</span>
                    <span class="border border-dark rounded p-2">dir</span>
                    <span class="border border-dark rounded p-2">uns</span>
                    <span class="border border-dark rounded p-2">Ihnen</span>
                    <span class="border border-dark rounded p-2">euch</span>
                    <span class="border border-dark rounded p-2">ihr</span>
                    <span class="border border-dark rounded p-2">ihm</span>
                    <span class="border border-dark rounded p-2">ihnen</span>
                </div>
            </div>
            <div class="row">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: ["./dev/sounds/Reihe 8/r8 E4.mp3"],
                sprite: {
                    "0": [499, 45861]
                },
                html5: true,

<?php require_once("heading.php"); ?>
    ...
    <section class="nq-exercise" data-type="fill-blank" data-reihe="8">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 mb-4 mt-2 text-center">
                    ...
                    <h3>[ <small>정답을 입력하면 입력란이 초록색으로 표시되고,<br> 오답이 될 때는 입력란이 붉게
                            표시됩니다.</small> ]<button type="button"
            ...
            <div class="row">
                <div class="col">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                <th scope="row" width="5%">1.
                                </th>
                                <td width="45%">mehr Sport
                                    treiben (ihr)
                                    <span class="tran"><br><small>운동을 더 많이
                                            하다</small></span>
                                </td>
                                <td>
                                    ...
                                    <span class="tran"><small>운동을 더 많이
                                            해라!</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">2.</th>
                                <td>etwas lauter sprechen (Sie)
                                    <span class="tran"><br><small>조금 더 크게
                                            말하다</small></span>
                                </td>
                                <td>
                                    <div class="input-group">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="tran"><small>손을
                                            씻으렴!</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">4.</th>
                                <td>nicht so viel Eis essen
                                    (ihr)
                                    <span class="tran"><br><small>아이스크림을 그렇게 많이
                                            먹지 않다</small></span>
                                </td>
                                <td>
                                    <div class="input-group">
                                    ...
                                    <span class="tran"><small>아이스크림을 그렇게 많이 먹지
                                            말아라!</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">5.</th>
                                <td>den Imperativ erklären
                                    (Sie)
                                    <span class="tran"><br><small>명령형을
                                            설명하다</small></span>
                                </td>
                                <td>
                                    <div class="input-group">
                                    ...
                                    <span class="tran"><small>명령형을
                                            설명해주세요</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">6.</th>
                                <td>nicht so viel rauchen (du)
                                    <span class="tran"><br><small>담배를 많이 피우지
                                            않는다</small></span>
                                </td>
                                <td>
                                    <div class="input-group">
                                    ...
                                    <span class="tran"><small>(담배를) 많이 피우지 마십시오,
                                            제발!</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">7.</th>
                                <td>mehr Obst und Gemüse essen
                                    (ihr)
                                    <span class="tran"><br><small>과일과 채소를 더 많이
                                            먹다</small></span>
                                </td>
                                <td>
                                    <div class="input-group">
                                    ...
                                    <span class="tran"><small>과일과 채소를 더 많이
                                            먹으렴!</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">8.</th>
                                <td>regelmäßig Rad fahren (du)
                                    <span class="tran"><br><small>정기적으로 자전거를
                                            타다</small></span>
                                </td>
                                <td>
                                    <div class="input-group">
                                    ...
                                    <span class="tran"><small>정기적으로 자전거를 타라,
                                            제발!</small></span>
                                </td>
                            </tr>
                        </tbody>
    ...
    <script>
        ...
        $(".ant").hide();
        var an = new Array();
        var an = ["Treibt", "Sprechen Sie", "Wasch", "Esst", "Erklären Sie",
            "Rauch", "Esst", "Fahr"
        ];
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: ["./dev/sounds/Reihe 8/r8 E6.mp3"],
                sprite: {
                    "0": [1656, 62342]
                },
                html5: true,

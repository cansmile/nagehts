			...
			<div class="row">
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
					<table class="table border-0">
						<tbody>
							<tr>
								<td height="250" class="border-0 align-middle"><img src="./<?=$root ?>images/Reihe 9/Reihe-9-A0-1.png" alt="Wann ist das?" style="max-width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td class="border-0">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
					<table class="table border-0">
						<tbody>
							<tr>
								<td height="250" class="border-0 align-middle"><img src="./<?=$root ?>images/Reihe 9/Reihe-9-A0-2.png" alt="Wann ist das?" style="max-width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td class="border-0">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
					<table class="table border-0">
						<tbody>
							<tr>
								<td height="250" class="border-0 align-middle"><img src="./<?=$root ?>images/Reihe 9/Reihe-9-A0-3.png" alt="Wann ist das?" style="max-width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td class="border-0">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
					<table class="table border-0">
						<tbody>
							<tr>
								<td height="250" class="border-0 align-middle"><img src="./<?=$root ?>images/Reihe 9/Reihe-9-A0-4.png" alt="Wann ist das?" style="max-width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td class="border-0">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
					<table class="table border-0">
						<tbody>
							<tr>
								<td height="250" class="border-0 align-middle"><img src="./<?=$root ?>images/Reihe 9/Reihe-9-A0-5.png" alt="Wann ist das?" style="max-width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td class="border-0">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
					<table class="table border-0">
						<tbody>
							<tr>
								<td height="250" class="border-0 align-middle"><img src="./<?=$root ?>images/Reihe 9/Reihe-9-A0-6.png" alt="Wann ist das?" style="max-width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td class="border-0">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-3">
					<table class="table border-0">
						<tbody>
							<tr>
								<td height="250" class="border-0 align-middle"><img src="./<?=$root ?>images/Reihe 9/Reihe-9-A0-7.png" alt="Wann ist das?" style="max-width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td class="border-0">

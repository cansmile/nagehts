            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        Alles Gute zum Geburtstag!<span
                            class="tran"><br><small>생일축하해!</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans3 btn-lg btn-outline-dark so itm"
                        id="5">
                        Alles Liebe zum Geburtstag!<span
                            class="tran"><br><small>생일축하해!</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark so itm"
                        id="6">
                        Guten Rutsch ins Neujahr!<span
                            class="tran"><br><small>새해 복 많이 받으세요!</small></span>
                    </button>
                    <button type="button"
                ...
                <div class="col-12">
                    <div class="video-container rounded">
                        <object width="320" height="240">
                            <param name="movie"
                                value="https://www.youtube.com/v/TuyroRHlcBE?version=3">
                            </param>
                            <param name="allowFullScreen" value="true">
                            </param>
                            <param name="allowscriptaccess" value="always">
                            </param><embed
                                src="https://www.youtube.com/v/TuyroRHlcBE?version=3"

            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    ...
                    <button type="button"
                        ...
                        id="2">Nikolaustag<span
                            class="tran"><br><small>성니콜라스</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark itm so"
                        id="3">Valentinstag<span
                            class="tran"><br><small>발렌타인</small></span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="5">Silvester<span
                            class="tran"><br><small>송구영신</small></span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans7 btn-lg btn-outline-dark itm so"
                        id="6">Heiligabend<span
                            class="tran"><br><small>성탄전야</small></span>
                    </button>
                    <button type="button"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle"
                                    ...
                                    Spiele. Um Mitternacht macht man ein großes
                                    Feuerwerk und wünscht sich gegenseitig ein
                                    gutes neues Jahr.
                                    <span class="tran"><small>모든 가족들이 송구영신과 새해는
                                            집에서 지낸다. 가족들은 카드놀이나 다른 놀이들을 한다. 자정이
                                            되면 커다란 폭죽을 터트리고 서로에게 새해의 복을
                                            빌어준다.</small></span></td>
                            </tr>
                            <tr>
                                <th width="50" class="align-top"
                                ...
                                <td class="align-middle"
                                    ...
                                    <span class="tran"><small>발렌타인데이는 사랑하는 이들이나
                                            친구들이 우편엽서, 선물 혹은 꽂을
                                            선물한다.</small></span></td>
                            </tr>
                            <tr>
                                ...
                                <td class="align-middle"
                                    ...
                                    <span class="tran"><small>곧 겨울이 가고 봄이 오면
                                            ...
                                            부른다. 사육제 월요일에는 성대한 카니발퍼레이드가 있다. 이러한
                                            카니발로 쾰른, 마인츠 그리고 뮌헨이
                                            유명하다.</small></span></td>
                            </tr>
                            <tr>
                                ...
                                <td class="align-middle"
                                    ...
                                    <span class="tran"><small>부활절에는 부활절 토끼가 정원에
                                            계란을 숨겨놓는다. 그럼 아이들은 그 계란을
                                            찾는다.</small></span></td>
                            </tr>
                            <tr>
                                <th width="50" class="align-top"
                                ...
                                <td class="align-middle"
                                    ...
                                    die Kerzen.
                                    <span class="tran"><small>대림절에 독일 가정에는 네 개의
                                            초가 있는 대림절화관이 있다. 성탄절 전 네 번의 일요일에 이
                                            초들이 불을 밝힌다.</small></span></td>
                            </tr>
                            <tr>
                                <th width="50" class="align-top"
                                    scope="col">6.</th>
                                <td class="align-middle"
                                    ...
                                    Eingang der Wohnung. Am nächsten Morgen
                                    finden sie genau dort Süßigkeiten.
                                    <span class="tran"><small>니콜라우스는 주교였고 아이들의
                                            친구였다. 성니콜라우스의 날, 12월 6일 전날 밤에 아이들은 집
                                            현관앞에 신발이나 양말을 놔둔다. 그다음 날 아침 바로 거기에서
                                            사탕등과 같은 단 것들을 발견한다.</small></span>
                                </td>
                            </tr>
                            <tr>
                                <th width="50" class="align-top"
                                ...
                                <td class="align-middle"
                                    ...
                                    <span class="tran"><small>독일에서 크리스마스는 이렇게
                                            ...
                                            간다. 교회에서 집으로 다시오면 가족들은 함께 크리스마스 노래를
                                            부르고 크리스마스선물을 푼다. 크리스마스 음식, 예를 들어
                                            성탄절거위요리는 12월 25일에
                                            먹는다.</small></span></td>
                            </tr>
                        </tbody>

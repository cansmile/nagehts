...
<?php require "nav.php"; ?>
	...
	<section>
		<div class="container">
			...
			<div class="row">
				<div class="col"><img src="./<?=$root ?>images/Reihe 9/Reihe-9-A4.png" alt="" style="max-width: 100%; height: auto;"> </div>
			</div>
			<div class="row">
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td width="50" class="border-0 text-right">12.1.</td>
								<td class="border-0">
									<div class="itm-lst 1itm d-inline-block px-0 mr-1" style="min-width: 200px;" id="lst-1">
										<h2 class="btn btn-warning btn-xl ttl d-block">
										▼ </h2>
									</div>ist ein Sonntag. <span class="tran"><br><small>1월 12일은 일요일입니다.</small></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td width="50" class="border-0 text-right">5.2.</td>
								<td class="border-0">
									<div class="itm-lst 1itm d-inline-block px-0 mr-1" style="min-width: 200px;" id="lst-2">
										<h2 class="btn btn-warning btn-xl ttl d-block">
										▼ </h2>
									</div>ist ein Mittwoch. <span class="tran"><br><small>2월 5일은 수요일입니다.</small></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td width="50" class="border-0 text-right">1.5.</td>
								<td class="border-0">
									<div class="itm-lst 1itm d-inline-block px-0 mr-1" style="min-width: 200px;" id="lst-3">
										<h2 class="btn btn-warning btn-xl ttl d-block">
										▼ </h2>
									</div>ist ein Donnerstag. <span class="tran"><br><small>5월 1일은 목요일입니다.</small></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td width="50" class="border-0 text-right">17.6.</td>
								<td class="border-0">
									<div class="itm-lst 1itm d-inline-block px-0 mr-1" style="min-width: 200px;" id="lst-4">
										<h2 class="btn btn-warning btn-xl ttl d-block">
										▼ </h2>
									</div>ist ein Dienstag. <span class="tran"><br><small>6월 17일은 화요일입니다.</small></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td width="50" class="border-0 text-right">9.7.</td>
								<td class="border-0">
									<div class="itm-lst 1itm d-inline-block px-0 mr-1" style="min-width: 200px;" id="lst-5">
										<h2 class="btn btn-warning btn-xl ttl d-block">
										▼ </h2>
									</div>ist ein Mittwoch. <span class="tran"><br><small>7월 9일은 수요일입니다.</small></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td width="50" class="border-0 text-right">23.12.</td>
								<td class="border-0">
									<div class="itm-lst 1itm d-inline-block px-0 mr-1" style="min-width: 200px;" id="lst-6">
										<h2 class="btn btn-warning btn-xl ttl d-block">
										▼ </h2>
									</div>ist ein Dienstag. <span class="tran"><br><small>12월 23일은 화요일입니다.</small></span>
								</td>
							</tr>
						</tbody>
					</table>

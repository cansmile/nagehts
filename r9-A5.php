			...
			<div class="row">
				<div class="col border border-dark rounded">
					<table class="table">
						<thead>
							<tr>
								<th scope="col" colspan="2" class="border-0">Das Datum</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="border-0">Man schreibt:</td>
								<td class="border-0">Man sagt:</td>
							</tr>
							<tr>
								<td class="border-0">15. 8. oder 15. August</td>
								<td class="border-0">Heute ist der fünfzehnte Achte. oder</td>
							</tr>
							<tr>
								<td class="border-0">&nbsp;</td>
								<td class="border-0">Heute ist der fünfzehnte August.</td>
							</tr>
							<tr>
								<td class="border-0">15. 8. Unabhängiger Tag</td>
								<td class="border-0">Am fünfzehnten August ist Unabhängiger Tag. oder</td>
							</tr>
							<tr>
								<td class="border-0">&nbsp;</td>
								<td class="border-0">Am fünfzehnten Achten ist Unabhängiger Tag.</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 my-2">
					<table class="table border-0">
						<tbody>
							<tr>
								<th width="20" class="text-center"><button type="button" id="1" class="so btn btn-outline-dark btn-sm mr-1">▶</button></th>
				...
				<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 my-2">
					<table class="table border-0">
						<tbody>
							<tr>
								<th width="20" class="text-center"><button type="button" id="2" class="so btn btn-outline-dark btn-sm mr-1">▶</button></th>
				...
				<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 my-2">
					<table class="table border-0">
						<tbody>
							<tr>
								<th width="20" class="text-center"><button type="button" id="3" class="so btn btn-outline-dark btn-sm mr-1">▶</button></th>
				...
				<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 my-2">
					<table class="table border-0">
						<tbody>
							<tr>
								<th width="20" class="text-center"><button type="button" id="4" class="so btn btn-outline-dark btn-sm mr-1">▶</button></th>
				...
				<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 my-2">
					<table class="table border-0">
						<tbody>
							<tr>
								<th width="20" class="text-center"><button type="button" id="5" class="so btn btn-outline-dark btn-sm mr-1">▶</button></th>

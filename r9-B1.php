        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans12 btn-lg btn-outline-dark itm px-3"
                        id="8">
                        b
                    </button>
                    <button type="button"
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-sm-6 col-md-4 col-lg-2 p-2 align-middle text-center"
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="row">
                        <div
                            class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border border-light">
                            <span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>1</strong></span><br>Herzlichen
                            Glückwunsch, Sara.<br>Hier ist mein Geschenk.<span
                                class="tran"><br><small>사라야, (생일) 축하해! 여기 내
                                    선물</small></span>
                        </div>
                        <div
                            class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border border-light">
                            ...
                            habe im Mai Geburtstag, du auch?<span
                                class="tran"><br><small>나는 5월에 생일이야, 너도
                                    그래?</small></span>
                        </div>
                        <div
                            class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border border-light">
                            ...
                            die Kinderschokolade ist lecker.<span
                                class="tran"><br><small>여기, 이 어린이초코렛
                                    맛있단다.</small></span>
                        </div>
                        <div
                            class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border border-light">
                            ...
                            ist denn die Geburtstagstorte?<br><span
                                class="tran"><br><small>생일케익이
                                    어디있지?</small></span>
                        </div>
                        <div
                            class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border border-light">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="row">
                        <div
                            ...
                            ich habe auch im Mai Geburtstag!<span
                                class="tran"><br><small>응, 나도 5월에
                                    생일이야</small></span>
                        </div>
                        <div
                            class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border border-light">
                        ...
                        <div
                            ...
                            eine Musik-CD. Danke. Das ist ja toll.<span
                                class="tran"><br><small>오, 음악CD구나. 정말
                                    좋다</small></span>
                        </div>
                        <div
                            class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border border-light">
                            ...
                            die Kekse sind meine Lieblingskekse.<span
                                class="tran"><br><small>나! 이 과자는 내가 좋아하는
                                    과자야</small></span>
                        </div>
                        <div
                            class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 border border-light">
                        ...
                        <div
                            ...
                            ich darf nicht. Ich kann dann nicht schlafen.<span
                                class="tran"><br><small>아 나. 마시면 안되. 그럼 잠을
                                    못자서.</small></span>
                        </div>
                    </div>
                </div>

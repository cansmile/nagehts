			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-12 text-center">
						<img src="./<?=$root ?>images/Reihe 9/Reihe-9-B2-1.png" alt="Geburtstagsfeier in Deutschland und in Korea" style="max-width: 240px; height: auto;">
					</div>
					<div class="col-12">
						<table class="table">
							<thead>
							...
							<tbody>
								<tr>
									...
									<td class="border-0">In Deutschland feiert man mit Freunden und Familie.<span class="tran"><br><small>독일에서는 친구와 가족과 (생일) 파티를 한다.</small></br></span></td>
									<td class="border-0">
								...
								<tr>
									...
									<td class="border-0">Man feiert nur zu Hause mit Kuchen und leckerem Essen.<span class="tran"><br><small>케익과 맛있는 음식으로 오직 집에서만 파티를 한다.</small></br></span></td>
									<td class="border-0">
								...
								<tr>
									...
									<td class="border-0">Man kauft in Deutschland Geburtstagstorten.<span class="tran"><br><small>독일에서는 생일케익을 산다.</small></br></span></td>
									<td class="border-0">
								...
								<tr>
									...
									<td class="border-0">In Korea isst normalerweise das Geburtstagskind am Gebutstagsmorgen Reis und Seetangsuppe.<span class="tran"><br><small>한국에서는 일반적으로 생일을 맞이한 사람이 생일날 아침에 밥과 미역국을 먹는다.</small></br></span></td>
									<td class="border-0">
								...
								<tr>
									...
									<td class="border-0">Man schenkt dem Geburtstagskind in Korea immer Geld.<span class="tran"><br><small>한국에서는 생일을 맞이한 사람에게 항상 돈을 선물한다.</small></br></span></td>
									<td class="border-0">
								...
								<tr>
									...
									<td class="border-0">Man feiert in Korea nicht zu Hause.<span class="tran"><br><small>한국에서는 (생일)파티를 집에서 하지 않는다.</small></br></span></td>
									<td class="border-0">

        ...
        <div class="container">
            ...
            <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle"
                                            ...
                                            <img src="./<?php echo($root); ?>images/Reihe 9/Reihe-9-C1-1.png"
                                                alt="Wer spricht mit wem?"
                                                style="max-width: 100%; height: auto;">
                                        </td>
                                        <td
                                            class="text-center align-middle">
                                            <div class="itm-lst 1itm"
                                                id="lst-1">
                                                <h2
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="row">
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="11"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>1</strong></span><br>Die
                            Verkäuferin zeigt der Mutter und dem Kind ein
                            Wertkauftelefon.<span
                                class="tran"><br><small></small></span>
                        </div>
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="12"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>2</strong></span><br>Eine
                            Kursteilnehmerin stellt dem Lehrer eine Frage nach
                            dem Dativ.<span
                                class="tran"><br><small></small></span>
                        </div>
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="13"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>3</strong></span><br>Der
                            Vater will seiner Tochter beim Sprachenlernen
                            helfen.<span class="tran"><br><small></small></span>
                        </div>
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="14"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>4</strong></span><br>Tim
                            schenkt seiner Freundin zum Valentinstag eine
                            Halskette.<span
                                class="tran"><br><small></small></span>
                        </div>
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="15"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>5</strong></span><br>Die
                            Oma kauft ihrem Enkelkind zum Geburtstag ein
                            Fahrrad.<span
                                class="tran"><br><small></small></span>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="row">
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="16"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>a</strong></span><br>Deshalb
                            kauft er ihr ein Wörterbuch.<br><span
                                class="tran"><br><small></small></span>
                        </div>
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="17"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>b</strong></span><br>Er
                            erklärt ihr den Dativ.<br><span
                                class="tran"><br><small></small></span>
                        </div>
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="18"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>c</strong></span><br>Er
                            schenkt ihr die Kette.<br><span
                                class="tran"><br><small></small></span>
                        </div>
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="19"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>d</strong></span><br>Sie
                            zeigt ihnen ein Wertkauftelefon<br><span
                                class="tran"><br><small></small></span>
                        </div>
                        <div class="col-12 p-2 border border-light"><button
                                type="button" id="20"
                                class="so btn btn-outline-dark btn-sm mr-1">▶</button><span
                                class="p-1 bg-dark text-white border border-dark rounded mb-2 px-2"><strong>e</strong></span><br>Sie
                            will ihm das Fahrrad schenken.<br><span
                                class="tran"><br><small></small></span>
                        </div>
                    </div>
                </div>

            ...
            <div class="row py-2 my-2 lh350">
                <div class="col">
                    <span class="border border-dark rounded p-2">eine
                        Kaffeemaschine</span>
                    <span class="border border-dark rounded p-2">Musik
                        CDs</span>
                    <span class="border border-dark rounded p-2">eine
                        Kamera</span>
            ...
            <div class="row py-2 border border-dark my-2 rounded">
                ...
                <div class="col-sm-6 col-md-12 col-lg-12 my-2">
                    <div class="input-group">
                        Deshalb möchte ich
                        <input autocomplete="off" type="text" class="form-control q ps-0 rounded-0 border-bottom-only mx-1 px-2 py-1
            ...
            <div class="row">
                <div class="col">
                    <table class="table table-borderless table-sm table-striped">
                        <thead>
                            <tr>
                                <th scope="col" class="pb-3"><span class="tipp">TIPP</span>deshalb
                                    어순</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="col">
                    <table class="table table-striped table-sm table-borderless">
                        <thead>
                            <tr>
                                <th scope="col" class="pb-3"><span class="tipp">TIPP</span>강조*
                                    + 동사 + 주어</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th scope="row"><small>* 강조는 부사 혹은 목적어가 될 수
                                        있다.</small></th>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col">
                    <table class="table table-striped table-sm table-borderless">
                        <thead>
                            <tr>
                                <th scope="col" class="pb-3"><span class="tipp">TIPP</span>möchten
                                    어순</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th scope="row"><small>möchten + 동사원형(문장 끝에
                                        위치)</small></th>
                            </tr>
                        </tbody>
                    </table>

		...
		<div class="row">
			...
			<div class="col-12" id="itms">
				...
				<button type="button" class="mt-1 mx-1 btn ans7 btn-lg btn-outline-dark itm so" id="5">
					...
					<span class="tran"><br />수요일까지 나에게 대답을 해주시던지 전화해주렴</span>
				</button>
				...
				<button type="button" class="mt-1 mx-1 btn ans2 btn-lg btn-outline-dark itm so" id="7">
					Das möchte ich gern mit dir und meinen anderen Freunden feiern.
					<span class="tran"><br />너와 나의 다른 친구들과 생일파티를 하고자 해.</span>
				</button>

		...
		<div class="container">
			...
			<div class="row">
				<table class="table table-striped table-sm table-borderless">
					<thead>
						<tr>
							<th scope="col" colspan="10"><span class="bg-lime font-weight-bold rounded p-1 px-2 m-1">TIPP</span>Personalpronomen <small>인칭대명사</small></th>
						</tr>
					</thead>
					<tbody>
						<tr>
	...
	<script>
		...
		$(document).ready(function() {// 소리 출력 전역 변수와 함수
			...
			var nagehts = new Howl({
				src: ["./<?=$root ?>sounds/Reihe 9/r9 D2.mp3"],
				sprite : {
					"0": [1035, 34824]
				},
				html5: true,

            ...
            <div class="row py-2 border border-dark my-2 rounded bg-light" style="line-height: 300%;">
                ...
                <div class="col-12 my-2">
                    <div class="input-group">
                        Das möchte <input autocomplete="off" type="text" class="form-control q ps-0 rounded-0 border-bottom-only mx-1 px-2 py-1 text-center
                        ...
                        <span class="tran"><br><small>파티는 5월 4일 토요일,
                                20시야.</small></span> <input autocomplete="off" type="text" class="form-control q ps-0 rounded-0 border-bottom-only mx-1 px-2 py-1 text-center
                            border-dark mx-1 t-6" style="min-width: 150px;" aria-label="." id="qst-3">
                        lade<input autocomplete="off" type="text" class="form-control q ps-0 rounded-0 border-bottom-only mx-1 px-2 py-1 text-center
                            border-dark mx-1 t-6" style="min-width: 150px;" aria-label="." id="qst-4">
                        herzlich ein.
                        <span class="tran"><br><small>너희를 초대할게.</small></span>
                        Habt<input autocomplete="off" type="text" class="form-control q ps-0 rounded-0 border-bottom-only mx-1 px-2 py-1 text-center

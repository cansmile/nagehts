		...
		<div class="container">
			...
			<div class="row">
				<table class="table table-striped">
					<thead>
						<tr>
							<th scope="col" colspan="10"><span class="bg-lime font-weight-bold rounded p-1 px-2 m-1">TIPP</span>Personalpronomen 인칭대명사</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<th scope="col" class="border-0 text-center">Nominativ</th>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">ich</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">du</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">Sie</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">er</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">sie</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">es</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">wir</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">ihr</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">sie</td>
						</tr>
						<tr>
							<th scope="col" class="border-0 text-center">Akkusativ</th>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">mich</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">dich</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">Sie</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">ihn</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">sie</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">es</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">uns</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">euch</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">sie</td>
						</tr>
						<tr>
							<th scope="col" class="border-0 text-center">Dativ</th>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">mir</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">dir</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">Ihnen</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">ihm</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">ihr</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">ihm</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">uns</td>
							<td class="border border-dark border-right-0 border-top-0 border-bottom-0 text-center">euch</td>

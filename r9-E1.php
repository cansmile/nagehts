        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div
                        class="border border-dark rounded p-1 px-2 d-block font-weight-bold">
                        Weihnachten<span
                            class="tran">&nbsp;<small>크리스마스</small></span></div>
                    <div class="btn-group btn-group-toggle q"
                        ...
                        <div class="btn btn-light pop x" data-toggle="popover"
                            ...
                            <input type="radio" name="options" id="option1"
                                ...
                                for="option1">Frühling<span
                                    class="tran"><br><small>봄</small></span></label>
                        </div>
                        <div class="btn btn-light pop x" data-toggle="popover"
                            data-container="body" data-placement="top"
                            data-content="정답이 아니에요.">
                            <input type="radio" name="options" id="option2"
                                autocomplete="off"><label
                                for="option2">Sommer<span
                                    class="tran"><br><small>여름</small></span></label>
                        </div>
                        <div class="btn btn-light pop x" data-toggle="popover"
                            data-container="body" data-placement="top"
                            data-content="정답이 아니에요.">
                            <input type="radio" name="options" id="option3"
                                autocomplete="off"><label
                                for="option3">Herbst<span
                                    class="tran"><br><small>가을</small></span></label>
                        </div>
                        <div class="btn btn-light pop o" data-toggle="popover"
                            ...
                            <input type="radio" name="options" id="option4"
                                autocomplete="off"><label
                                for="option4">Winter<span
                                    class="tran"><br><small>겨울</small></span></label>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div
                        class="border border-dark rounded p-1 px-2 d-block font-weight-bold">
                        Karneval<span
                            class="tran">&nbsp;<small>카니발</small></span></div>
                    <div class="btn-group btn-group-toggle q"
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div
                        class="border border-dark rounded p-1 px-2 d-block font-weight-bold">
                        Oktoberfest<span
                            class="tran">&nbsp;<small>옥토버페스트</small></span>
                    </div>
                    <div class="btn-group btn-group-toggle q"
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div
                        class="border border-dark rounded p-1 px-2 d-block font-weight-bold">
                        Valentinstag<span
                            class="tran">&nbsp;<small>발렌타인데이</small></span>
                    </div>
                    <div class="btn-group btn-group-toggle q"
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div
                        class="border border-dark rounded p-1 px-2 d-block font-weight-bold">
                        Erntedankfest<span
                            class="tran">&nbsp;<small>추수감사절</small></span></div>
                    <div class="btn-group btn-group-toggle q"

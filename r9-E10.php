        ...
        <div class="container">
            ...
            <div class="row" id="lsts">
                <div style="min-height: 240px;"
                    ...
                    id="lst-1">
                    <h2
                        class="btn btn-xl bg-white ttl d-block font-weight-bold">
                        habenverben <span
                            class="tran"><br><small>haben동사</small></span></h2>
                    &nbsp;
                </div>
                <div style="min-height: 240px;"
                    ...
                    <h2
                        class="btn btn-xl bg-white ttl d-block font-weight-bold">
                        Bewegungsverben <span
                            class="tran"><br><small>동작동사</small></span></h2>
                    &nbsp;
                </div>
                <div style="min-height: 240px;"
                    ...
                    <h2
                        class="btn btn-xl bg-white ttl d-block font-weight-bold">
                        Veränderungsverben <span
                            class="tran"><br><small>상태동사</small></span></h2>
                    &nbsp;
                </div>
                <div style="min-height: 240px;"
                    ...
                    <h2
                        class="btn btn-xl bg-white ttl d-block font-weight-bold">
                        Sonderverben <span
                            class="tran"><br><small>예외동사</small></span></h2>
                    &nbsp;
                </div>
            </div>
            <!-- 정답화인 버튼 시작 -->
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th scope="col"><span
                                        class="tipp">TIPP</span><small><strong>&nbsp;일상회화,
                                            과거분사형, 과거</strong></small></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th scope="col"><span
                                        class="tipp">TIPP</span><small><strong>&nbsp;지속,
                                            -ieren 동사</strong></small></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th scope="col"><span
                                        class="tipp">TIPP</span><small><strong>&nbsp;werden,
                                            상태의 변화, bleiben</strong></small>
                                </th>
                            </tr>
                        </thead>
                        <tbody>

            ...
            <div class="row">
                ...
                <div class="col-12" id="itms">
                    <button type="button"
                        ...
                        id="1">
                        am Wochenende haben wir das koreanische Neujahr
                        „Seoulnal“ gefeiert.
                    ...
                    <button type="button"
                        ...
                        id="5">
                        Lass uns bald mal treffen und ich zeige dir dann ein
                        paar Videos vom Fest.
                        <span class="tran"><br />우리 한번 만나자. 그럼 내가 비디오영상을 몇 개
                            보여줄게.</span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        ...
                        id="8">
                        Danach haben wir verschiedene Spiele gespielt, wie zum
                        Beispiel das traditionelle Spiel ,Yutnori‘.
                        <span class="tran"><br />그리고나서 우리는 여러 가지 놀이를 하였는데, 예를 들어
                            한국전통놀이인 윷놀이를 했어.</span>
                    </button>
                    <button type="button"
                        class="mt-1 mx-1 btn ans5 btn-lg btn-outline-dark itm"
                        id="9">
                        Nach dem Essen haben wir Jüngeren uns vor den Älteren
                        verbeugt und ihnen ein frohes neues Jahr gewünscht.
                        <span class="tran"><br />식사 후에 나이가 적은 우리들이 어른들께 세배를 하였고
                            새해 인사를 드렸어.</span>
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="mt-1 mx-1 btn ans12 btn-lg btn-outline-dark itm"
                        id="11">
                        Deine ○○○
                    ...
                    <button type="button"
                        ...
                        id="12">
                        Wir haben zusammen Reiskuchensuppe gegessen. Hm, das war
                        einfach lecker!
                        <span class="tran"><br />우리들은 함께 떡국을 먹었어. 음, 진짜
                            맛있었어.</span>
                    </button>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 mb-4 mt-2 text-center">
                    <h2>Hören Sie und vergleichen Sie.<small>&nbsp;듣고
                            비교하세요.</small></h2>

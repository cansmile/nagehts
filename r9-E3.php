...
<body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 my-2 py-2">
                    <img src="./<?php echo($root); ?>images/Reihe 9/Reihe-9-E3.png"
                        alt="Schreiben Sie die Tage."
    ...
    <script>
        ...
        var an = new Array();
        var an = [
            ["dreiundzwanzigste März", "dreiundzwanzigste Dritte"],
            ["sechste April", "sechste Vierte"],
            ["siebzehnte Mai", "siebzehnte Fünfte"],
            ["siebzehnte August", "siebzehnte Achte"],
            ["sechsundzwanzigste Oktober", "sechsundzwanzigste Zehnte"],
            ["fünfundzwanzigste Dezember", "fünfundzwanzigste Zwölfte"]
        ];

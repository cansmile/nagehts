        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6"
                    ...
                    <span class="text-white bg-dark rounded p-1 px-2 m-1">Eva
                        Fischer.</span>&nbsp;
                    <span class="tran">&nbsp;<small>에바 피셔</small></span>
                    Es ist für mich das schönste Fest, weil endlich der Frühling
                    kommt.&nbsp;
                    <span class="tran">&nbsp;<small>그것은 나에게 가장 아름다운 축제다, 왜냐하면
                            마침내 봄이 오기 때문이다.</small></span>
                        ...
                        <div class="btn-group btn-group-toggle border border-dark border-bottom-only q d-inline-flex"
                            ...
                            <div class="btn btn-light pop o px-1"
                                ...
                                <input type="radio" name="options" id="option1"
                                    autocomplete="off">Tochter
                            </div>
                            <div class="btn btn-light pop x px-1"
                                data-toggle="popover" data-container="body"
                                data-placement="top" data-content="정답이 아니에요.">
                                <input type="radio" name="options" id="option2"
                                    autocomplete="off">Kinder
                            </div>
                            <div class="btn btn-light pop x px-1"
                                data-toggle="popover" data-container="body"
                                data-placement="top" data-content="정답이 아니에요.">
                                <input type="radio" name="options" id="option3"
                                    autocomplete="off">Bruder
                            </div>
                        </div>besucht uns mit ihren Kindern.&nbsp;<span
                            class="ans"> </span>
                    </span>
                    <span class="tran">&nbsp;<small>나의 딸은 자녀들과 함께 우리를
                            방문한다.</small></span>
                    <span class="sen">Ich und mein Mann verstecken die <span
                            class="nu"> </span>
                        <div class="btn-group btn-group-toggle border border-dark border-bottom-only q d-inline-flex"
                            ...
                            <div class="btn btn-light pop o px-1"
                                ...
                                <input type="radio" name="options" id="option4"
                                    autocomplete="off">Ostereier
                            </div>
                            <div class="btn btn-light pop x px-1"
                                data-toggle="popover" data-container="body"
                                data-placement="top" data-content="정답이 아니에요.">
                                <input type="radio" name="options" id="option5"
                                    autocomplete="off">Osterhase
                            </div>
                            <div class="btn btn-light pop x px-1"
                                data-toggle="popover" data-container="body"
                                data-placement="top" data-content="정답이 아니에요.">
                                <input type="radio" name="options" id="option6"
                                    autocomplete="off">Schokolade
                            </div>
                        </div> im Garten.&nbsp;<span class="ans"> </span>
                    </span>
                    <span class="tran">&nbsp;<small>나와 남편은 부활절 계란을 정원에
                            숨겨둔다.</small></span>
                    Unsere Enkelkinder finden sie.&nbsp;
                    <span class="tran">&nbsp;<small>우리의 손자, 손녀들은 그것들을
                            찾는다.</small></span>
                    Das macht uns allen Spaß.&nbsp;
                    <span class="tran">&nbsp;<small>이것은 우리 모두를 즐겁게
                            해준다.</small></span>
                    Wie heißt das Fest ?&nbsp;
                ...
                <div class="col-sm-12 col-md-6 col-lg-6"
                    style="line-height: 250%;">
                    <span class="text-white bg-dark rounded p-1 px-2 m-1">Tim
                        Klein.</span>&nbsp;
                    <span class="tran">&nbsp;<small>팀 클라인</small></span>
                    <span class="sen">Ich liebe <span class="nu"> </span>
                        <div class="btn-group btn-group-toggle border border-dark border-bottom-only q d-inline-flex"
                    ...
                    <span class="sen">Die Leute kaufen <span class="nu"> </span>
                        <div class="btn-group btn-group-toggle border border-dark border-bottom-only q d-inline-flex"
                        ...
                        <div class="btn-group btn-group-toggle border border-dark border-bottom-only q d-inline-flex"
                            ...
                            <div class="btn btn-light pop x px-1"
                                ...
                                <input type="radio" name="options" id="option16"
                                    autocomplete="off">Weihnachtsgans
                            </div>
                            <div class="btn btn-light pop x px-1"
                                data-toggle="popover" data-container="body"
                                data-placement="top" data-content="정답이 아니에요.">
                            ...
                            <div class="btn btn-light pop o px-1"
                                ...
                                <input type="radio" name="options" id="option18"
                                    autocomplete="off">Tannenbaum
                            </div>
                        </div> ist doch vor allem für das Fest.<span
                            class="ans"> </span>
                    </span>
                    <span class="tran">&nbsp;<small>그리고 크리스마스트리야말로 이 축제의
                            꽃이다.</small></span>
                </div>
            </div>
            <!-- 정답화인 버튼 시작 -->

...
<?php include "nav.php"; ?>
	...
	<section>
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12 col-md-6 col-lg-6" style="line-height: 250%;">
					<span class="text-white bg-dark rounded p-1 px-2 m-1">Eva Fischer.</span>&nbsp;
					<span class="tran">&nbsp;<small>에바 피셔</small></span>
					Es ist für mich das schönste Fest, weil endlich der Frühling kommt.&nbsp;
					<span class="tran">&nbsp;<small>그것은 나에게 가장 아름다운 축제다, 왜냐하면 마침내 봄이 오기 때문이다.</small></span>
					<span class="sen">Meine <span class="nu"> </span><div class="btn-group btn-group-toggle border border-dark border-top-0 border-left-0 border-right-0 q d-inline-flex" data-toggle="buttons" id="qst-1">
					...
					<span class="tran">&nbsp;<small>나의 딸은 자녀들과 함께 우리를 방문한다.</small></span>
					<span class="sen">Ich und mein Mann verstecken die <span class="nu"> </span><div class="btn-group btn-group-toggle border border-dark border-top-0 border-left-0 border-right-0 q d-inline-flex" data-toggle="buttons" id="qst-2">
						<div class="btn btn-light pop o px-1" data-toggle="popover" data-container="body" data-placement="top" data-content="정답!">
					...
					<span class="tran">&nbsp;<small>나와 남편은 부활절 계란을 정원에 숨겨둔다.</small></span>
					Unsere Enkelkinder finden sie.&nbsp;
					<span class="tran">&nbsp;<small>우리의 손자, 손녀들은 그것들을 찾는다.</small></span>
					Das macht uns allen Spaß.&nbsp;
					<span class="tran">&nbsp;<small>이것은 우리 모두를 즐겁게 해준다.</small></span>
					Wie heißt das Fest ?&nbsp;
					<span class="tran">&nbsp;<small>이 축제의 이름은?</small></span>
					<span class="sen"><span class="nu"> </span><div class="btn-group btn-group-toggle border border-dark border-top-0 border-left-0 border-right-0 q d-inline-flex" data-toggle="buttons" id="qst-3">
						<div class="btn btn-light pop x px-1" data-toggle="popover" data-container="body" data-placement="top" data-content="정답이 아니에요.">
					...
					<span class="tran">&nbsp;<small>부활절</small></span>
				</div>
				<div class="col-sm-12 col-md-6 col-lg-6" style="line-height: 250%;">
					<span class="text-white bg-dark rounded p-1 px-2 m-1">Tim Klein.</span>&nbsp;
					<span class="tran">&nbsp;<small>팀 클라인</small></span>
					<span class="sen">Ich liebe <span class="nu"> </span><div class="btn-group btn-group-toggle border border-dark border-top-0 border-left-0 border-right-0 q d-inline-flex" data-toggle="buttons" id="qst-4">
						<div class="btn btn-light pop x px-1" data-toggle="popover" data-container="body" data-placement="top" data-content="정답이 아니에요.">
					...
					<span class="tran">&nbsp;<small>나는 성탄절을 좋아한다.</small></span>
					<span class="sen">Die Leute kaufen <span class="nu"> </span><div class="btn-group btn-group-toggle border border-dark border-top-0 border-left-0 border-right-0 q d-inline-flex" data-toggle="buttons" id="qst-5">
						<div class="btn btn-light pop o px-1" data-toggle="popover" data-container="body" data-placement="top" data-content="정답!">
					...
					</div> ein.&nbsp;<span class="ans"> </span></span>
					<span class="tran">&nbsp;<small>사람들은 선물을 산다.</small></span>
					Ich freue mich sehr auf die Geschenke.&nbsp;
					<span class="tran">&nbsp;<small>나는 선물을 매우 고대하고 있다.</small></span>&nbsp;
					<span class="sen">Und Der <span class="nu"> </span><div class="btn-group btn-group-toggle border border-dark border-top-0 border-left-0 border-right-0 q d-inline-flex" data-toggle="buttons" id="qst-6">
						<div class="btn btn-light pop x px-1" data-toggle="popover" data-container="body" data-placement="top" data-content="정답이 아니에요.">
					...
					</div> ist doch vor allem für das Fest.<span class="ans"> </span></span>
					<span class="tran">&nbsp;<small>그리고 크리스마스트리야말로 이 축제의 꽃이다.</small></span>
				</div>
			</div>
			<!-- 정답화인 버튼 시작 -->
			<div class="row">

 			...
 			<div class="row">
 				<div class="col-12">
 					<table class="table">
 						<tbody>
							<tr>
								<th scope="row" class="text-center align-middle border-0" width="80">
								...
								<td class="border-0" style="line-height: 250%;">
									<div class="input-group">
										...
										<span class="tran"><small>율리아는 이번 주말에 출장으로 뮌헨에 있다. 마틴은 조금 슬프다: 마틴은 율리아가 그립다. 그는 하루 종일 그녀를 생각한다.</small><br></span>
									</div>
								</td>
							</tr>
							<tr>
								<th scope="row" class="text-center align-middle border-0">

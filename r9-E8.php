 			...
 			<div class="row py-2 border border-dark my-2 rounded bg-light" style="line-height: 300%;">
				...
				<div class="col-12 my-2">
					<div class="input-group">
						<input type="text" class="form-control q pl-0 col-1 rounded-0 border-left-0 border-right-0 border-top-0 mx-1 px-2 py-1 text-center border-dark mx-1" style="min-width: 150px;" aria-label="." id="qst-1"> sind 20 Jahre verheiratet.<span class="tran"><small>translate</small></span> Das möchten <input type="text" class="form-control q pl-0 col-1 rounded-0 border-left-0 border-right-0 border-top-0 mx-1 px-2 py-1 text-center border-dark mx-1" style="min-width: 150px;" aria-label="." id="qst-2">gern mit <input type="text" class="form-control q pl-0 col-1 rounded-0 border-left-0 border-right-0 border-top-0 mx-1 px-2 py-1 text-center border-dark mx-1 text-capitalize" style="min-width: 150px;" aria-label="." id="qst-3">und Ihrer Frau und unseren anderen Bekannten und Freunden feiern.<span class="tran"><small>translate</small></span> Die Feier ist am Montag, 16. 6., um 19.00 Uhr.<span class="tran"><small>translate</small></span> Haben<input type="text" class="form-control q pl-0 col-1 rounded-0 border-left-0 border-right-0 border-top-0 mx-1 px-2 py-1 text-center border-dark mx-1 text-capitalize" style="min-width: 150px;" aria-label="." id="qst-4"> da Zeit?<span class="tran"><small>translate</small></span> Bitte antworten Sie <input type="text" class="form-control q pl-0 col-1 rounded-0 border-left-0 border-right-0 border-top-0 mx-1 px-2 py-1 text-center border-dark mx-1" style="min-width: 150px;" aria-label="." id="qst-5">bis Mittwoch oder rufen Sie <input type="text" class="form-control q pl-0 col-1 rounded-0 border-left-0 border-right-0 border-top-0 mx-1 px-2 py-1 text-center border-dark mx-1" style="min-width: 150px;" aria-label="." id="qst-6">an.<span class="tran"><small>translate</small></span>
					</div>
					
				<div class="col-12  text-right">Mit freundlichen Grüßen <br>
						<span class="tran"><small>translate</small></span>Ihre Christa und Wolfgang Haister
						<span class="tran"><small>translate</small></span></div>
				</div>
			</div>
			<!-- 정답화인 버튼 시작 -->
			<div class="row">

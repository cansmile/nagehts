        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col my-2 py-2">
                    <span class="wd ml-2">uns</span>
                    <span class="wd ml-2">wir</span>
                    <span class="wd ml-2">Sie</span>
                    <span class="wd ml-2">uns</span>
                    <span class="wd ml-2">Ihnen</span>
                </div>
            </div>
                ...
                <div class="col-12 my-2">
                    <div class="input-group">
                        ...
                        sind 20 Jahre verheiratet.<span class="tran">&nbsp;<small>저희가 결혼한 지 20주년이
                                되었습니다.</small>&nbsp;</span> Das möchten <input type="text"
                            class="form-control q pl-0 col-1 rounded-0 border-bottom-only mx-1 px-2 py-1 text-center
                            border-dark mx-1" style="min-width: 150px;" aria-label="." id="qst-2">gern mit
                            <input type="text" class="form-control q pl-0 col-1 rounded-0 border-bottom-only mx-1 px-2
                        ...
                        Montag, 16. 6., um 19.00 Uhr.<span class="tran">&nbsp;<small>파티는 6월 16일 월요일,
                                19시입니다.</small>&nbsp;</span> Haben<input type="text"
                            class="form-control q pl-0 col-1 rounded-0 border-bottom-only mx-1 px-2 py-1 text-center
                        ...
                        <input type="text"
                            ...
                            bis Mittwoch oder rufen Sie <input type="text"
                            class="form-control q pl-0 col-1 rounded-0 border-bottom-only mx-1 px-2 py-1 text-center
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var nagehts = new Howl({
                src: ["./<?php echo($root); ?>sounds/Reihe 9/r9 E8.mp3"],
                sprite: {
                    "0": [.802, 43.390]
                },
                html5: true,

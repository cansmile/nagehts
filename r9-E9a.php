...
td,th {
	...
	<section class="bg-white rounded p-2" style="position: fixed; bottom: 0; z-index: 9999; width: 100%;" id="wahl">
		<div class="container">
			<div class="row">
				<div class="col display-4 bg-<?php echo($color); ?> rounded text-white font-weight-bold col-12 text-center">Wahl</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12 col-md-6 col-lg-4 mx-0 px-0">
					<table class="table table-borderless text-center table-striped mx-0">
						<thead>
							<tr>
								<th scope="col" class="bg-secondary text-white d-sm-block d-md-block d-lg-block">Personal-<br>pronomen</th>
								<th scope="col" class="bg-dark text-white">ich</th>
								<th scope="col" class="bg-secondary text-white">du</th>
							</tr>
							<tbody>
								<tr>
									<th scope="row" class="bg-dark text-white d-sm-block d-md-block d-lg-block">
										sein
									</th>
								...
								<tr>
									<th scope="row" class="bg-secondary text-white d-sm-block d-md-block d-lg-block">
										haben
									</th>
									<td class="text-center">
				...
				<div class="col-sm-12 col-md-6 col-lg-4 mx-0 px-0">
					<table class="table table-borderless text-center table-striped mx-0">
						<thead>
							<tr>
								<th scope="col" class="bg-secondary text-white d-sm-block d-md-none d-lg-none">Personal-<br>pronomen</th>
								<th scope="col" class="bg-dark text-white">Sie</th>
								<th scope="col" class="bg-secondary text-white">er/sie/es</th>
								<th scope="col" class="bg-dark text-white">wir</th>
							</tr>
							<tbody>
								<tr>
									<th scope="row" class="bg-dark text-white d-sm-block d-md-none d-lg-none">
										sein
									</th>
									<td class="text-center">
								...
								<tr>
									<th scope="row" class="bg-secondary text-white d-sm-block d-md-none d-lg-none">
										haben
									</th>
									<td class="text-center">
				...
				<div class="col-sm-12 col-md-6 col-lg-4 mx-0 px-0">
					<table class="table table-borderless text-center table-striped mx-0">
						<thead>
							<tr>
								<th scope="col" class="bg-secondary text-white d-sm-block d-md-block d-lg-none">Personal-<br>pronomen</th>
								<th scope="col" class="bg-secondary text-white">ihr</th>
								<th scope="col" class="bg-dark text-white">Sie</th>
								<th scope="col" class="bg-secondary text-white">sie</th>
							</tr>
							<tbody>
								<tr>
									<th scope="row" class="bg-dark text-white d-sm-block d-md-block d-lg-none">
										sein
									</th>
									<td class="bg-white">
								...
								<tr>
									<th scope="row" class="bg-secondary text-white d-sm-block d-md-block d-lg-none">
										haben
									</th>
									<td class="bg-light">
			...
			p++) {
				...
				$(".itm").each(function() {
					if($(this).hasClass("ans"+ pan[p])) {
						...
						$("#"+ $(this).attr("id")).addClass("text-center");
						$("#lst-"+ pan[p] + ">h2").remove();

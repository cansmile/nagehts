            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 border border-dark rounded p-2 my-2 py-4"
                    ...
                    <div class="row">
                        ...
                        <div class="col-11">
                            <div class="input-group">
                                Meine Eltern <input type="text"
                                    class="form-control q pl-0 col-2 rounded-0 border-bottom-only mx-1 px-2 py-1
                                    text-center border-dark mx-1 t-6" style="min-width: 150px;"
                                    aria-label="." id="qst-5"> vor 20 Jahren
                                glücklich. <span class="tran">&nbsp;<small>나의
                                        부모님은 20년 전에 행복하셨다.</small>&nbsp;</span>
                                Sie sind heute immer noch glücklich. <span
                                    class="tran">&nbsp;<small>그들은 여전히
                                        행복하다.</small>&nbsp;</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 border border-dark rounded p-2 my-2 py-4"
                    ...
                    <div class="row">
                        ...
                        <div class="col-11">
                            <div class="input-group">
                                Sabine <input type="text"
                                    class="form-control q pl-0 col-2 rounded-0 border-bottom-only mx-1 px-2 py-1
                                    text-center border-dark mx-1 t-6" style="min-width: 150px;"
                                    aria-label="." id="qst-6">schon als Kind
                                sehr sportlich. <span
                                    class="tran">&nbsp;<small>자비네는 어렸을 때부터 운동에
                                        소질이 있었다.</small>&nbsp;</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-11">
                            <div class="input-group">
                                ...
                                Weihnachten? <span
                                    class="tran">&nbsp;<small>크리스마스에 너희는 어디에
                                        있었니?</small>&nbsp;</span>
                            </div>
                        </div>
                        <div class="col-1 text-center"></div>

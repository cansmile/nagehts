...
<body>
	...
	<section>
		<div class="container">
			<div class="row">
 			...
 			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-6 border border-dark rounded p-2 my-2 py-4" style="line-height: 250%">
					<div class="row">
	...
	<script>
		...
		$(".ant").hide();
		var an=new Array();
		var an=["hattest","war","war","hatten","waren","waren","war","wart","hatte","warst","war","war"];

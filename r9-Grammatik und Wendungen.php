                            ...
                            <div class="card-header" id="heading1">
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        <strong>F1. Personalpronomen</strong>
                                        <small>인칭대명사</small>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" id="heading2">
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        <strong>F2. Perfekt: haben/sein +
                                            Partizip II</strong> <small>완료형:
                                            haben / sein + 과거분사형</small>
                                    </button>
                                </h5>
                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td
                                                ...
                                                Hilfsverb: haben (70-80%)</td>
                                            <td
                                                class="font-weight-bold text-center">
                                                Hilfsverb: sein (20-30%)</td>
                                        </tr>
                                        <tr>
                                            <td>die meisten Verben<br>(V-trans./
                                                V-intrans., +durativ / V-ieren)
                                            </td>
                                            <td>nur drei Gruppen von
                                                V-intrans.<br>(+Bewegung /
                                                +Veränderung / sein, bleiben,
                                                werden)</td>
                                        </tr>
                                        <tr>
                                            <td>Ich <span
                            ...
                            <div class="card-header" id="heading3">
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        <strong>F3. Präteritum von sein und
                                            haben.</strong> <small>haben과 sein의
                                            과거형.</small>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" id="heading4">
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        <strong>F4. Konnektoren: deshalb und
                                            weil</strong> <small>접속사: deshalb와
                                            weil</small>
                                    </button>
                                </h5>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div
                                                        class="col-9 mx-1 px-1 lh250">
                                                        Welche Feiertage und
                                                        Feste gibt es in Korea?
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
